...
namespace BIPOS.Database
{
  public class BaseDataAccess
  {
    ...
    protected DbCommand GetCommand(DbTransaction transaction, string commandText, CommandType commandType)
    {
    ...
    protected NpgsqlParameter GetParameterOut(string parameter, NpgsqlDbType type, object? value = null, ParameterDirection parameterDirection = ParameterDirection.InputOutput)
    {
