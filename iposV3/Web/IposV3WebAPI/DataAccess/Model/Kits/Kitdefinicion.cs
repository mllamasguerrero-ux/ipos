...
{
    public class Kitdefinicion : EntityBaseExt
    {


        public Kitdefinicion() : base()
        {
        }

        public Kitdefinicion(Empresa empresa, Sucursal sucursal) : base(empresa, sucursal)
        {
        }
        public Kitdefinicion(Empresa empresa, Sucursal sucursal, Usuario? creadoPor) : base(empresa, sucursal, creadoPor)
        {
        }
