...
{
    public class Inventario : EntityBaseExt
    {
        ...
        public Inventario(Empresa empresa, Sucursal sucursal) : base(empresa, sucursal)
        {
        }
        public Inventario(Empresa empresa, Sucursal sucursal, Usuario? creadoPor) : base(empresa, sucursal, creadoPor)
        {
        }
