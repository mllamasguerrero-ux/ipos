...
{
    public class Movto_ventafuturo : EntityBaseExt
    {


        public Movto_ventafuturo() : base()
        {
        }

        public Movto_ventafuturo(Empresa empresa, Sucursal sucursal) : base(empresa, sucursal)
        {
        }
        public Movto_ventafuturo(Empresa empresa, Sucursal sucursal, Usuario? creadoPor) : base(empresa, sucursal, creadoPor)
        {
        }
