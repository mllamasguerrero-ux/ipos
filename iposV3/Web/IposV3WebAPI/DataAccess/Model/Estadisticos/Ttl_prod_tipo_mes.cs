...
{
    public class Ttl_prod_tipo_mes : EntityBaseExt
    {


        public Ttl_prod_tipo_mes() : base()
        {
        }

        public Ttl_prod_tipo_mes(Empresa empresa, Sucursal sucursal) : base(empresa, sucursal)
        {
        }
        public Ttl_prod_tipo_mes(Empresa empresa, Sucursal sucursal, Usuario? creadoPor) : base(empresa, sucursal, creadoPor)
        {
        }
