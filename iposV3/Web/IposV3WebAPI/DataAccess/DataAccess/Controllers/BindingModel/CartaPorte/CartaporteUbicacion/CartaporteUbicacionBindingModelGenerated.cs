...
namespace BindingModels
{
    ...
    
    {
        ...
        public CartaporteUbicacionBindingModelGenerated(CartaporteUbicacion item)
        {
            FillFromEntity(item);
        }
        ...
        public void FillCatalogRelatedFields(CartaporteUbicacion item)
        {
        ...
        public void FillEntityValues(ref CartaporteUbicacion item)
        {
            ...
            item.Tipoubicacion = Tipoubicacion ;


            item.Idubicacion = Idubicacion ;


            item.Rfcremitentedestinatario = Rfcremitentedestinatario ;


            item.Nombreremitentedestinatario = Nombreremitentedestinatario ;


            item.Numregidtrib = Numregidtrib ;


            item.Residenciafiscal = Residenciafiscal ;


            item.Numestacion = Numestacion ;


            item.Nombreestacion = Nombreestacion ;


            item.Navegaciontrafico = Navegaciontrafico ;


            item.Fechahorasalidallegada = Fechahorasalidallegada ;


            item.Tipoestacion = Tipoestacion ;


            item.Distanciarecorrida = Distanciarecorrida ;
        ...
        public void FillFromEntity(CartaporteUbicacion item)
        {
