...
namespace Controllers.Controller
{
    ...
    public class ProductoController : BaseController<ProductoBindingModel>
    {
        ...
        public ProductoController(IDbContextFactory<ApplicationDbContext> operationsContextFactory,
        ...
        public List<ProductoListBindingModel> SelectForSimpleList(ProductoParam? param, KendoParams? kendoParams)
        {
            if (param == null) throw new Exception("El campo de parametros es null y debe tener valor");
