...
namespace Controllers.Controller
{
    ...
    public class MarcaController : BaseController<MarcaBindingModel>
    {
        ...
        public MarcaController(IDbContextFactory<ApplicationDbContext> operationsContextFactory)
        {
        ...
        public override MarcaBindingModel? GetById(MarcaBindingModel itemSelect)
        {
            ...
            var basicQuery = applicationDbContext.Marca.AsNoTracking()
                           .Where(x => x.EmpresaId == itemSelect.EmpresaId && x.SucursalId == itemSelect.SucursalId && x.Id == itemSelect.Id);

            var queryWithIncludes = QueryableWithIncludes(basicQuery);

            var item =
                  queryWithIncludes.Select(x => new MarcaBindingModel(x))
                            .FirstOrDefault();
        ...
        public override List<MarcaBindingModel> SelectList(object? param, KendoParams? kendoParams)
        {
            ...
            MarcaParam itemParam = (MarcaParam)param;
            ...
            try
            {
                ...
                var lstQuery = queryWithIncludes
                      ...
                      .Data.ToList<Marca>()
                      .Select(x => new MarcaBindingModel(x));
        ...
        public override List<MarcaBindingModel> SelectById(MarcaBindingModel itemSelect)
        {
            ...
            var listItems = queryWithIncludes.Select(x => new MarcaBindingModel(x)).ToList();
        ...
        public override bool Update(MarcaBindingModel item)
        {
            ...
            var basicQuery = applicationDbContext.Marca
        ...
        public override bool Delete(MarcaBindingModel item)
        {
            ...
            var entityItem = applicationDbContext.Marca?
...
#pragma warning disable CS8602
        public IQueryable<Marca> QueryableWithIncludes(IQueryable<Marca> itemBasicQuery)
        {
