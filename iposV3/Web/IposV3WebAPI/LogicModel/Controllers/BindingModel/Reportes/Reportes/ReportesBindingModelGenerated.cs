...
namespace BindingModels
{
    ...
    public class ReportesBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public ReportesBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public ReportesBindingModelGenerated(Reportes item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Reportes"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        {
            return @"Nombre|Archivo|Descripcion";
        }


        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Reportes item)
        {
        ...
        public void FillEntityValues(ref Reportes item)
        {
        ...
        public void FillFromEntity(Reportes item)
        {
