...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFMarcasWFBindingModel : Validatable
    {

        public WFMarcasWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFMarcasWF_TableBindingModel : Validatable
    {

        public WFMarcasWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
