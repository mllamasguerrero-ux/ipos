...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFPersonaCuentasBancosWFBindingModel : Validatable
    {

        public WFPersonaCuentasBancosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFPersonaCuentasBancosWF_TableBindingModel : Validatable
    {

        public WFPersonaCuentasBancosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
