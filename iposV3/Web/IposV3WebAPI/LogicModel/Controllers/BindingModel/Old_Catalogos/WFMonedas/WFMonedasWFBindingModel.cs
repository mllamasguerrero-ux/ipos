...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFMonedasWFBindingModel : Validatable
    {

        public WFMonedasWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFMonedasWF_TableBindingModel : Validatable
    {

        public WFMonedasWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
