...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFMerchantPagoServiciosWFBindingModel : Validatable
    {

        public WFMerchantPagoServiciosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFMerchantPagoServiciosWF_TableBindingModel : Validatable
    {

        public WFMerchantPagoServiciosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
