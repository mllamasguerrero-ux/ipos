...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFTipoDiferenciaInventariosWFBindingModel : Validatable
    {

        public WFTipoDiferenciaInventariosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFTipoDiferenciaInventariosWF_TableBindingModel : Validatable
    {

        public WFTipoDiferenciaInventariosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
