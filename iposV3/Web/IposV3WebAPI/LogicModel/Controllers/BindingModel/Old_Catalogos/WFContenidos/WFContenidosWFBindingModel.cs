...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFContenidosWFBindingModel : Validatable
    {

        public WFContenidosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFContenidosWF_TableBindingModel : Validatable
    {

        public WFContenidosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
