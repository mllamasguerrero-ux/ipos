...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFAlmacenesWFBindingModel : Validatable
    {

        public WFAlmacenesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFAlmacenesWF_TableBindingModel : Validatable
    {

        public WFAlmacenesWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
