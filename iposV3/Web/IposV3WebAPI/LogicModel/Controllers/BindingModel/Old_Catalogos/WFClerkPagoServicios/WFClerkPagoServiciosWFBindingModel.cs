...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFClerkPagoServiciosWFBindingModel : Validatable
    {

        public WFClerkPagoServiciosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFClerkPagoServiciosWF_TableBindingModel : Validatable
    {

        public WFClerkPagoServiciosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
