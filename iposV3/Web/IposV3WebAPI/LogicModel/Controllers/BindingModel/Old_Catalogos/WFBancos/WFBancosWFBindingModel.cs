...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFBancosWFBindingModel : Validatable
    {

        public WFBancosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFBancosWF_TableBindingModel : Validatable
    {

        public WFBancosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
