...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFEstadosWFBindingModel : Validatable
    {

        public WFEstadosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFEstadosWF_TableBindingModel : Validatable
    {

        public WFEstadosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
