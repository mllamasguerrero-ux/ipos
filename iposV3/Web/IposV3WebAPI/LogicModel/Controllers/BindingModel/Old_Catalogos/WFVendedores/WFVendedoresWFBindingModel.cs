...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFVendedoresWFBindingModel : Validatable
    {

        public WFVendedoresWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFVendedoresWF_TableBindingModel : Validatable
    {

        public WFVendedoresWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
