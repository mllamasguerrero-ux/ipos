...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFLineasWFBindingModel : Validatable
    {

        public WFLineasWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFLineasWF_TableBindingModel : Validatable
    {

        public WFLineasWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
        ...
        private string? _Acumulapromocion;
        [XmlAttribute]
        public string? Acumulapromocion { get => _Acumulapromocion; set { if (RaiseAcceptPendingChange(value, _Acumulapromocion)) { _Acumulapromocion = value; OnPropertyChanged(); } } }
