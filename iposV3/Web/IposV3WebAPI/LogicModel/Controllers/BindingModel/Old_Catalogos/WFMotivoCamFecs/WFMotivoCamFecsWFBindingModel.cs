...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFMotivoCamFecsWFBindingModel : Validatable
    {

        public WFMotivoCamFecsWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFMotivoCamFecsWF_TableBindingModel : Validatable
    {

        public WFMotivoCamFecsWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
