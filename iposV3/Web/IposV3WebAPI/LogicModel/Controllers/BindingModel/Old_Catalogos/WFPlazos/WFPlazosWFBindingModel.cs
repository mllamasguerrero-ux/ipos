...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFPlazosWFBindingModel : Validatable
    {

        public WFPlazosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFPlazosWF_TableBindingModel : Validatable
    {

        public WFPlazosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
