...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFAreasWFBindingModel : Validatable
    {

        public WFAreasWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFAreasWF_TableBindingModel : Validatable
    {

        public WFAreasWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
