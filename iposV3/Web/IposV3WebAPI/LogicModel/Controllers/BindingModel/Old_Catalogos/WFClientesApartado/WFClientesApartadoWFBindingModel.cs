...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFClientesApartadoWFBindingModel : Validatable
    {

        public WFClientesApartadoWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFClientesApartadoWF_TableBindingModel : Validatable
    {

        public WFClientesApartadoWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
