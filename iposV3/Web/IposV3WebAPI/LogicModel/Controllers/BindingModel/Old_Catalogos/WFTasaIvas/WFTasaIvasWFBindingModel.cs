...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFTasaIvasWFBindingModel : Validatable
    {

        public WFTasaIvasWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFTasaIvasWF_TableBindingModel : Validatable
    {

        public WFTasaIvasWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
