...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFGruposSucursalWFBindingModel : Validatable
    {

        public WFGruposSucursalWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFGruposSucursalWF_TableBindingModel : Validatable
    {

        public WFGruposSucursalWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
