...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFAnaquelesWFBindingModel : Validatable
    {

        public WFAnaquelesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFAnaquelesWF_TableBindingModel : Validatable
    {

        public WFAnaquelesWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
