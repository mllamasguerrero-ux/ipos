...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFProveedoresWFBindingModel : Validatable
    {

        public WFProveedoresWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFProveedoresWF_TableBindingModel : Validatable
    {

        public WFProveedoresWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
