...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFSucursalesWFBindingModel : Validatable
    {

        public WFSucursalesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFSucursalesWF_TableBindingModel : Validatable
    {

        public WFSucursalesWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
