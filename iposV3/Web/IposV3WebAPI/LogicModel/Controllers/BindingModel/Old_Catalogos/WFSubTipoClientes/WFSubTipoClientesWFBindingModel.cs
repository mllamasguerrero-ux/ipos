...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFSubTipoClientesWFBindingModel : Validatable
    {

        public WFSubTipoClientesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFSubTipoClientesWF_TableBindingModel : Validatable
    {

        public WFSubTipoClientesWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
        ...
        private string? _Descontinuado;
        [XmlAttribute]
        public string? Descontinuado { get => _Descontinuado; set { if (RaiseAcceptPendingChange(value, _Descontinuado)) { _Descontinuado = value; OnPropertyChanged(); } } }
