...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFClasificasWFBindingModel : Validatable
    {

        public WFClasificasWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFClasificasWF_TableBindingModel : Validatable
    {

        public WFClasificasWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
