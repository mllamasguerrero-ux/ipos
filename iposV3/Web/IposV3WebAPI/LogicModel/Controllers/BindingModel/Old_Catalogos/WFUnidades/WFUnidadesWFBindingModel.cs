...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFUnidadesWFBindingModel : Validatable
    {

        public WFUnidadesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFUnidadesWF_TableBindingModel : Validatable
    {

        public WFUnidadesWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
