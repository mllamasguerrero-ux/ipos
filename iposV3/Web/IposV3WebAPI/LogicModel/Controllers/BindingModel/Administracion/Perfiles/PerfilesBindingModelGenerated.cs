...
namespace BindingModels
{
    ...
    public class PerfilesBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public PerfilesBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public PerfilesBindingModelGenerated(Perfiles item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Perfiles"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Perfiles item)
        {
        ...
        public void FillEntityValues(ref Perfiles item)
        {
        ...
        public void FillFromEntity(Perfiles item)
        {
