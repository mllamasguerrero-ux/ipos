...
namespace BindingModels
{
    ...
    public class TipoutilidadBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public TipoutilidadBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public TipoutilidadBindingModelGenerated(Tipoutilidad item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Tipoutilidad"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Tipoutilidad item)
        {
        ...
        public void FillEntityValues(ref Tipoutilidad item)
        {
        ...
        public void FillFromEntity(Tipoutilidad item)
        {
