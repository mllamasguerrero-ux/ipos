...
namespace BindingModels
{
    ...
    public class SubtipoclienteBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public SubtipoclienteBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public SubtipoclienteBindingModelGenerated(Subtipocliente item)
        {
            FillFromEntity(item);
        }
        ...
        private BoolCN? _Esmostrador;
        [XmlAttribute][Required(ErrorMessage = "Es requerido")]
        public BoolCN? Esmostrador { get => _Esmostrador?? BoolCN.N; set { if (RaiseAcceptPendingChange(value, _Esmostrador)) { _Esmostrador = value?? BoolCN.N; OnPropertyChanged(); } } }

        public static string GetBaseQuery()
        {

            return $@"SELECT * FROM ""Subtipocliente"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Subtipocliente item)
        {
        ...
        public void FillEntityValues(ref Subtipocliente item)
        {
            ...
            item.Esmostrador = Esmostrador ?? BoolCN.N;



        }

        public void FillFromEntity(Subtipocliente item)
        {
