...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFComprasWFBindingModel : Validatable
    {

        public WFComprasWFBindingModel()
        {
        ...
        private string? _Tbproveedor;
        [XmlAttribute]
        public string? Tbproveedor { get => _Tbproveedor; set { if (RaiseAcceptPendingChange(value, _Tbproveedor)) { _Tbproveedor = value; OnPropertyChanged(); } } }
        ...
        private DateTimeOffset? _Dtpfechafactura;
        [XmlAttribute]
        public DateTimeOffset? Dtpfechafactura { get => _Dtpfechafactura; set { if (RaiseAcceptPendingChange(value, _Dtpfechafactura)) { _Dtpfechafactura = value; OnPropertyChanged(); } } }

        private string? _Tbgastosadic;
        [XmlAttribute]
        public string? Tbgastosadic { get => _Tbgastosadic; set { if (RaiseAcceptPendingChange(value, _Tbgastosadic)) { _Tbgastosadic = value; OnPropertyChanged(); } } }
    ...
    [XmlRoot]
    public class WFComprasWF_GridpvBindingModel : Validatable
    {

        public WFComprasWF_GridpvBindingModel()
        {
            FillCatalogRelatedFields();
        }
