...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFPagoServiciosEmidaWFBindingModel : Validatable
    {

        public WFPagoServiciosEmidaWFBindingModel()
        {
        ...
        private decimal? _Tbcomision;
        [XmlAttribute]
        public decimal? Tbcomision { get => _Tbcomision; set { if (RaiseAcceptPendingChange(value, _Tbcomision)) { _Tbcomision = value; OnPropertyChanged(); } } }
        ...
        private decimal? _Tbmontoaplicar;
        [XmlAttribute]
        public decimal? Tbmontoaplicar { get => _Tbmontoaplicar; set { if (RaiseAcceptPendingChange(value, _Tbmontoaplicar)) { _Tbmontoaplicar = value; OnPropertyChanged(); } } }
