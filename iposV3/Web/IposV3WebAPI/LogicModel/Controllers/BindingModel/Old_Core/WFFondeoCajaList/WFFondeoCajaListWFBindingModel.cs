...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFFondeoCajaListWFBindingModel : Validatable
    {

        public WFFondeoCajaListWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFFondeoCajaListWF_Fondeos_cajaBindingModel : Validatable
    {

        public WFFondeoCajaListWF_Fondeos_cajaBindingModel()
        {
            FillCatalogRelatedFields();
        }
