...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFGastosWFBindingModel : Validatable
    {

        public WFGastosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFGastosWF_TableBindingModel : Validatable
    {

        public WFGastosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
