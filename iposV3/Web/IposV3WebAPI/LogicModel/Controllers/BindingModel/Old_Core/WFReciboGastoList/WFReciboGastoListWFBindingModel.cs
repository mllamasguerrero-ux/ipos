...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFReciboGastoListWFBindingModel : Validatable
    {

        public WFReciboGastoListWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFReciboGastoListWF_GastosBindingModel : Validatable
    {

        public WFReciboGastoListWF_GastosBindingModel()
        {
            FillCatalogRelatedFields();
        }
