...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFLOOKUPCOMPRASWFBindingModel : Validatable
    {

        public WFLOOKUPCOMPRASWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFLOOKUPCOMPRASWF_VentaslistaBindingModel : Validatable
    {

        public WFLOOKUPCOMPRASWF_VentaslistaBindingModel()
        {
            FillCatalogRelatedFields();
        }
