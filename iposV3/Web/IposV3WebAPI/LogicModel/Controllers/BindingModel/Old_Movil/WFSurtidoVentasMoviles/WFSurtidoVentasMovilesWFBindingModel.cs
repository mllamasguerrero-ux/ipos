...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFSurtidoVentasMovilesWFBindingModel : Validatable
    {

        public WFSurtidoVentasMovilesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFSurtidoVentasMovilesWF_SurtidoventasmovilesBindingModel : Validatable
    {

        public WFSurtidoVentasMovilesWF_SurtidoventasmovilesBindingModel()
        {
            FillCatalogRelatedFields();
        }
        ...
        private string? _Dgsurtido;
        [XmlAttribute]
        public string? Dgsurtido { get => _Dgsurtido; set { if (RaiseAcceptPendingChange(value, _Dgsurtido)) { _Dgsurtido = value; OnPropertyChanged(); } } }
        ...
        private string? _Dgcheck;
        [XmlAttribute]
        public string? Dgcheck { get => _Dgcheck; set { if (RaiseAcceptPendingChange(value, _Dgcheck)) { _Dgcheck = value; OnPropertyChanged(); } } }
