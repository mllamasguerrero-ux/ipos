...
namespace BindingModels
{
    ...
    public class RangopromocionBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public RangopromocionBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public RangopromocionBindingModelGenerated(Rangopromocion item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Rangopromocion""  ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Rangopromocion item)
        {
        ...
        public void FillEntityValues(ref Rangopromocion item)
        {
        ...
        public void FillFromEntity(Rangopromocion item)
        {
