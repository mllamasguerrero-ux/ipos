...
namespace BindingModels
{
    ...
    public class TipopromocionBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public TipopromocionBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public TipopromocionBindingModelGenerated(Tipopromocion item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Tipopromocion""  ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Tipopromocion item)
        {
        ...
        public void FillEntityValues(ref Tipopromocion item)
        {
        ...
        public void FillFromEntity(Tipopromocion item)
        {
