...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFDesTrasladoProdPromWFBindingModel : Validatable
    {

        public WFDesTrasladoProdPromWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFDesTrasladoProdPromWF_TrasladopromdetalleBindingModel : Validatable
    {

        public WFDesTrasladoProdPromWF_TrasladopromdetalleBindingModel()
        {
            FillCatalogRelatedFields();
        }
