...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFTrasladoProdPromWFBindingModel : Validatable
    {

        public WFTrasladoProdPromWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFTrasladoProdPromWF_TrasladopromdetalleBindingModel : Validatable
    {

        public WFTrasladoProdPromWF_TrasladopromdetalleBindingModel()
        {
            FillCatalogRelatedFields();
        }
