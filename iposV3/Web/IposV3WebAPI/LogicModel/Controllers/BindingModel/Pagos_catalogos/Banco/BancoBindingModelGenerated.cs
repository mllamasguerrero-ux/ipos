...
namespace BindingModels
{
    ...
    public class BancoBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public BancoBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public BancoBindingModelGenerated(Banco item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Banco"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Banco item)
        {
        ...
        public void FillEntityValues(ref Banco item)
        {
        ...
        public void FillFromEntity(Banco item)
        {
