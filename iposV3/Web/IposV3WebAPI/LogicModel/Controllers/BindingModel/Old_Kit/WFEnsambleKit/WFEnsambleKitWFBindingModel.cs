...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFEnsambleKitWFBindingModel : Validatable
    {

        public WFEnsambleKitWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFEnsambleKitWF_KitdetalleBindingModel : Validatable
    {

        public WFEnsambleKitWF_KitdetalleBindingModel()
        {
            FillCatalogRelatedFields();
        }
