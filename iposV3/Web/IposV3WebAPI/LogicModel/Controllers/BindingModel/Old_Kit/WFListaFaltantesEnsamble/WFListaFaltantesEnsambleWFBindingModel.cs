...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFListaFaltantesEnsambleWFBindingModel : Validatable
    {

        public WFListaFaltantesEnsambleWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFListaFaltantesEnsambleWF_FaltantesensambleBindingModel : Validatable
    {

        public WFListaFaltantesEnsambleWF_FaltantesensambleBindingModel()
        {
            FillCatalogRelatedFields();
        }
