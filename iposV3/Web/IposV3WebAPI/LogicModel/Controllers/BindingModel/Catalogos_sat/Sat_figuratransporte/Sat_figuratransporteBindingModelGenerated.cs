...
namespace BindingModels
{
    ...
    public class Sat_figuratransporteBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Sat_figuratransporteBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public Sat_figuratransporteBindingModelGenerated(Sat_figuratransporte item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Sat_figuratransporte"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        {
            return @"Clave|Descripcion|Nombre";
        }



        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Sat_figuratransporte item)
        {
        ...
        public void FillEntityValues(ref Sat_figuratransporte item)
        {
        ...
        public void FillFromEntity(Sat_figuratransporte item)
        {
