...
namespace BindingModels
{
    ...
    public class Sat_localidadBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Sat_localidadBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public Sat_localidadBindingModelGenerated(Sat_localidad item)
        {
            FillFromEntity(item);
        }
        ...
        private string? _Clave_localidad;
        [XmlAttribute]
        public string? Clave_localidad { get => _Clave_localidad; set { if (RaiseAcceptPendingChange(value, _Clave_localidad)) { _Clave_localidad = value; OnPropertyChanged(); } } }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Sat_localidad""  ";
        ...
        {
            return @"Clave|Nombre|Clave_localidad|Clave_estado|Descripcion";
        }



        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Sat_localidad item)
        {
        ...
        public void FillEntityValues(ref Sat_localidad item)
        {
            ...
            item.Clave_localidad = Clave_localidad ;
        ...
        public void FillFromEntity(Sat_localidad item)
        {
