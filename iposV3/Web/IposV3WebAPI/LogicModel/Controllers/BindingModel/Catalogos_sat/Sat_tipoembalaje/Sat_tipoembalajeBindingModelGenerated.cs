...
namespace BindingModels
{
    ...
    public class Sat_tipoembalajeBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Sat_tipoembalajeBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public Sat_tipoembalajeBindingModelGenerated(Sat_tipoembalaje item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Sat_tipoembalaje""  ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Sat_tipoembalaje item)
        {
        ...
        public void FillEntityValues(ref Sat_tipoembalaje item)
        {
        ...
        public void FillFromEntity(Sat_tipoembalaje item)
        {
