...
namespace BindingModels
{
    ...
    public class Sat_regimenfiscalBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Sat_regimenfiscalBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public Sat_regimenfiscalBindingModelGenerated(Sat_regimenfiscal item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Sat_regimenfiscal""  ";
        ...
        {
            return @"Clave|Nombre|Sat_clave|Sat_description|Sat_personafisica|Sat_personamoral";
        }


        #if PROYECTO_WEB

        public void FillCatalogRelatedFields(Sat_regimenfiscal item)
        {
        ...
        public void FillEntityValues(ref Sat_regimenfiscal item)
        {
        ...
        public void FillFromEntity(Sat_regimenfiscal item)
        {
