...
namespace BindingModels
{
    ...
    public class Sat_unidadmedidaBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Sat_unidadmedidaBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public Sat_unidadmedidaBindingModelGenerated(Sat_unidadmedida item)
        {
            FillFromEntity(item);
        }
        ...
        private string? _Sat_nombre;
        [XmlAttribute]
        public string? Sat_nombre { get => _Sat_nombre; set { if (RaiseAcceptPendingChange(value, _Sat_nombre)) { _Sat_nombre = value; OnPropertyChanged(); } } }
        ...
        private string? _Sat_simbolo;
        [XmlAttribute]
        public string? Sat_simbolo { get => _Sat_simbolo; set { if (RaiseAcceptPendingChange(value, _Sat_simbolo)) { _Sat_simbolo = value; OnPropertyChanged(); } } }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Sat_unidadmedida""  ";
        ...
        {
            return @"Clave|Nombre|Sat_clave|Sat_nombre|Sat_descripcion|Sat_simbolo";
        }


        #if PROYECTO_WEB

        public void FillCatalogRelatedFields(Sat_unidadmedida item)
        {
        ...
        public void FillEntityValues(ref Sat_unidadmedida item)
        {
            ...
            item.Sat_nombre = Sat_nombre ;


            item.Sat_descripcion = Sat_descripcion ;


            item.Sat_simbolo = Sat_simbolo ;
        ...
        public void FillFromEntity(Sat_unidadmedida item)
        {
            ...
            Sat_nombre = item.Sat_nombre;

            Sat_descripcion = item.Sat_descripcion;

            Sat_simbolo = item.Sat_simbolo;
