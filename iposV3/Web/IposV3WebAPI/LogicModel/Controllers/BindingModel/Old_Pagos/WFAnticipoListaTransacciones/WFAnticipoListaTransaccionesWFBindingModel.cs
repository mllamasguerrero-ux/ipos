...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFAnticipoListaTransaccionesWFBindingModel : Validatable
    {

        public WFAnticipoListaTransaccionesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFAnticipoListaTransaccionesWF_VentaslistaBindingModel : Validatable
    {

        public WFAnticipoListaTransaccionesWF_VentaslistaBindingModel()
        {
            FillCatalogRelatedFields();
        }
