...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFSaldosAplicacionWFBindingModel : Validatable
    {

        public WFSaldosAplicacionWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFSaldosAplicacionWF_Get_credito_lista_a_aplicarBindingModel : Validatable
    {

        public WFSaldosAplicacionWF_Get_credito_lista_a_aplicarBindingModel()
        {
            FillCatalogRelatedFields();
        }
