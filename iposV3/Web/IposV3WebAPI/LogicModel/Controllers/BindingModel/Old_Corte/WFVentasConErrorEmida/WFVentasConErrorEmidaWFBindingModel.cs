...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFVentasConErrorEmidaWFBindingModel : Validatable
    {

        public WFVentasConErrorEmidaWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFVentasConErrorEmidaWF_VentasconerroremidaBindingModel : Validatable
    {

        public WFVentasConErrorEmidaWF_VentasconerroremidaBindingModel()
        {
            FillCatalogRelatedFields();
        }
