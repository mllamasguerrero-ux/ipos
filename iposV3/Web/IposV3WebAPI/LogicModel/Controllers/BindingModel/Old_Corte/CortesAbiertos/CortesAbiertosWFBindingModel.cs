...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class CortesAbiertosWFBindingModel : Validatable
    {

        public CortesAbiertosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class CortesAbiertosWF_TableBindingModel : Validatable
    {

        public CortesAbiertosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
