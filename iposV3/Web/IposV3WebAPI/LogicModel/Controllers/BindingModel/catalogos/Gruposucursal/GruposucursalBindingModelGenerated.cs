...
namespace BindingModels
{
    ...
    public class GruposucursalBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public GruposucursalBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public GruposucursalBindingModelGenerated(Gruposucursal item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Gruposucursal"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Gruposucursal item)
        {
        ...
        public void FillEntityValues(ref Gruposucursal item)
        {
        ...
        public void FillFromEntity(Gruposucursal item)
        {
