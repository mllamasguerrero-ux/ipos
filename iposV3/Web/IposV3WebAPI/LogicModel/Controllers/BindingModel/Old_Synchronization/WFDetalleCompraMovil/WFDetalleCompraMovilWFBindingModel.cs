...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFDetalleCompraMovilWFBindingModel : Validatable
    {

        public WFDetalleCompraMovilWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFDetalleCompraMovilWF_Detalle_compra_movilBindingModel : Validatable
    {

        public WFDetalleCompraMovilWF_Detalle_compra_movilBindingModel()
        {
            FillCatalogRelatedFields();
        }
