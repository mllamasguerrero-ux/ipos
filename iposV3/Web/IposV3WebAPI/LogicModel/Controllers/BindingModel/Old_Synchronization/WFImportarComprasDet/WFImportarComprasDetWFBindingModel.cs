...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFImportarComprasDetWFBindingModel : Validatable
    {

        public WFImportarComprasDetWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFImportarComprasDetWF_Imp_rec_detBindingModel : Validatable
    {

        public WFImportarComprasDetWF_Imp_rec_detBindingModel()
        {
            FillCatalogRelatedFields();
        }
