...
namespace BindingModels
{
    ...
    public class MensajenivelurgenciaBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public MensajenivelurgenciaBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public MensajenivelurgenciaBindingModelGenerated(Mensajenivelurgencia item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Mensajenivelurgencia"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        public void FillCatalogRelatedFields(Mensajenivelurgencia item)
        {
        ...
        public void FillEntityValues(ref Mensajenivelurgencia item)
        {
        ...
        public void FillFromEntity(Mensajenivelurgencia item)
        {
