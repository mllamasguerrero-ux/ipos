...
namespace BindingModels
{
    ...
    public class AreaBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public AreaBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public AreaBindingModelGenerated(Area item)
        {
            FillFromEntity(item);
        }
        ...
        [XmlAttribute]
        public string? Nombrearea { get => _Nombrearea; set { if (RaiseAcceptPendingChange(value, _Nombrearea)) { _Nombrearea = value; OnPropertyChanged(); } } }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Area"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        {
            return @"Nombrearea|Clave";
        }


        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Area item)
        {
        ...
        public void FillEntityValues(ref Area item)
        {
        ...
        public void FillFromEntity(Area item)
        {
