...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFInformeProductosStockWFBindingModel : Validatable
    {

        public WFInformeProductosStockWFBindingModel()
        {
        ...
        private long? _Comboorden;
        [XmlAttribute]
        public long? Comboorden { get => _Comboorden; set { if (RaiseAcceptPendingChange(value, _Comboorden)) { _Comboorden = value; OnPropertyChanged(); } } }

        private BoolCN? _Cbdebajostock;
        [XmlAttribute]
        public BoolCN? Cbdebajostock { get => _Cbdebajostock; set { if (RaiseAcceptPendingChange(value, _Cbdebajostock)) { _Cbdebajostock = value; OnPropertyChanged(); } } }
        ...
        private string? _ComboordenClave;
        [XmlAttribute]
        public string? ComboordenClave { get => _ComboordenClave; set { if (RaiseAcceptPendingChange(value, _ComboordenClave)) { _ComboordenClave = value; OnPropertyChanged(); } } }

        private string? _ComboordenNombre;
        [XmlAttribute]
        public string? ComboordenNombre { get => _ComboordenNombre; set { if (RaiseAcceptPendingChange(value, _ComboordenNombre)) { _ComboordenNombre = value; OnPropertyChanged(); } } }
