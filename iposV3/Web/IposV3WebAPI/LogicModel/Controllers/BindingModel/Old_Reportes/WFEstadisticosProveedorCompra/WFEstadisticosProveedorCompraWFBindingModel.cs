...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFEstadisticosProveedorCompraWFBindingModel : Validatable
    {

        public WFEstadisticosProveedorCompraWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFEstadisticosProveedorCompraWF_Ttl_rep_cliente_comparacionBindingModel : Validatable
    {

        public WFEstadisticosProveedorCompraWF_Ttl_rep_cliente_comparacionBindingModel()
        {
            FillCatalogRelatedFields();
        }
