...
namespace BindingModels
{
    ...
    public class TipotransaccionBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public TipotransaccionBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public TipotransaccionBindingModelGenerated(Tipotransaccion item)
        {
            FillFromEntity(item);
        }
        ...
        private short? _Sentidoinventario;
        [XmlAttribute]
        public short? Sentidoinventario { get => _Sentidoinventario; set { if (RaiseAcceptPendingChange(value, _Sentidoinventario)) { _Sentidoinventario = value; OnPropertyChanged(); } } }

        private short? _Sentidopago;
        [XmlAttribute]
        public short? Sentidopago { get => _Sentidopago; set { if (RaiseAcceptPendingChange(value, _Sentidopago)) { _Sentidopago = value; OnPropertyChanged(); } } }

        public static string GetBaseQuery()
        {

            return $@"SELECT * FROM ""Tipotransaccion"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Tipotransaccion item)
        {
        ...
        public void FillEntityValues(ref Tipotransaccion item)
        {
            ...
            item.Sentidoinventario = Sentidoinventario ;
        ...
        public void FillFromEntity(Tipotransaccion item)
        {
            ...
            Sentidoinventario = item.Sentidoinventario;
