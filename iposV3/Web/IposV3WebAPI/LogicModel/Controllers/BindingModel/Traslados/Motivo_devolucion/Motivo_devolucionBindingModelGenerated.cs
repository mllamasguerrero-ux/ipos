...
namespace BindingModels
{
    ...
    public class Motivo_devolucionBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Motivo_devolucionBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public Motivo_devolucionBindingModelGenerated(Motivo_devolucion item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Motivo_devolucion"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        public void FillCatalogRelatedFields(Motivo_devolucion item)
        {
        ...
        public void FillEntityValues(ref Motivo_devolucion item)
        {
        ...
        public void FillFromEntity(Motivo_devolucion item)
        {
