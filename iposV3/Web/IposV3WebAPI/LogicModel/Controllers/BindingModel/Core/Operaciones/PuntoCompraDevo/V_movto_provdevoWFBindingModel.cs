...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class V_movto_provdevoWFBindingModel : Validatable
    {

        public V_movto_provdevoWFBindingModel()
        {
        ...
        public static V_movto_provdevoWFBindingModel CreateFromAnonymous( dynamic obj)
        {
            var buffer_V_movto_provdevoWFBindingModel = new V_movto_provdevoWFBindingModel();

        	buffer_V_movto_provdevoWFBindingModel._EmpresaId = obj.EmpresaId;

        	buffer_V_movto_provdevoWFBindingModel._SucursalId = obj.SucursalId;

        	buffer_V_movto_provdevoWFBindingModel._Id = obj.Id;

        	buffer_V_movto_provdevoWFBindingModel._Partida = obj.Partida;

        	buffer_V_movto_provdevoWFBindingModel._Productoid = obj.Productoid;

        	buffer_V_movto_provdevoWFBindingModel._ProductoClave = obj.ProductoClave;

        	buffer_V_movto_provdevoWFBindingModel._ProductoNombre = obj.ProductoNombre;

        	buffer_V_movto_provdevoWFBindingModel._Cantidad = obj.Cantidad;

        	buffer_V_movto_provdevoWFBindingModel._Preciolista = obj.Preciolista;

        	buffer_V_movto_provdevoWFBindingModel._Descuentoporcentaje = obj.Descuentoporcentaje;

        	buffer_V_movto_provdevoWFBindingModel._Descuento = obj.Descuento;

        	buffer_V_movto_provdevoWFBindingModel._Precio = obj.Precio;

        	buffer_V_movto_provdevoWFBindingModel._Importe = obj.Importe;

        	buffer_V_movto_provdevoWFBindingModel._Subtotal = obj.Subtotal;

        	buffer_V_movto_provdevoWFBindingModel._Iva = obj.Iva;

        	buffer_V_movto_provdevoWFBindingModel._Ieps = obj.Ieps;

        	buffer_V_movto_provdevoWFBindingModel._Tasaiva = obj.Tasaiva;

        	buffer_V_movto_provdevoWFBindingModel._Tasaieps = obj.Tasaieps;

        	buffer_V_movto_provdevoWFBindingModel._Total = obj.Total;

        	buffer_V_movto_provdevoWFBindingModel._Lote = obj.Lote;

        	buffer_V_movto_provdevoWFBindingModel._Fechavence = obj.Fechavence;

        	buffer_V_movto_provdevoWFBindingModel._Loteimportado = obj.Loteimportado;

        	buffer_V_movto_provdevoWFBindingModel._Doctoid = obj.Doctoid;

        	buffer_V_movto_provdevoWFBindingModel._Orden = obj.Orden;

        	buffer_V_movto_provdevoWFBindingModel._Descuentovale = obj.Descuentovale;

        	buffer_V_movto_provdevoWFBindingModel._Descuentovaleporcentaje = obj.Descuentovaleporcentaje;

        	buffer_V_movto_provdevoWFBindingModel._Ingresopreciomanual = obj.Ingresopreciomanual;

        	buffer_V_movto_provdevoWFBindingModel._Porcentajedescuentomanual = obj.Porcentajedescuentomanual;

        	buffer_V_movto_provdevoWFBindingModel._Descripcion1 = obj.Descripcion1;

        	buffer_V_movto_provdevoWFBindingModel._Descripcion2 = obj.Descripcion2;

        	buffer_V_movto_provdevoWFBindingModel._Descripcion3 = obj.Descripcion3;

        	buffer_V_movto_provdevoWFBindingModel._Cantidadsurtida = obj.Cantidadsurtida;

        	buffer_V_movto_provdevoWFBindingModel._Precio1 = obj.Precio1;

        	buffer_V_movto_provdevoWFBindingModel._Existencia = obj.Existencia;

        	buffer_V_movto_provdevoWFBindingModel._Pzacaja = obj.Pzacaja;

        	buffer_V_movto_provdevoWFBindingModel._Texto1 = obj.Texto1;

        	buffer_V_movto_provdevoWFBindingModel._Texto2 = obj.Texto2;

        	buffer_V_movto_provdevoWFBindingModel._Texto3 = obj.Texto3;

        	buffer_V_movto_provdevoWFBindingModel._Texto4 = obj.Texto4;

        	buffer_V_movto_provdevoWFBindingModel._Texto5 = obj.Texto5;

        	buffer_V_movto_provdevoWFBindingModel._Texto6 = obj.Texto6;

        	buffer_V_movto_provdevoWFBindingModel._Numero1 = obj.Numero1;

        	buffer_V_movto_provdevoWFBindingModel._Numero2 = obj.Numero2;

        	buffer_V_movto_provdevoWFBindingModel._Numero3 = obj.Numero3;

        	buffer_V_movto_provdevoWFBindingModel._Numero4 = obj.Numero4;

        	buffer_V_movto_provdevoWFBindingModel._Fecha1 = obj.Fecha1;

        	buffer_V_movto_provdevoWFBindingModel._Fecha2 = obj.Fecha2;

        	buffer_V_movto_provdevoWFBindingModel._Unidadid = obj.Unidadid;

        	buffer_V_movto_provdevoWFBindingModel._UnidadClave = obj.UnidadClave;

        	buffer_V_movto_provdevoWFBindingModel._UnidadNombre = obj.UnidadNombre;

        	buffer_V_movto_provdevoWFBindingModel._Alerta3 = obj.Alerta3;

        	buffer_V_movto_provdevoWFBindingModel._Preciomostrar = obj.Preciomostrar;

        	buffer_V_movto_provdevoWFBindingModel._Descuentomostrar = obj.Descuentomostrar;

        	buffer_V_movto_provdevoWFBindingModel._Devolucionmovtorefid = obj.Devolucionmovtorefid;

        	buffer_V_movto_provdevoWFBindingModel._Devolucionmovtorefcantidad = obj.Devolucionmovtorefcantidad;

        	buffer_V_movto_provdevoWFBindingModel._Devolucionmovtorefprecio = obj.Devolucionmovtorefprecio;

            return buffer_V_movto_provdevoWFBindingModel;
        }
