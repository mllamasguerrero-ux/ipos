...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class PuntoCompraBindingModel : Validatable
    {
        ...
        public List<V_movto_proveeduriaWFBindingModel> MovtoItems { get; set; }


        //Operation result properties
        public BaseResultBindingModel? Fnc_docto_proveeduria_insertResult { get; set; }
        public BaseResultBindingModel? Fnc_movto_proveeduria_insertResult { get; set; }


        public List<MovtoProvTrans>? MovtoTransList { get; set; }
