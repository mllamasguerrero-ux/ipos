...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class V_movto_vend_to_devoWFBindingModel : Validatable
    {

        public V_movto_vend_to_devoWFBindingModel()
        {
        ...
        public static V_movto_vend_to_devoWFBindingModel CreateFromAnonymous( dynamic obj)
        {
            var buffer_V_movto_vend_to_devoWFBindingModel = new V_movto_vend_to_devoWFBindingModel();

        	buffer_V_movto_vend_to_devoWFBindingModel._DoctoRefId = obj.DoctoRefId;

        	buffer_V_movto_vend_to_devoWFBindingModel._Movtorefid = obj.Movtorefid;

        	buffer_V_movto_vend_to_devoWFBindingModel._Partidaref = obj.Partidaref;

        	buffer_V_movto_vend_to_devoWFBindingModel._Cantidadref = obj.Cantidadref;

        	buffer_V_movto_vend_to_devoWFBindingModel._Descripcion = obj.Descripcion;

        	buffer_V_movto_vend_to_devoWFBindingModel._Preciounidadref = obj.Preciounidadref;

        	buffer_V_movto_vend_to_devoWFBindingModel._Importeref = obj.Importeref;

        	buffer_V_movto_vend_to_devoWFBindingModel._Descuentoref = obj.Descuentoref;

        	buffer_V_movto_vend_to_devoWFBindingModel._Descripcion2 = obj.Descripcion2;

        	buffer_V_movto_vend_to_devoWFBindingModel._Lote = obj.Lote;

        	buffer_V_movto_vend_to_devoWFBindingModel._Claveproducto = obj.Claveproducto;

        	buffer_V_movto_vend_to_devoWFBindingModel._Subtotalref = obj.Subtotalref;

        	buffer_V_movto_vend_to_devoWFBindingModel._Ivaref = obj.Ivaref;

        	buffer_V_movto_vend_to_devoWFBindingModel._Cantidad = obj.Cantidad;

        	buffer_V_movto_vend_to_devoWFBindingModel._Movtoid = obj.Movtoid;

        	buffer_V_movto_vend_to_devoWFBindingModel._Preciounidad = obj.Preciounidad;

        	buffer_V_movto_vend_to_devoWFBindingModel._Subtotal = obj.Subtotal;

        	buffer_V_movto_vend_to_devoWFBindingModel._Importe = obj.Importe;

        	buffer_V_movto_vend_to_devoWFBindingModel._Partida = obj.Partida;

        	buffer_V_movto_vend_to_devoWFBindingModel._Cantidaddevuelta = obj.Cantidaddevuelta;

        	buffer_V_movto_vend_to_devoWFBindingModel._Cantdisp = obj.Cantdisp;

        	buffer_V_movto_vend_to_devoWFBindingModel._Cantdispdespues = obj.Cantdispdespues;

        	buffer_V_movto_vend_to_devoWFBindingModel._Tasaiva = obj.Tasaiva;

        	buffer_V_movto_vend_to_devoWFBindingModel._Tasaieps = obj.Tasaieps;

        	buffer_V_movto_vend_to_devoWFBindingModel._EmpresaId = obj.EmpresaId;

        	buffer_V_movto_vend_to_devoWFBindingModel._SucursalId = obj.SucursalId;

        	buffer_V_movto_vend_to_devoWFBindingModel._Productoid = obj.Productoid;

        	buffer_V_movto_vend_to_devoWFBindingModel._Descripcion1 = obj.Descripcion1;

        	buffer_V_movto_vend_to_devoWFBindingModel._Descripcion3 = obj.Descripcion3;

        	buffer_V_movto_vend_to_devoWFBindingModel._Fechavence = obj.Fechavence;

        	buffer_V_movto_vend_to_devoWFBindingModel._Loteimportado = obj.Loteimportado;

            return buffer_V_movto_vend_to_devoWFBindingModel;
        }
