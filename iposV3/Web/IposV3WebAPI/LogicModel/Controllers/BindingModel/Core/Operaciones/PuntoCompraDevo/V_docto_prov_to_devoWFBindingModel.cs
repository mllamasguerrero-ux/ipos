...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class V_docto_prov_to_devoWFBindingModel : Validatable
    {

        public V_docto_prov_to_devoWFBindingModel()
        {
        ...
        public static V_docto_prov_to_devoWFBindingModel CreateFromAnonymous( dynamic obj)
        {
            var buffer_V_docto_proveeduriaWFBindingModel = new V_docto_prov_to_devoWFBindingModel();
    ...
    [XmlRoot]
    public class V_docto_prov_to_devoParamWFBindingModel : Validatable
    {

        public V_docto_prov_to_devoParamWFBindingModel()
        {
            FillCatalogRelatedFields();
        }
