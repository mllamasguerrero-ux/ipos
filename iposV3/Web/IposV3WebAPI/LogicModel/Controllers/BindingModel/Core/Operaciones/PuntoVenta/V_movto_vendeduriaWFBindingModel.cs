...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class V_movto_vendeduriaWFBindingModel : Validatable, IRecordColor
    {

        public V_movto_vendeduriaWFBindingModel()
        {
        ...
        public static V_movto_vendeduriaWFBindingModel CreateFromAnonymous( dynamic obj)
        {
            var buffer_V_movto_vendeduriaWFBindingModel = new V_movto_vendeduriaWFBindingModel();

        	buffer_V_movto_vendeduriaWFBindingModel._EmpresaId = obj.EmpresaId;

        	buffer_V_movto_vendeduriaWFBindingModel._SucursalId = obj.SucursalId;

        	buffer_V_movto_vendeduriaWFBindingModel._Id = obj.Id;

        	buffer_V_movto_vendeduriaWFBindingModel._Partida = obj.Partida;

        	buffer_V_movto_vendeduriaWFBindingModel._Productoid = obj.Productoid;

        	buffer_V_movto_vendeduriaWFBindingModel._ProductoClave = obj.ProductoClave;

        	buffer_V_movto_vendeduriaWFBindingModel._ProductoNombre = obj.ProductoNombre;

        	buffer_V_movto_vendeduriaWFBindingModel._Cantidad = obj.Cantidad;

        	buffer_V_movto_vendeduriaWFBindingModel._Preciolista = obj.Preciolista;

            buffer_V_movto_vendeduriaWFBindingModel._Preciolista = obj.Preciomanual;

            buffer_V_movto_vendeduriaWFBindingModel._Descuentoporcentaje = obj.Descuentoporcentaje;

        	buffer_V_movto_vendeduriaWFBindingModel._Descuento = obj.Descuento;

        	buffer_V_movto_vendeduriaWFBindingModel._Precio = obj.Precio;

        	buffer_V_movto_vendeduriaWFBindingModel._Importe = obj.Importe;

        	buffer_V_movto_vendeduriaWFBindingModel._Subtotal = obj.Subtotal;

        	buffer_V_movto_vendeduriaWFBindingModel._Iva = obj.Iva;

        	buffer_V_movto_vendeduriaWFBindingModel._Ieps = obj.Ieps;

        	buffer_V_movto_vendeduriaWFBindingModel._Tasaiva = obj.Tasaiva;

        	buffer_V_movto_vendeduriaWFBindingModel._Tasaieps = obj.Tasaieps;

        	buffer_V_movto_vendeduriaWFBindingModel._Total = obj.Total;

        	buffer_V_movto_vendeduriaWFBindingModel._Lote = obj.Lote;

        	buffer_V_movto_vendeduriaWFBindingModel._Fechavence = obj.Fechavence;

        	buffer_V_movto_vendeduriaWFBindingModel._Loteimportado = obj.Loteimportado;

        	buffer_V_movto_vendeduriaWFBindingModel._Doctoid = obj.Doctoid;

        	buffer_V_movto_vendeduriaWFBindingModel._Orden = obj.Orden;

        	buffer_V_movto_vendeduriaWFBindingModel._Descuentovale = obj.Descuentovale;

        	buffer_V_movto_vendeduriaWFBindingModel._Descuentovaleporcentaje = obj.Descuentovaleporcentaje;

        	buffer_V_movto_vendeduriaWFBindingModel._Ingresopreciomanual = obj.Ingresopreciomanual;

        	buffer_V_movto_vendeduriaWFBindingModel._Porcentajedescuentomanual = obj.Porcentajedescuentomanual;

        	buffer_V_movto_vendeduriaWFBindingModel._Descripcion1 = obj.Descripcion1;

        	buffer_V_movto_vendeduriaWFBindingModel._Descripcion2 = obj.Descripcion2;

        	buffer_V_movto_vendeduriaWFBindingModel._Descripcion3 = obj.Descripcion3;

        	buffer_V_movto_vendeduriaWFBindingModel._Cantidadsurtida = obj.Cantidadsurtida;

        	buffer_V_movto_vendeduriaWFBindingModel._Precio1 = obj.Precio1;

        	buffer_V_movto_vendeduriaWFBindingModel._Existencia = obj.Existencia;

        	buffer_V_movto_vendeduriaWFBindingModel._Pzacaja = obj.Pzacaja;

        	buffer_V_movto_vendeduriaWFBindingModel._Texto1 = obj.Texto1;

        	buffer_V_movto_vendeduriaWFBindingModel._Texto2 = obj.Texto2;

        	buffer_V_movto_vendeduriaWFBindingModel._Texto3 = obj.Texto3;

        	buffer_V_movto_vendeduriaWFBindingModel._Texto4 = obj.Texto4;

        	buffer_V_movto_vendeduriaWFBindingModel._Texto5 = obj.Texto5;

        	buffer_V_movto_vendeduriaWFBindingModel._Texto6 = obj.Texto6;

        	buffer_V_movto_vendeduriaWFBindingModel._Numero1 = obj.Numero1;

        	buffer_V_movto_vendeduriaWFBindingModel._Numero2 = obj.Numero2;

        	buffer_V_movto_vendeduriaWFBindingModel._Numero3 = obj.Numero3;

        	buffer_V_movto_vendeduriaWFBindingModel._Numero4 = obj.Numero4;

        	buffer_V_movto_vendeduriaWFBindingModel._Fecha1 = obj.Fecha1;

        	buffer_V_movto_vendeduriaWFBindingModel._Fecha2 = obj.Fecha2;

        	buffer_V_movto_vendeduriaWFBindingModel._Unidadid = obj.Unidadid;

        	buffer_V_movto_vendeduriaWFBindingModel._UnidadClave = obj.UnidadClave;

        	buffer_V_movto_vendeduriaWFBindingModel._UnidadNombre = obj.UnidadNombre;

        	buffer_V_movto_vendeduriaWFBindingModel._Alerta3 = obj.Alerta3;

        	buffer_V_movto_vendeduriaWFBindingModel._Preciomostrar = obj.Preciomostrar;

        	buffer_V_movto_vendeduriaWFBindingModel._Descuentomostrar = obj.Descuentomostrar;

            return buffer_V_movto_vendeduriaWFBindingModel;
        }



        public string hexRecordColor()
        {
            switch (this.Alerta3)
            {
                case "PRECIO MENOR A PRECIO MINIMO":
                    return "#FFFF00";//"AMARILLO";
                case "PRECIO MENOR AL COSTO":
                    return "#FF0000"; //"ROJO";
                default:
        ...
        public string hexTextRecordColor()
        {
            switch (this.Alerta3)
            {
                case "PRECIO MENOR A PRECIO MINIMO":
                    return "#000000";//"AMARILLO";
                case "PRECIO MENOR AL COSTO":
                    return "#FFFFFF";  //"ROJO";
                default:
                    return "#000000";//"BLANCO";
            }
        }
