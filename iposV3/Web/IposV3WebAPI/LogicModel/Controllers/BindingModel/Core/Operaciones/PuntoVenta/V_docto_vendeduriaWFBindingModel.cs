...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class V_docto_vendeduriaWFBindingModel : Validatable
    {

        public V_docto_vendeduriaWFBindingModel()
        {
        ...
        public static V_docto_vendeduriaWFBindingModel CreateFromAnonymous( dynamic obj)
        {
            var buffer_V_docto_vendeduriaWFBindingModel = new V_docto_vendeduriaWFBindingModel();
    ...
    [XmlRoot]
    public class V_docto_vendeduriaParamWFBindingModel : Validatable
    {

        public V_docto_vendeduriaParamWFBindingModel()
        {
            FillCatalogRelatedFields();
        }
