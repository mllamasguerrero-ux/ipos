...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class PuntoVentaBindingModel : Validatable
    {
        ...
        public List<V_movto_vendeduriaWFBindingModel> MovtoItems { get; set; }
        ...
        public List<MovtoVendTrans>? MovtoTransList { get; set; }
