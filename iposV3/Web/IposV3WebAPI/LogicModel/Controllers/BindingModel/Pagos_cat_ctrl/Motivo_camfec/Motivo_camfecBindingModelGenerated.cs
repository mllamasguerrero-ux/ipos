...
namespace BindingModels
{
    ...
    public class Motivo_camfecBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Motivo_camfecBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public Motivo_camfecBindingModelGenerated(Motivo_camfec item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Motivo_camfec"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Motivo_camfec item)
        {
        ...
        public void FillEntityValues(ref Motivo_camfec item)
        {
        ...
        public void FillFromEntity(Motivo_camfec item)
        {
