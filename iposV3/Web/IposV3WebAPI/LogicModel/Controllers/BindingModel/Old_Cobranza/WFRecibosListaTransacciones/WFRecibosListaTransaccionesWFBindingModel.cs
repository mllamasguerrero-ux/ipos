...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFRecibosListaTransaccionesWFBindingModel : Validatable
    {

        public WFRecibosListaTransaccionesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFRecibosListaTransaccionesWF_Transacciones_listaBindingModel : Validatable
    {

        public WFRecibosListaTransaccionesWF_Transacciones_listaBindingModel()
        {
            FillCatalogRelatedFields();
        }
