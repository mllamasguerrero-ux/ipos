...
namespace IposV3Sync.Controllers.Controller.Utils
{
    public class CatalogSelector
    {
        private OperationsContextFactory _operationsContextFactory;
        public CatalogSelector(OperationsContextFactory operationsContextFactory)
        {
        ...
        public List<BaseSelector>? obtainCatalog(CatalogDef catalogDef, BaseParam defaultParam)
        {
            ...
            switch (catalogDef.CatalogName)
            {
                ...
                case "Empresa":
                    ...
                    //var test = applicationDbContext.ConnectionString;
            ...
            switch (catalogDef.CatalogName)
            {
                ...
                case "Sat_colonia":
                    ...
                    ret = applicationDbContext.Sat_colonia
                            .Where(x =>  (x.Colonia != null && x.Colonia.ToLower() == claveToLower))
                            .Select(x => new BaseSelector(x.EmpresaId, x.SucursalId, x.Id, x.Clave, (x.Nombre ?? "")))
                            .FirstOrDefault();
                    break;
                ...
                case "Sat_localidad":
                    ...
                    ret = applicationDbContext.Sat_localidad
                            .Where(x =>  (x.Clave_localidad != null && x.Clave_localidad.ToLower() == claveToLower))
                            .Select(x => new BaseSelector(x.EmpresaId, x.SucursalId, x.Id, x.Clave, x.Nombre))
                            .FirstOrDefault();
                    break;
                ...
                case "Sat_municipio":
                    ...
                    ret = applicationDbContext.Sat_municipio
                            .Where(x =>  ( x.Clave_municipio != null &&  x.Clave_municipio.ToLower() == claveToLower))
                            .Select(x => new BaseSelector(x.EmpresaId, x.SucursalId, x.Id, x.Clave, x.Nombre))
                            .FirstOrDefault();
                    break;
