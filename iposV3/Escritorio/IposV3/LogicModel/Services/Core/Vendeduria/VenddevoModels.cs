...
namespace IposV3.Services
{
    ...
    public class DoctoVenddevoTrans
    {
        ...
        public BoolCN? Mercanciaentregada { get; set; }
        public TipoPagoConTarjeta? Pagocontarjeta { get; set; }
        public BoolCN? Pagoacredito { get; set; }
        public long? Doctoadevolverid { get; set; }
        public DateTimeOffset? Fechavence { get; set; }

    }

    public class MovtoVenddevoTrans
    {
        public long Empresaid { get; set; }
        public long Sucursalid { get; set; }
