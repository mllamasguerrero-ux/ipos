...
namespace BindingModels
{
    ...
    public class TipoprecioBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public TipoprecioBindingModelGenerated()
        {
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Tipoprecio"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
