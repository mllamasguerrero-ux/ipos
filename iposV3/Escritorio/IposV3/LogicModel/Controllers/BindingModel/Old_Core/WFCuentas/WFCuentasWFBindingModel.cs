...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFCuentasWFBindingModel : Validatable
    {

        public WFCuentasWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFCuentasWF_TableBindingModel : Validatable
    {

        public WFCuentasWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
