...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFPagosBasicoWFBindingModel : Validatable
    {

        public WFPagosBasicoWFBindingModel()
        {
        ...
        private string? _Tbmonederoaplicado;
        [XmlAttribute]
        public string? Tbmonederoaplicado { get => _Tbmonederoaplicado; set { if (RaiseAcceptPendingChange(value, _Tbmonederoaplicado)) { _Tbmonederoaplicado = value; OnPropertyChanged(); } } }

        private string? _Tbnumeromonedero;
        [XmlAttribute]
        public string? Tbnumeromonedero { get => _Tbnumeromonedero; set { if (RaiseAcceptPendingChange(value, _Tbnumeromonedero)) { _Tbnumeromonedero = value; OnPropertyChanged(); } } }
        ...
        private decimal? _Lblcreditoautomatico;
        [XmlAttribute]
        public decimal? Lblcreditoautomatico { get => _Lblcreditoautomatico; set { if (RaiseAcceptPendingChange(value, _Lblcreditoautomatico)) { _Lblcreditoautomatico = value; OnPropertyChanged(); } } }
        ...
        private BoolCN? _Cbcomprobantetraslado;
        [XmlAttribute]
        public BoolCN? Cbcomprobantetraslado { get => _Cbcomprobantetraslado; set { if (RaiseAcceptPendingChange(value, _Cbcomprobantetraslado)) { _Cbcomprobantetraslado = value; OnPropertyChanged(); } } }

        private BoolCN? _Cbcartaporte;
        [XmlAttribute]
        public BoolCN? Cbcartaporte { get => _Cbcartaporte; set { if (RaiseAcceptPendingChange(value, _Cbcartaporte)) { _Cbcartaporte = value; OnPropertyChanged(); } } }
