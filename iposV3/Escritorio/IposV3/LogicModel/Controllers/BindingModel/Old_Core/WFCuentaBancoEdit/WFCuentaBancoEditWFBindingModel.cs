...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFCuentaBancoEditWFBindingModel : Validatable
    {

        public WFCuentaBancoEditWFBindingModel()
        {
        ...
        [XmlAttribute]
        public BoolCN? Predeterminada { get => _Predeterminada; set { if (RaiseAcceptPendingChange(value, _Predeterminada)) { _Predeterminada = value; OnPropertyChanged(); } } }
