...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFImportarOrdenesWFBindingModel : Validatable
    {

        public WFImportarOrdenesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFImportarOrdenesWF_Imp_filesBindingModel : Validatable
    {

        public WFImportarOrdenesWF_Imp_filesBindingModel()
        {
            FillCatalogRelatedFields();
        }
