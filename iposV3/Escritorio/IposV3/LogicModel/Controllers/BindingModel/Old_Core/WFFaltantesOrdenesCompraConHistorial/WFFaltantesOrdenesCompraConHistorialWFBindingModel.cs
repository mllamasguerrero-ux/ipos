...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFFaltantesOrdenesCompraConHistorialWFBindingModel : Validatable
    {

        public WFFaltantesOrdenesCompraConHistorialWFBindingModel()
        {
        ...
        private BoolCN? _Cbtraslados;
        [XmlAttribute]
        public BoolCN? Cbtraslados { get => _Cbtraslados; set { if (RaiseAcceptPendingChange(value, _Cbtraslados)) { _Cbtraslados = value; OnPropertyChanged(); } } }
