...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class LookUpSucursalesWFBindingModel : Validatable
    {

        public LookUpSucursalesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class LookUpSucursalesWF_SucursaltrasladosBindingModel : Validatable
    {

        public LookUpSucursalesWF_SucursaltrasladosBindingModel()
        {
            FillCatalogRelatedFields();
        }
