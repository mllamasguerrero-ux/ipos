...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFImportarOrdenesDetWFBindingModel : Validatable
    {

        public WFImportarOrdenesDetWFBindingModel()
        {
        ...
        private BoolCN? _Cbmostrarusd;
        [XmlAttribute]
        public BoolCN? Cbmostrarusd { get => _Cbmostrarusd; set { if (RaiseAcceptPendingChange(value, _Cbmostrarusd)) { _Cbmostrarusd = value; OnPropertyChanged(); } } }
        ...
        private string? _Tbusdtotal;
        [XmlAttribute]
        public string? Tbusdtotal { get => _Tbusdtotal; set { if (RaiseAcceptPendingChange(value, _Tbusdtotal)) { _Tbusdtotal = value; OnPropertyChanged(); } } }
    ...
    [XmlRoot]
    public class WFImportarOrdenesDetWF_Imp_rec_detBindingModel : Validatable
    {

        public WFImportarOrdenesDetWF_Imp_rec_detBindingModel()
        {
            FillCatalogRelatedFields();
        }
        ...
        private string? _Cambiarlote;
        [XmlAttribute]
        public string? Cambiarlote { get => _Cambiarlote; set { if (RaiseAcceptPendingChange(value, _Cambiarlote)) { _Cambiarlote = value; OnPropertyChanged(); } } }

        private string? _Otrolote;
        [XmlAttribute]
        public string? Otrolote { get => _Otrolote; set { if (RaiseAcceptPendingChange(value, _Otrolote)) { _Otrolote = value; OnPropertyChanged(); } } }
        ...
        private decimal? _Importeendolar;
        [XmlAttribute]
        public decimal? Importeendolar { get => _Importeendolar; set { if (RaiseAcceptPendingChange(value, _Importeendolar)) { _Importeendolar = value; OnPropertyChanged(); } } }

        private string? _Productoean;
        [XmlAttribute]
        public string? Productoean { get => _Productoean; set { if (RaiseAcceptPendingChange(value, _Productoean)) { _Productoean = value; OnPropertyChanged(); } } }
        ...
        private string? _Manejaloteimportado;
        [XmlAttribute]
        public string? Manejaloteimportado { get => _Manejaloteimportado; set { if (RaiseAcceptPendingChange(value, _Manejaloteimportado)) { _Manejaloteimportado = value; OnPropertyChanged(); } } }
