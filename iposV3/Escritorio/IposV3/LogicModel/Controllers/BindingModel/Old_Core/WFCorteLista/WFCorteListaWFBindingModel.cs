...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFCorteListaWFBindingModel : Validatable
    {

        public WFCorteListaWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFCorteListaWF_CortessinrecoleccionBindingModel : Validatable
    {

        public WFCorteListaWF_CortessinrecoleccionBindingModel()
        {
            FillCatalogRelatedFields();
        }
