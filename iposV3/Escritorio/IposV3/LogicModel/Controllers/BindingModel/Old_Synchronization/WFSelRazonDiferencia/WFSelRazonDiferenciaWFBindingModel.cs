...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFSelRazonDiferenciaWFBindingModel : Validatable
    {

        public WFSelRazonDiferenciaWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFSelRazonDiferenciaWF_TipodiferenciainventarioBindingModel : Validatable
    {

        public WFSelRazonDiferenciaWF_TipodiferenciainventarioBindingModel()
        {
            FillCatalogRelatedFields();
        }
