...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFImportarComprasWFBindingModel : Validatable
    {

        public WFImportarComprasWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFImportarComprasWF_Imp_filesBindingModel : Validatable
    {

        public WFImportarComprasWF_Imp_filesBindingModel()
        {
            FillCatalogRelatedFields();
        }
