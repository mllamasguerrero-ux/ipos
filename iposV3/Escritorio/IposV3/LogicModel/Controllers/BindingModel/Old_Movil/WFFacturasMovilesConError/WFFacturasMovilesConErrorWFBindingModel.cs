...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFFacturasMovilesConErrorWFBindingModel : Validatable
    {

        public WFFacturasMovilesConErrorWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFFacturasMovilesConErrorWF_FacturasconerrorBindingModel : Validatable
    {

        public WFFacturasMovilesConErrorWF_FacturasconerrorBindingModel()
        {
            FillCatalogRelatedFields();
        }
