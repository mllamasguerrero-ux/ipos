...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFVerificarCXCPedidoMovilWFBindingModel : Validatable
    {

        public WFVerificarCXCPedidoMovilWFBindingModel()
        {
        ...
        private long? _Cbmostraropciones;
        [XmlAttribute]
        public long? Cbmostraropciones { get => _Cbmostraropciones; set { if (RaiseAcceptPendingChange(value, _Cbmostraropciones)) { _Cbmostraropciones = value; OnPropertyChanged(); } } }

        private string? _CbmostraropcionesClave;
        [XmlAttribute]
        public string? CbmostraropcionesClave { get => _CbmostraropcionesClave; set { if (RaiseAcceptPendingChange(value, _CbmostraropcionesClave)) { _CbmostraropcionesClave = value; OnPropertyChanged(); } } }

        private string? _CbmostraropcionesNombre;
        [XmlAttribute]
        public string? CbmostraropcionesNombre { get => _CbmostraropcionesNombre; set { if (RaiseAcceptPendingChange(value, _CbmostraropcionesNombre)) { _CbmostraropcionesNombre = value; OnPropertyChanged(); } } }
    ...
    [XmlRoot]
    public class WFVerificarCXCPedidoMovilWF_DoctosasurtirBindingModel : Validatable
    {

        public WFVerificarCXCPedidoMovilWF_DoctosasurtirBindingModel()
        {
            FillCatalogRelatedFields();
        }
        ...
        private decimal? _Cobranzaaplicada;
        [XmlAttribute]
        public decimal? Cobranzaaplicada { get => _Cobranzaaplicada; set { if (RaiseAcceptPendingChange(value, _Cobranzaaplicada)) { _Cobranzaaplicada = value; OnPropertyChanged(); } } }

        private string? _Creditoaprobado;
        [XmlAttribute]
        public string? Creditoaprobado { get => _Creditoaprobado; set { if (RaiseAcceptPendingChange(value, _Creditoaprobado)) { _Creditoaprobado = value; OnPropertyChanged(); } } }
