...
namespace BindingModels
{
    ...
    public class Sat_matpeligrosoBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Sat_matpeligrosoBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public Sat_matpeligrosoBindingModelGenerated(Sat_matpeligroso item)
        {
            FillFromEntity(item);
        }
        ...
        [XmlAttribute]
        public string? Clase { get => _Clase; set { if (RaiseAcceptPendingChange(value, _Clase)) { _Clase = value; OnPropertyChanged(); } } }

        private string? _Peligro_secundario;
        [XmlAttribute]
        public string? Peligro_secundario { get => _Peligro_secundario; set { if (RaiseAcceptPendingChange(value, _Peligro_secundario)) { _Peligro_secundario = value; OnPropertyChanged(); } } }

        private string? _Nombre_tecnico;
        [XmlAttribute]
        public string? Nombre_tecnico { get => _Nombre_tecnico; set { if (RaiseAcceptPendingChange(value, _Nombre_tecnico)) { _Nombre_tecnico = value; OnPropertyChanged(); } } }

        public static string GetBaseQuery()
        {

            return $@"SELECT * FROM ""Sat_matpeligroso""  ";
        ...
        {
            return @"Clave|Descripcion|Nombre|Clase|Peligro_secundario|Nombre_tecnico";
        }



        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Sat_matpeligroso item)
        {
        ...
        public void FillEntityValues(ref Sat_matpeligroso item)
        {
            ...
            item.Peligro_secundario = Peligro_secundario ;
        ...
        public void FillFromEntity(Sat_matpeligroso item)
        {
