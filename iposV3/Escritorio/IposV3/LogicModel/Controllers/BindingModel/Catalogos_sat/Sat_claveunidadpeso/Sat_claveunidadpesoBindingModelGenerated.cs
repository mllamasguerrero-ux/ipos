...
namespace BindingModels
{
    ...
    public class Sat_claveunidadpesoBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Sat_claveunidadpesoBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public Sat_claveunidadpesoBindingModelGenerated(Sat_claveunidadpeso item)
        {
            FillFromEntity(item);
        }
        ...
        [XmlAttribute]
        public string? Simbolo { get => _Simbolo; set { if (RaiseAcceptPendingChange(value, _Simbolo)) { _Simbolo = value; OnPropertyChanged(); } } }

        private string? _Bandera;
        [XmlAttribute]
        public string? Bandera { get => _Bandera; set { if (RaiseAcceptPendingChange(value, _Bandera)) { _Bandera = value; OnPropertyChanged(); } } }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Sat_claveunidadpeso""  ";
        ...
        {
            return @"Clave|Descripcion|Nombre|Simbolo|Bandera|Nota";
        }



        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Sat_claveunidadpeso item)
        {
        ...
        public void FillEntityValues(ref Sat_claveunidadpeso item)
        {
        ...
        public void FillFromEntity(Sat_claveunidadpeso item)
        {
