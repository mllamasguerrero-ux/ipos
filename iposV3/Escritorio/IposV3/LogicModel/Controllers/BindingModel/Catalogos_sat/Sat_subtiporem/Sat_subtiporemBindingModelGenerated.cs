...
namespace BindingModels
{
    ...
    public class Sat_subtiporemBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Sat_subtiporemBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public Sat_subtiporemBindingModelGenerated(Sat_subtiporem item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Sat_subtiporem"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Sat_subtiporem item)
        {
        ...
        public void FillEntityValues(ref Sat_subtiporem item)
        {
        ...
        public void FillFromEntity(Sat_subtiporem item)
        {
