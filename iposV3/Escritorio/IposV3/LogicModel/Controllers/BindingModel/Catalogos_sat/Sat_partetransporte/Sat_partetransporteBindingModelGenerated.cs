...
namespace BindingModels
{
    ...
    public class Sat_partetransporteBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public Sat_partetransporteBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public Sat_partetransporteBindingModelGenerated(Sat_partetransporte item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Sat_partetransporte"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Sat_partetransporte item)
        {
        ...
        public void FillEntityValues(ref Sat_partetransporte item)
        {
        ...
        public void FillFromEntity(Sat_partetransporte item)
        {
