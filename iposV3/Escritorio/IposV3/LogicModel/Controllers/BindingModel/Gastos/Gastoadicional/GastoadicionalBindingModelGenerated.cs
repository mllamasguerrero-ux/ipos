...
namespace BindingModels
{
    ...
    public class GastoadicionalBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public GastoadicionalBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public GastoadicionalBindingModelGenerated(Gastoadicional item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Gastoadicional"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Gastoadicional item)
        {
        ...
        public void FillEntityValues(ref Gastoadicional item)
        {
        ...
        public void FillFromEntity(Gastoadicional item)
        {
