...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFEstadisticosProductoVentaWFBindingModel : Validatable
    {

        public WFEstadisticosProductoVentaWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFEstadisticosProductoVentaWF_Ttl_rep_prod_venta_comparacionBindingModel : Validatable
    {

        public WFEstadisticosProductoVentaWF_Ttl_rep_prod_venta_comparacionBindingModel()
        {
            FillCatalogRelatedFields();
        }
