...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class FormTestKardexWFBindingModel : Validatable
    {

        public FormTestKardexWFBindingModel()
        {
    ...
    [XmlRoot]
    public class FormTestKardexWF_Get_kardexBindingModel : Validatable
    {

        public FormTestKardexWF_Get_kardexBindingModel()
        {
            FillCatalogRelatedFields();
        }
