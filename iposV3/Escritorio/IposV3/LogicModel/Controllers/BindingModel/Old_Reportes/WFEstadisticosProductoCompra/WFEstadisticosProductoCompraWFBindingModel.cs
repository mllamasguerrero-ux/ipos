...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFEstadisticosProductoCompraWFBindingModel : Validatable
    {

        public WFEstadisticosProductoCompraWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFEstadisticosProductoCompraWF_Ttl_rep_prod_venta_comparacionBindingModel : Validatable
    {

        public WFEstadisticosProductoCompraWF_Ttl_rep_prod_venta_comparacionBindingModel()
        {
            FillCatalogRelatedFields();
        }
