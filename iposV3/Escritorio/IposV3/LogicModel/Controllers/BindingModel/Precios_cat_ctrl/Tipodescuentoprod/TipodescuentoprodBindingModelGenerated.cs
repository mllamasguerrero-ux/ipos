...
namespace BindingModels
{
    ...
    public class TipodescuentoprodBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public TipodescuentoprodBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public TipodescuentoprodBindingModelGenerated(Tipodescuentoprod item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Tipodescuentoprod"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Tipodescuentoprod item)
        {
        ...
        public void FillEntityValues(ref Tipodescuentoprod item)
        {
        ...
        public void FillFromEntity(Tipodescuentoprod item)
        {
