...
namespace BindingModels
{
    ...
    public class ClasificaBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public ClasificaBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public ClasificaBindingModelGenerated(Clasifica item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Clasifica"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Clasifica item)
        {
        ...
        public void FillEntityValues(ref Clasifica item)
        {
        ...
        public void FillFromEntity(Clasifica item)
        {
