...
namespace BindingModels
{
    ...
    public class EstadopagocontrareciboBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public EstadopagocontrareciboBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public EstadopagocontrareciboBindingModelGenerated(Estadopagocontrarecibo item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Estadopagocontrarecibo"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Estadopagocontrarecibo item)
        {
        ...
        public void FillEntityValues(ref Estadopagocontrarecibo item)
        {
        ...
        public void FillFromEntity(Estadopagocontrarecibo item)
        {
