...
namespace BindingModels
{
    ...
    public class EstadopaisBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public EstadopaisBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public EstadopaisBindingModelGenerated(Estadopais item)
        {
            FillFromEntity(item);
        }
        ...
        [XmlAttribute]
        public string? Acronimo { get => _Acronimo; set { if (RaiseAcceptPendingChange(value, _Acronimo)) { _Acronimo = value; OnPropertyChanged(); } } }

        public static string GetBaseQuery()
        {

            return $@"SELECT * FROM ""Estadopais"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        {
            return @"Clave|Nombre|Acronimo";
        }


        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Estadopais item)
        {
        ...
        public void FillEntityValues(ref Estadopais item)
        {
            ...
            item.Acronimo = Acronimo ;



        }

        public void FillFromEntity(Estadopais item)
        {
