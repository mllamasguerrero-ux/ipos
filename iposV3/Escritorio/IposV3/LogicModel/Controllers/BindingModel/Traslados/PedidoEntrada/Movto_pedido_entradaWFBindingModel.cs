...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class Movto_pedido_entradaWFBindingModel : Validatable
    {

        public Movto_pedido_entradaWFBindingModel()
        {
        ...
        public static Movto_pedido_entradaWFBindingModel CreateFromAnonymous( dynamic obj)
        {
            var buffer_Movto_pedido_entradaWFBindingModel = new Movto_pedido_entradaWFBindingModel();

        	buffer_Movto_pedido_entradaWFBindingModel._EmpresaId = obj.EmpresaId;

        	buffer_Movto_pedido_entradaWFBindingModel._SucursalId = obj.SucursalId;

        	buffer_Movto_pedido_entradaWFBindingModel._Id = obj.Id;

        	buffer_Movto_pedido_entradaWFBindingModel._Partida = obj.Partida;

        	buffer_Movto_pedido_entradaWFBindingModel._Productoid = obj.Productoid;

        	buffer_Movto_pedido_entradaWFBindingModel._ProductoClave = obj.ProductoClave;

        	buffer_Movto_pedido_entradaWFBindingModel._ProductoNombre = obj.ProductoNombre;

        	buffer_Movto_pedido_entradaWFBindingModel._Cantidad = obj.Cantidad;

        	buffer_Movto_pedido_entradaWFBindingModel._Preciolista = obj.Preciolista;

        	buffer_Movto_pedido_entradaWFBindingModel._Descuentoporcentaje = obj.Descuentoporcentaje;

        	buffer_Movto_pedido_entradaWFBindingModel._Descuento = obj.Descuento;

        	buffer_Movto_pedido_entradaWFBindingModel._Precio = obj.Precio;

        	buffer_Movto_pedido_entradaWFBindingModel._Importe = obj.Importe;

        	buffer_Movto_pedido_entradaWFBindingModel._Subtotal = obj.Subtotal;

        	buffer_Movto_pedido_entradaWFBindingModel._Iva = obj.Iva;

        	buffer_Movto_pedido_entradaWFBindingModel._Ieps = obj.Ieps;

        	buffer_Movto_pedido_entradaWFBindingModel._Tasaiva = obj.Tasaiva;

        	buffer_Movto_pedido_entradaWFBindingModel._Tasaieps = obj.Tasaieps;

        	buffer_Movto_pedido_entradaWFBindingModel._Total = obj.Total;

        	buffer_Movto_pedido_entradaWFBindingModel._Lote = obj.Lote;

        	buffer_Movto_pedido_entradaWFBindingModel._Fechavence = obj.Fechavence;

        	buffer_Movto_pedido_entradaWFBindingModel._Loteimportado = obj.Loteimportado;

        	buffer_Movto_pedido_entradaWFBindingModel._Doctoid = obj.Doctoid;

        	buffer_Movto_pedido_entradaWFBindingModel._Orden = obj.Orden;

        	buffer_Movto_pedido_entradaWFBindingModel._Descuentovale = obj.Descuentovale;

        	buffer_Movto_pedido_entradaWFBindingModel._Descuentovaleporcentaje = obj.Descuentovaleporcentaje;

        	buffer_Movto_pedido_entradaWFBindingModel._Ingresopreciomanual = obj.Ingresopreciomanual;

        	buffer_Movto_pedido_entradaWFBindingModel._Porcentajedescuentomanual = obj.Porcentajedescuentomanual;

        	buffer_Movto_pedido_entradaWFBindingModel._Descripcion1 = obj.Descripcion1;

        	buffer_Movto_pedido_entradaWFBindingModel._Descripcion2 = obj.Descripcion2;

        	buffer_Movto_pedido_entradaWFBindingModel._Descripcion3 = obj.Descripcion3;

        	buffer_Movto_pedido_entradaWFBindingModel._Cantidadsurtida = obj.Cantidadsurtida;

        	buffer_Movto_pedido_entradaWFBindingModel._Precio1 = obj.Precio1;

        	buffer_Movto_pedido_entradaWFBindingModel._Existencia = obj.Existencia;

        	buffer_Movto_pedido_entradaWFBindingModel._Pzacaja = obj.Pzacaja;

        	buffer_Movto_pedido_entradaWFBindingModel._Texto1 = obj.Texto1;

        	buffer_Movto_pedido_entradaWFBindingModel._Texto2 = obj.Texto2;

        	buffer_Movto_pedido_entradaWFBindingModel._Texto3 = obj.Texto3;

        	buffer_Movto_pedido_entradaWFBindingModel._Texto4 = obj.Texto4;

        	buffer_Movto_pedido_entradaWFBindingModel._Texto5 = obj.Texto5;

        	buffer_Movto_pedido_entradaWFBindingModel._Texto6 = obj.Texto6;

        	buffer_Movto_pedido_entradaWFBindingModel._Numero1 = obj.Numero1;

        	buffer_Movto_pedido_entradaWFBindingModel._Numero2 = obj.Numero2;

        	buffer_Movto_pedido_entradaWFBindingModel._Numero3 = obj.Numero3;

        	buffer_Movto_pedido_entradaWFBindingModel._Numero4 = obj.Numero4;

        	buffer_Movto_pedido_entradaWFBindingModel._Fecha1 = obj.Fecha1;

        	buffer_Movto_pedido_entradaWFBindingModel._Fecha2 = obj.Fecha2;

        	buffer_Movto_pedido_entradaWFBindingModel._Unidadid = obj.Unidadid;

        	buffer_Movto_pedido_entradaWFBindingModel._UnidadClave = obj.UnidadClave;

        	buffer_Movto_pedido_entradaWFBindingModel._UnidadNombre = obj.UnidadNombre;

        	buffer_Movto_pedido_entradaWFBindingModel._Alerta3 = obj.Alerta3;

        	buffer_Movto_pedido_entradaWFBindingModel._Preciomostrar = obj.Preciomostrar;

        	buffer_Movto_pedido_entradaWFBindingModel._Descuentomostrar = obj.Descuentomostrar;

        	buffer_Movto_pedido_entradaWFBindingModel._Cantidadfaltante = obj.Cantidadfaltante;

        	buffer_Movto_pedido_entradaWFBindingModel._Cantidaddevuelta = obj.Cantidaddevuelta;

        	buffer_Movto_pedido_entradaWFBindingModel._Cantidadsaldo = obj.Cantidadsaldo;

            return buffer_Movto_pedido_entradaWFBindingModel;
        }
