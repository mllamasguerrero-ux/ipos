...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class Docto_ped_entr_lstParamWFBindingModel : Validatable
    {

        public Docto_ped_entr_lstParamWFBindingModel()
        {
        ...
        public static Docto_ped_entr_lstParamWFBindingModel CreateFromAnonymous( dynamic obj)
        {
            var buffer_Docto_ped_entr_lstParamWFBindingModel = new Docto_ped_entr_lstParamWFBindingModel();

        	buffer_Docto_ped_entr_lstParamWFBindingModel._EmpresaId = obj.EmpresaId;

        	buffer_Docto_ped_entr_lstParamWFBindingModel._SucursalId = obj.SucursalId;

        	buffer_Docto_ped_entr_lstParamWFBindingModel._TipoDoctoId = obj.TipoDoctoId;

        	buffer_Docto_ped_entr_lstParamWFBindingModel._SubTipoDoctoId = obj.SubTipoDoctoId;

        	buffer_Docto_ped_entr_lstParamWFBindingModel._Usuarioid = obj.Usuarioid;

        	buffer_Docto_ped_entr_lstParamWFBindingModel._FechaIni = obj.FechaIni;

        	buffer_Docto_ped_entr_lstParamWFBindingModel._FechaFin = obj.FechaFin;

        	buffer_Docto_ped_entr_lstParamWFBindingModel._SoloPendientes = obj.SoloPendientes;

            return buffer_Docto_ped_entr_lstParamWFBindingModel;
        }
