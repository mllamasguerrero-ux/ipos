...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFReportesWFBindingModel : Validatable
    {

        public WFReportesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFReportesWF_TableBindingModel : Validatable
    {

        public WFReportesWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
        ...
        private string? _Verreporte;
        [XmlAttribute]
        public string? Verreporte { get => _Verreporte; set { if (RaiseAcceptPendingChange(value, _Verreporte)) { _Verreporte = value; OnPropertyChanged(); } } }

        private string? _Disenarreporte;
        [XmlAttribute]
        public string? Disenarreporte { get => _Disenarreporte; set { if (RaiseAcceptPendingChange(value, _Disenarreporte)) { _Disenarreporte = value; OnPropertyChanged(); } } }
