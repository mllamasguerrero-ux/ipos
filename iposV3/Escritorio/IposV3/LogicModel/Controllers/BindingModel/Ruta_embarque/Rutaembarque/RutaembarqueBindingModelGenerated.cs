...
namespace BindingModels
{
    ...
    public class RutaembarqueBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public RutaembarqueBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public RutaembarqueBindingModelGenerated(Rutaembarque item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Rutaembarque"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Rutaembarque item)
        {
        ...
        public void FillEntityValues(ref Rutaembarque item)
        {
        ...
        public void FillFromEntity(Rutaembarque item)
        {
