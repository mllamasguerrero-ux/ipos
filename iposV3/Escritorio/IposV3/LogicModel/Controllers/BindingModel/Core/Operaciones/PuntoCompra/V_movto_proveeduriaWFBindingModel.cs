...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class V_movto_proveeduriaWFBindingModel : Validatable, IRecordColor
    {

        public V_movto_proveeduriaWFBindingModel()
        {
        ...
        public static V_movto_proveeduriaWFBindingModel CreateFromAnonymous(dynamic obj)
        {
            var buffer_V_movto_proveeduriaWFBindingModel = new V_movto_proveeduriaWFBindingModel();

            buffer_V_movto_proveeduriaWFBindingModel._EmpresaId = obj.EmpresaId;

            buffer_V_movto_proveeduriaWFBindingModel._SucursalId = obj.SucursalId;

            buffer_V_movto_proveeduriaWFBindingModel._Id = obj.Id;

            buffer_V_movto_proveeduriaWFBindingModel._Partida = obj.Partida;

            buffer_V_movto_proveeduriaWFBindingModel._Productoid = obj.Productoid;

            buffer_V_movto_proveeduriaWFBindingModel._ProductoClave = obj.ProductoClave;

            buffer_V_movto_proveeduriaWFBindingModel._ProductoNombre = obj.ProductoNombre;

            buffer_V_movto_proveeduriaWFBindingModel._Cantidad = obj.Cantidad;

            buffer_V_movto_proveeduriaWFBindingModel._Preciolista = obj.Preciolista;

            buffer_V_movto_proveeduriaWFBindingModel._Descuentoporcentaje = obj.Descuentoporcentaje;

            buffer_V_movto_proveeduriaWFBindingModel._Descuento = obj.Descuento;

            buffer_V_movto_proveeduriaWFBindingModel._Precio = obj.Precio;

            buffer_V_movto_proveeduriaWFBindingModel._Importe = obj.Importe;

            buffer_V_movto_proveeduriaWFBindingModel._Subtotal = obj.Subtotal;

            buffer_V_movto_proveeduriaWFBindingModel._Iva = obj.Iva;

            buffer_V_movto_proveeduriaWFBindingModel._Ieps = obj.Ieps;

            buffer_V_movto_proveeduriaWFBindingModel._Tasaiva = obj.Tasaiva;

            buffer_V_movto_proveeduriaWFBindingModel._Tasaieps = obj.Tasaieps;

            buffer_V_movto_proveeduriaWFBindingModel._Total = obj.Total;

            buffer_V_movto_proveeduriaWFBindingModel._Lote = obj.Lote;

            buffer_V_movto_proveeduriaWFBindingModel._Fechavence = obj.Fechavence;

            buffer_V_movto_proveeduriaWFBindingModel._Loteimportado = obj.Loteimportado;

            buffer_V_movto_proveeduriaWFBindingModel._Doctoid = obj.Doctoid;

            buffer_V_movto_proveeduriaWFBindingModel._Orden = obj.Orden;

            buffer_V_movto_proveeduriaWFBindingModel._Descuentovale = obj.Descuentovale;

            buffer_V_movto_proveeduriaWFBindingModel._Descuentovaleporcentaje = obj.Descuentovaleporcentaje;

            buffer_V_movto_proveeduriaWFBindingModel._Ingresopreciomanual = obj.Ingresopreciomanual;

            buffer_V_movto_proveeduriaWFBindingModel._Porcentajedescuentomanual = obj.Porcentajedescuentomanual;

            buffer_V_movto_proveeduriaWFBindingModel._Descripcion1 = obj.Descripcion1;

            buffer_V_movto_proveeduriaWFBindingModel._Descripcion2 = obj.Descripcion2;

            buffer_V_movto_proveeduriaWFBindingModel._Descripcion3 = obj.Descripcion3;

            buffer_V_movto_proveeduriaWFBindingModel._Cantidadsurtida = obj.Cantidadsurtida;

            buffer_V_movto_proveeduriaWFBindingModel._Precio1 = obj.Precio1;

            buffer_V_movto_proveeduriaWFBindingModel._Existencia = obj.Existencia;

            buffer_V_movto_proveeduriaWFBindingModel._Pzacaja = obj.Pzacaja;

            buffer_V_movto_proveeduriaWFBindingModel._Texto1 = obj.Texto1;

            buffer_V_movto_proveeduriaWFBindingModel._Texto2 = obj.Texto2;

            buffer_V_movto_proveeduriaWFBindingModel._Texto3 = obj.Texto3;

            buffer_V_movto_proveeduriaWFBindingModel._Texto4 = obj.Texto4;

            buffer_V_movto_proveeduriaWFBindingModel._Texto5 = obj.Texto5;

            buffer_V_movto_proveeduriaWFBindingModel._Texto6 = obj.Texto6;

            buffer_V_movto_proveeduriaWFBindingModel._Numero1 = obj.Numero1;

            buffer_V_movto_proveeduriaWFBindingModel._Numero2 = obj.Numero2;

            buffer_V_movto_proveeduriaWFBindingModel._Numero3 = obj.Numero3;

            buffer_V_movto_proveeduriaWFBindingModel._Numero4 = obj.Numero4;

            buffer_V_movto_proveeduriaWFBindingModel._Fecha1 = obj.Fecha1;

            buffer_V_movto_proveeduriaWFBindingModel._Fecha2 = obj.Fecha2;

            buffer_V_movto_proveeduriaWFBindingModel._Unidadid = obj.Unidadid;

            buffer_V_movto_proveeduriaWFBindingModel._UnidadClave = obj.UnidadClave;

            buffer_V_movto_proveeduriaWFBindingModel._UnidadNombre = obj.UnidadNombre;

            buffer_V_movto_proveeduriaWFBindingModel._Alerta3 = obj.Alerta3;

            buffer_V_movto_proveeduriaWFBindingModel._Preciomostrar = obj.Preciomostrar;

            buffer_V_movto_proveeduriaWFBindingModel._Descuentomostrar = obj.Descuentomostrar;

            return buffer_V_movto_proveeduriaWFBindingModel;
        }
