...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class V_docto_proveeduriaWFBindingModel : Validatable
    {

        public V_docto_proveeduriaWFBindingModel()
        {
        ...
        public static V_docto_proveeduriaWFBindingModel CreateFromAnonymous( dynamic obj)
        {
            var buffer_V_docto_proveeduriaWFBindingModel = new V_docto_proveeduriaWFBindingModel();

        	buffer_V_docto_proveeduriaWFBindingModel._EmpresaId = obj.EmpresaId;

        	buffer_V_docto_proveeduriaWFBindingModel._SucursalId = obj.SucursalId;

        	buffer_V_docto_proveeduriaWFBindingModel._Id = obj.Id;

        	buffer_V_docto_proveeduriaWFBindingModel._Activo = obj.Activo;

        	buffer_V_docto_proveeduriaWFBindingModel._Estatusdoctoid = obj.Estatusdoctoid;

        	buffer_V_docto_proveeduriaWFBindingModel._Estatusdoctoclave = obj.Estatusdoctoclave;

        	buffer_V_docto_proveeduriaWFBindingModel._Estatusdoctonombre = obj.Estatusdoctonombre;

        	buffer_V_docto_proveeduriaWFBindingModel._Usuarioid = obj.Usuarioid;

        	buffer_V_docto_proveeduriaWFBindingModel._Usuarionombre = obj.Usuarionombre;

        	buffer_V_docto_proveeduriaWFBindingModel._Fecha = obj.Fecha;

        	buffer_V_docto_proveeduriaWFBindingModel._Serie = obj.Serie;

        	buffer_V_docto_proveeduriaWFBindingModel._Folio = obj.Folio;

        	buffer_V_docto_proveeduriaWFBindingModel._Importe = obj.Importe;

        	buffer_V_docto_proveeduriaWFBindingModel._Descuento = obj.Descuento;

        	buffer_V_docto_proveeduriaWFBindingModel._Subtotal = obj.Subtotal;

        	buffer_V_docto_proveeduriaWFBindingModel._Iva = obj.Iva;

        	buffer_V_docto_proveeduriaWFBindingModel._Ieps = obj.Ieps;

        	buffer_V_docto_proveeduriaWFBindingModel._Total = obj.Total;

        	buffer_V_docto_proveeduriaWFBindingModel._Cajaid = obj.Cajaid;

        	buffer_V_docto_proveeduriaWFBindingModel._Cajaclave = obj.Cajaclave;

        	buffer_V_docto_proveeduriaWFBindingModel._Cajanombre = obj.Cajanombre;

        	buffer_V_docto_proveeduriaWFBindingModel._Proveedorid = obj.Proveedorid;

        	buffer_V_docto_proveeduriaWFBindingModel._Proveedorclave = obj.Proveedorclave;

        	buffer_V_docto_proveeduriaWFBindingModel._Proveedornombre = obj.Proveedornombre;

        	buffer_V_docto_proveeduriaWFBindingModel._Tipodoctoid = obj.Tipodoctoid;

        	buffer_V_docto_proveeduriaWFBindingModel._Tipodoctoclave = obj.Tipodoctoclave;

        	buffer_V_docto_proveeduriaWFBindingModel._Tipodoctonombre = obj.Tipodoctonombre;

        	buffer_V_docto_proveeduriaWFBindingModel._Referencia = obj.Referencia;

        	buffer_V_docto_proveeduriaWFBindingModel._Foliosat = obj.Foliosat;

        	buffer_V_docto_proveeduriaWFBindingModel._Seriesat = obj.Seriesat;

        	buffer_V_docto_proveeduriaWFBindingModel._Sucursaltid = obj.Sucursaltid;

        	buffer_V_docto_proveeduriaWFBindingModel._Sucursaltclave = obj.Sucursaltclave;

        	buffer_V_docto_proveeduriaWFBindingModel._Sucursaltnombre = obj.Sucursaltnombre;

        	buffer_V_docto_proveeduriaWFBindingModel._Almacentid = obj.Almacentid;

        	buffer_V_docto_proveeduriaWFBindingModel._Almacentclave = obj.Almacentclave;

        	buffer_V_docto_proveeduriaWFBindingModel._Almacentnombre = obj.Almacentnombre;

            buffer_V_docto_proveeduriaWFBindingModel._Almacenid = obj.Almacenid;

            buffer_V_docto_proveeduriaWFBindingModel._Almacenclave = obj.Almacenclave;

            buffer_V_docto_proveeduriaWFBindingModel._Almacennombre = obj.Almacennombre;

            buffer_V_docto_proveeduriaWFBindingModel._Folio_c = obj.Folio_c;

        	buffer_V_docto_proveeduriaWFBindingModel._Factura_c = obj.Factura_c;

        	buffer_V_docto_proveeduriaWFBindingModel._Fechafactura_c = obj.Fechafactura_c;

        	buffer_V_docto_proveeduriaWFBindingModel._Fechavence_c = obj.Fechavence_c;

        	buffer_V_docto_proveeduriaWFBindingModel._Origenfiscalid = obj.Origenfiscalid;

        	buffer_V_docto_proveeduriaWFBindingModel._Origenfiscalclave = obj.Origenfiscalclave;

        	buffer_V_docto_proveeduriaWFBindingModel._Origenfiscalnombre = obj.Origenfiscalnombre;

            return buffer_V_docto_proveeduriaWFBindingModel;
        }
    ...
    [XmlRoot]
    public class V_docto_proveeduriaParamWFBindingModel : Validatable
    {

        public V_docto_proveeduriaParamWFBindingModel()
        {
            FillCatalogRelatedFields();
        }
        ...
        public long? P_usuarioid { get => _usuarioid; set { 
                if (RaiseAcceptPendingChange(value, _usuarioid)) { 
                    _usuarioid = value; OnPropertyChanged(); 
                } } }
        ...
        public DateTimeOffset? P_fechaini { get => _fechaini; 
                set { 
        ...
        private BoolCS _corteActual = BoolCS.S;
        public BoolCS P_corteActual { get => _corteActual; set { if (RaiseAcceptPendingChange(value, _corteActual)) { _corteActual = value; OnPropertyChanged(); } } }



        public long? _almacenid;
        public long? P_almacenid { get => _almacenid; set { if (RaiseAcceptPendingChange(value, _almacenid)) { _almacenid = value; OnPropertyChanged(); } } }


        public string? _almacenclave;
        public string? P_almacenclave { get => _almacenclave; set { if (RaiseAcceptPendingChange(value, _almacenclave)) { _almacenclave = value; OnPropertyChanged(); } } }


        public string? _almacennombre;
        public string? P_almacennombre { get => _almacennombre; set { if (RaiseAcceptPendingChange(value, _almacennombre)) { _almacennombre = value; OnPropertyChanged(); } } }



        private BoolCS _todosAlmacenes = BoolCS.S;
        public BoolCS P_todosAlmacenes { get => _todosAlmacenes; set { if (RaiseAcceptPendingChange(value, _todosAlmacenes)) { _todosAlmacenes = value; OnPropertyChanged(); } } }


        private BoolCS _todosUsuarios = BoolCS.S;
        public BoolCS P_todosUsuarios { get => _todosUsuarios; set { if (RaiseAcceptPendingChange(value, _todosUsuarios)) { _todosUsuarios = value; OnPropertyChanged(); } } }


        private BoolCS _porFecha = BoolCS.S;
        public BoolCS P_porFecha { get => _porFecha; set { if (RaiseAcceptPendingChange(value, _porFecha)) { _porFecha = value; OnPropertyChanged(); } } }
