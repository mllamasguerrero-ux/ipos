...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class V_docto_venddevoWFBindingModel : Validatable
    {

        public V_docto_venddevoWFBindingModel()
        {
        ...
        public static V_docto_venddevoWFBindingModel CreateFromAnonymous( dynamic obj)
        {
            var buffer_V_docto_venddevoWFBindingModel = new V_docto_venddevoWFBindingModel();

        	buffer_V_docto_venddevoWFBindingModel._EmpresaId = obj.EmpresaId;

        	buffer_V_docto_venddevoWFBindingModel._SucursalId = obj.SucursalId;

        	buffer_V_docto_venddevoWFBindingModel._Id = obj.Id;

        	buffer_V_docto_venddevoWFBindingModel._Activo = obj.Activo;

        	buffer_V_docto_venddevoWFBindingModel._Estatusdoctoid = obj.Estatusdoctoid;

        	buffer_V_docto_venddevoWFBindingModel._Estatusdoctoclave = obj.Estatusdoctoclave;

        	buffer_V_docto_venddevoWFBindingModel._Estatusdoctonombre = obj.Estatusdoctonombre;

        	buffer_V_docto_venddevoWFBindingModel._Usuarioid = obj.Usuarioid;

        	buffer_V_docto_venddevoWFBindingModel._Usuarionombre = obj.Usuarionombre;

        	buffer_V_docto_venddevoWFBindingModel._Fecha = obj.Fecha;

        	buffer_V_docto_venddevoWFBindingModel._Serie = obj.Serie;

        	buffer_V_docto_venddevoWFBindingModel._Folio = obj.Folio;

        	buffer_V_docto_venddevoWFBindingModel._Importe = obj.Importe;

        	buffer_V_docto_venddevoWFBindingModel._Descuento = obj.Descuento;

        	buffer_V_docto_venddevoWFBindingModel._Subtotal = obj.Subtotal;

        	buffer_V_docto_venddevoWFBindingModel._Iva = obj.Iva;

        	buffer_V_docto_venddevoWFBindingModel._Ieps = obj.Ieps;

        	buffer_V_docto_venddevoWFBindingModel._Total = obj.Total;

        	buffer_V_docto_venddevoWFBindingModel._Cajaid = obj.Cajaid;

        	buffer_V_docto_venddevoWFBindingModel._Cajaclave = obj.Cajaclave;

        	buffer_V_docto_venddevoWFBindingModel._Cajanombre = obj.Cajanombre;

        	buffer_V_docto_venddevoWFBindingModel._Clienteid = obj.Clienteid;

        	buffer_V_docto_venddevoWFBindingModel._Clienteclave = obj.Clienteclave;

        	buffer_V_docto_venddevoWFBindingModel._Clientenombre = obj.Clientenombre;

        	buffer_V_docto_venddevoWFBindingModel._Tipodoctoid = obj.Tipodoctoid;

        	buffer_V_docto_venddevoWFBindingModel._Tipodoctoclave = obj.Tipodoctoclave;

        	buffer_V_docto_venddevoWFBindingModel._Tipodoctonombre = obj.Tipodoctonombre;

        	buffer_V_docto_venddevoWFBindingModel._Referencia = obj.Referencia;

        	buffer_V_docto_venddevoWFBindingModel._Foliosat = obj.Foliosat;

        	buffer_V_docto_venddevoWFBindingModel._Seriesat = obj.Seriesat;

        	buffer_V_docto_venddevoWFBindingModel._Sucursaltid = obj.Sucursaltid;

        	buffer_V_docto_venddevoWFBindingModel._Sucursaltclave = obj.Sucursaltclave;

        	buffer_V_docto_venddevoWFBindingModel._Sucursaltnombre = obj.Sucursaltnombre;

        	buffer_V_docto_venddevoWFBindingModel._Almacentid = obj.Almacentid;

        	buffer_V_docto_venddevoWFBindingModel._Almacentclave = obj.Almacentclave;

        	buffer_V_docto_venddevoWFBindingModel._Almacentnombre = obj.Almacentnombre;

        	buffer_V_docto_venddevoWFBindingModel._Fechahora = obj.Fechahora;

        	buffer_V_docto_venddevoWFBindingModel._Origenfiscalid = obj.Origenfiscalid;

        	buffer_V_docto_venddevoWFBindingModel._Origenfiscalclave = obj.Origenfiscalclave;

        	buffer_V_docto_venddevoWFBindingModel._Origenfiscalnombre = obj.Origenfiscalnombre;

        	buffer_V_docto_venddevoWFBindingModel._Devolucionrefid = obj.Devolucionrefid;

        	buffer_V_docto_venddevoWFBindingModel._Devolucionreffolio = obj.Devolucionreffolio;

        	buffer_V_docto_venddevoWFBindingModel._Devolucionreffechahora = obj.Devolucionreffechahora;

            return buffer_V_docto_venddevoWFBindingModel;
        }
    ...
    [XmlRoot]
    public class V_docto_venddevoParamWFBindingModel : Validatable
    {

        public V_docto_venddevoParamWFBindingModel()
        {
            FillCatalogRelatedFields();
        }
