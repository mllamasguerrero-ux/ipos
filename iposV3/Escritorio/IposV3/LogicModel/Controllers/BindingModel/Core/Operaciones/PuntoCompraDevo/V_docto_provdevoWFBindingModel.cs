...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class V_docto_provdevoWFBindingModel : Validatable
    {

        public V_docto_provdevoWFBindingModel()
        {
        ...
        private long? _Devolucionrefid;
        [XmlAttribute]
        public long? Devolucionrefid { get => _Devolucionrefid; set { if (RaiseAcceptPendingChange(value, _Devolucionrefid)) { _Devolucionrefid = value; OnPropertyChanged(); } } }

        private int? _Devolucionreffolio;
        [XmlAttribute]
        public int? Devolucionreffolio { get => _Devolucionreffolio; set { if (RaiseAcceptPendingChange(value, _Devolucionreffolio)) { _Devolucionreffolio = value; OnPropertyChanged(); } } }

        private DateTimeOffset? _Devolucionreffechahora;
        [XmlAttribute]
        public DateTimeOffset? Devolucionreffechahora { get => _Devolucionreffechahora; set { if (RaiseAcceptPendingChange(value, _Devolucionreffechahora)) { _Devolucionreffechahora = value; OnPropertyChanged(); } } }
        ...
        public static V_docto_provdevoWFBindingModel CreateFromAnonymous( dynamic obj)
        {
            var buffer_V_docto_provdevoWFBindingModel = new V_docto_provdevoWFBindingModel();

        	buffer_V_docto_provdevoWFBindingModel._EmpresaId = obj.EmpresaId;

        	buffer_V_docto_provdevoWFBindingModel._SucursalId = obj.SucursalId;

        	buffer_V_docto_provdevoWFBindingModel._Id = obj.Id;

        	buffer_V_docto_provdevoWFBindingModel._Activo = obj.Activo;

        	buffer_V_docto_provdevoWFBindingModel._Estatusdoctoid = obj.Estatusdoctoid;

        	buffer_V_docto_provdevoWFBindingModel._Estatusdoctoclave = obj.Estatusdoctoclave;

        	buffer_V_docto_provdevoWFBindingModel._Estatusdoctonombre = obj.Estatusdoctonombre;

        	buffer_V_docto_provdevoWFBindingModel._Usuarioid = obj.Usuarioid;

        	buffer_V_docto_provdevoWFBindingModel._Usuarionombre = obj.Usuarionombre;

        	buffer_V_docto_provdevoWFBindingModel._Fecha = obj.Fecha;

        	buffer_V_docto_provdevoWFBindingModel._Serie = obj.Serie;

        	buffer_V_docto_provdevoWFBindingModel._Folio = obj.Folio;

        	buffer_V_docto_provdevoWFBindingModel._Importe = obj.Importe;

        	buffer_V_docto_provdevoWFBindingModel._Descuento = obj.Descuento;

        	buffer_V_docto_provdevoWFBindingModel._Subtotal = obj.Subtotal;

        	buffer_V_docto_provdevoWFBindingModel._Iva = obj.Iva;

        	buffer_V_docto_provdevoWFBindingModel._Ieps = obj.Ieps;

        	buffer_V_docto_provdevoWFBindingModel._Total = obj.Total;

        	buffer_V_docto_provdevoWFBindingModel._Cajaid = obj.Cajaid;

        	buffer_V_docto_provdevoWFBindingModel._Cajaclave = obj.Cajaclave;

        	buffer_V_docto_provdevoWFBindingModel._Cajanombre = obj.Cajanombre;

        	buffer_V_docto_provdevoWFBindingModel._Proveedorid = obj.Proveedorid;

        	buffer_V_docto_provdevoWFBindingModel._Proveedorclave = obj.Proveedorclave;

        	buffer_V_docto_provdevoWFBindingModel._Proveedornombre = obj.Proveedornombre;

        	buffer_V_docto_provdevoWFBindingModel._Tipodoctoid = obj.Tipodoctoid;

        	buffer_V_docto_provdevoWFBindingModel._Tipodoctoclave = obj.Tipodoctoclave;

        	buffer_V_docto_provdevoWFBindingModel._Tipodoctonombre = obj.Tipodoctonombre;

        	buffer_V_docto_provdevoWFBindingModel._Referencia = obj.Referencia;

        	buffer_V_docto_provdevoWFBindingModel._Foliosat = obj.Foliosat;

        	buffer_V_docto_provdevoWFBindingModel._Seriesat = obj.Seriesat;

        	buffer_V_docto_provdevoWFBindingModel._Sucursaltid = obj.Sucursaltid;

        	buffer_V_docto_provdevoWFBindingModel._Sucursaltclave = obj.Sucursaltclave;

        	buffer_V_docto_provdevoWFBindingModel._Sucursaltnombre = obj.Sucursaltnombre;

        	buffer_V_docto_provdevoWFBindingModel._Almacentid = obj.Almacentid;

        	buffer_V_docto_provdevoWFBindingModel._Almacentclave = obj.Almacentclave;

        	buffer_V_docto_provdevoWFBindingModel._Almacentnombre = obj.Almacentnombre;

        	buffer_V_docto_provdevoWFBindingModel._Folio_c = obj.Folio_c;

        	buffer_V_docto_provdevoWFBindingModel._Factura_c = obj.Factura_c;

        	buffer_V_docto_provdevoWFBindingModel._Fechafactura_c = obj.Fechafactura_c;

        	buffer_V_docto_provdevoWFBindingModel._Fechavence_c = obj.Fechavence_c;

        	buffer_V_docto_provdevoWFBindingModel._Origenfiscalid = obj.Origenfiscalid;

        	buffer_V_docto_provdevoWFBindingModel._Origenfiscalclave = obj.Origenfiscalclave;

        	buffer_V_docto_provdevoWFBindingModel._Origenfiscalnombre = obj.Origenfiscalnombre;

        	buffer_V_docto_provdevoWFBindingModel._Devolucionrefid = obj.Devolucionrefid;

        	buffer_V_docto_provdevoWFBindingModel._Devolucionreffolio = obj.Devolucionreffolio;

        	buffer_V_docto_provdevoWFBindingModel._Devolucionreffechahora = obj.Devolucionreffechahora;

            return buffer_V_docto_provdevoWFBindingModel;
        }
    ...
    [XmlRoot]
    public class V_docto_provdevoParamWFBindingModel : Validatable
    {

        public V_docto_provdevoParamWFBindingModel()
        {
            FillCatalogRelatedFields();
        }
