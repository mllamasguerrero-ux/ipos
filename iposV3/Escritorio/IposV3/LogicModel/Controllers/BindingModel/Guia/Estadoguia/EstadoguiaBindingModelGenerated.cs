...
namespace BindingModels
{
    ...
    public class EstadoguiaBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public EstadoguiaBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public EstadoguiaBindingModelGenerated(Estadoguia item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Estadoguia"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Estadoguia item)
        {
        ...
        public void FillEntityValues(ref Estadoguia item)
        {
        ...
        public void FillFromEntity(Estadoguia item)
        {
