...
namespace BindingModels
{
    ...
    public class TipoentregaBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public TipoentregaBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public TipoentregaBindingModelGenerated(Tipoentrega item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Tipoentrega"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        public void FillCatalogRelatedFields(Tipoentrega item)
        {
        ...
        public void FillEntityValues(ref Tipoentrega item)
        {
        ...
        public void FillFromEntity(Tipoentrega item)
        {
