...
namespace BindingModels
{
    ...
    public class DerechosBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public DerechosBindingModelGenerated()
        {
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Derechos"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
