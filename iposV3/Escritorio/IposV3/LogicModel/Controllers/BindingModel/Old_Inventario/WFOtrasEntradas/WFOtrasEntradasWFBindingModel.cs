...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFOtrasEntradasWFBindingModel : Validatable
    {

        public WFOtrasEntradasWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFOtrasEntradasWF_GridpvBindingModel : Validatable
    {

        public WFOtrasEntradasWF_GridpvBindingModel()
        {
            FillCatalogRelatedFields();
        }
