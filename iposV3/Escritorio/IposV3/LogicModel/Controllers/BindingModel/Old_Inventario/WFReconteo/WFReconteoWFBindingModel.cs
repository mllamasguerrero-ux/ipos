...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFReconteoWFBindingModel : Validatable
    {

        public WFReconteoWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFReconteoWF_Get_invfis_listadetallesBindingModel : Validatable
    {

        public WFReconteoWF_Get_invfis_listadetallesBindingModel()
        {
            FillCatalogRelatedFields();
        }
        ...
        private string? _Dgrecontar;
        [XmlAttribute]
        public string? Dgrecontar { get => _Dgrecontar; set { if (RaiseAcceptPendingChange(value, _Dgrecontar)) { _Dgrecontar = value; OnPropertyChanged(); } } }
