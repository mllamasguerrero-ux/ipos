...
namespace BindingModels
{
    ...
    public class GrupodiferenciainventarioBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public GrupodiferenciainventarioBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public GrupodiferenciainventarioBindingModelGenerated(Grupodiferenciainventario item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Grupodiferenciainventario"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        {
            return @"Clave|Nombre|Descripcion|Memo";
        }


        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Grupodiferenciainventario item)
        {
        ...
        public void FillEntityValues(ref Grupodiferenciainventario item)
        {
        ...
        public void FillFromEntity(Grupodiferenciainventario item)
        {
