...
namespace BindingModels
{
    ...
    public class EstadocobranzaBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public EstadocobranzaBindingModelGenerated()
        {
        }
        

        #if PROYECTO_WEB
        public EstadocobranzaBindingModelGenerated(Estadocobranza item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Estadocobranza"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Estadocobranza item)
        {
        ...
        public void FillEntityValues(ref Estadocobranza item)
        {
        ...
        public void FillFromEntity(Estadocobranza item)
        {
