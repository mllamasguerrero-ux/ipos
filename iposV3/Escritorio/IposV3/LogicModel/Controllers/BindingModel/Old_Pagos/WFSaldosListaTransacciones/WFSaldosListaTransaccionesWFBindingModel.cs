...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFSaldosListaTransaccionesWFBindingModel : Validatable
    {

        public WFSaldosListaTransaccionesWFBindingModel()
        {
        ...
        private BoolCN? _Cbreferencia;
        [XmlAttribute]
        public BoolCN? Cbreferencia { get => _Cbreferencia; set { if (RaiseAcceptPendingChange(value, _Cbreferencia)) { _Cbreferencia = value; OnPropertyChanged(); } } }
    ...
    [XmlRoot]
    public class WFSaldosListaTransaccionesWF_Transacciones_listaBindingModel : Validatable
    {

        public WFSaldosListaTransaccionesWF_Transacciones_listaBindingModel()
        {
            FillCatalogRelatedFields();
        }
