...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFMedicosWFBindingModel : Validatable
    {

        public WFMedicosWFBindingModel()
        {
        ...
        private BoolCN? _Cbsolomedicosempresa;
        [XmlAttribute]
        public BoolCN? Cbsolomedicosempresa { get => _Cbsolomedicosempresa; set { if (RaiseAcceptPendingChange(value, _Cbsolomedicosempresa)) { _Cbsolomedicosempresa = value; OnPropertyChanged(); } } }
    ...
    [XmlRoot]
    public class WFMedicosWF_TableBindingModel : Validatable
    {

        public WFMedicosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
