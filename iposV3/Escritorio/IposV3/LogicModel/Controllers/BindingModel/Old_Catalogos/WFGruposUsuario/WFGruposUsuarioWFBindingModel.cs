...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFGruposUsuarioWFBindingModel : Validatable
    {

        public WFGruposUsuarioWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFGruposUsuarioWF_TableBindingModel : Validatable
    {

        public WFGruposUsuarioWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
