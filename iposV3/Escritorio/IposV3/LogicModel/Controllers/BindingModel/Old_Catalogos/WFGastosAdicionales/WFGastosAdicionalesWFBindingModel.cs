...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFGastosAdicionalesWFBindingModel : Validatable
    {

        public WFGastosAdicionalesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFGastosAdicionalesWF_TableBindingModel : Validatable
    {

        public WFGastosAdicionalesWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
