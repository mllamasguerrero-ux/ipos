...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFPromocionesWFBindingModel : Validatable
    {

        public WFPromocionesWFBindingModel()
        {
        ...
        private BoolCN? _Cbsolovigentes;
        [XmlAttribute]
        public BoolCN? Cbsolovigentes { get => _Cbsolovigentes; set { if (RaiseAcceptPendingChange(value, _Cbsolovigentes)) { _Cbsolovigentes = value; OnPropertyChanged(); } } }
    ...
    [XmlRoot]
    public class WFPromocionesWF_TableBindingModel : Validatable
    {

        public WFPromocionesWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
        ...
        private string? _Coldesactivar;
        [XmlAttribute]
        public string? Coldesactivar { get => _Coldesactivar; set { if (RaiseAcceptPendingChange(value, _Coldesactivar)) { _Coldesactivar = value; OnPropertyChanged(); } } }
