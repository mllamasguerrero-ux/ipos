...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFListaPreciosWFBindingModel : Validatable
    {

        public WFListaPreciosWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFListaPreciosWF_TableBindingModel : Validatable
    {

        public WFListaPreciosWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
