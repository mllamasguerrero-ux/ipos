...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFCajasWFBindingModel : Validatable
    {

        public WFCajasWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFCajasWF_TableBindingModel : Validatable
    {

        public WFCajasWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
