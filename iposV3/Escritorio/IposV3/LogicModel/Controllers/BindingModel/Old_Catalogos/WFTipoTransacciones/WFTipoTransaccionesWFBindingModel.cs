...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFTipoTransaccionesWFBindingModel : Validatable
    {

        public WFTipoTransaccionesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFTipoTransaccionesWF_TableBindingModel : Validatable
    {

        public WFTipoTransaccionesWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
