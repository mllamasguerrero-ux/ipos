...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFEncargadosCortesWFBindingModel : Validatable
    {

        public WFEncargadosCortesWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFEncargadosCortesWF_TableBindingModel : Validatable
    {

        public WFEncargadosCortesWF_TableBindingModel()
        {
            FillCatalogRelatedFields();
        }
