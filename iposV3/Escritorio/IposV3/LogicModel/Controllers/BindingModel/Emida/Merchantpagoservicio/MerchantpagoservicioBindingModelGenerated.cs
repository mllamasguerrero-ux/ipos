...
namespace BindingModels
{
    ...
    public class MerchantpagoservicioBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public MerchantpagoservicioBindingModelGenerated()
        {
        }

        #if PROYECTO_WEB
        public MerchantpagoservicioBindingModelGenerated(Merchantpagoservicio item)
        {
            FillFromEntity(item);
        }
        ...
        [XmlAttribute]
        public string? Merchantid { get => _Merchantid; set { if (RaiseAcceptPendingChange(value, _Merchantid)) { _Merchantid = value; OnPropertyChanged(); } } }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Merchantpagoservicio"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        {
            return @"Merchantid|Sucursal_info.Clave|Sucursal_info.Nombre";
        }


        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Merchantpagoservicio item)
        {
        ...
        public void FillEntityValues(ref Merchantpagoservicio item)
        {
        ...
        public void FillFromEntity(Merchantpagoservicio item)
        {
