...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFRecepcionAlmacenDetalleWFBindingModel : Validatable
    {

        public WFRecepcionAlmacenDetalleWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFRecepcionAlmacenDetalleWF_Movto_por_lote_viewBindingModel : Validatable
    {

        public WFRecepcionAlmacenDetalleWF_Movto_por_lote_viewBindingModel()
        {
            FillCatalogRelatedFields();
        }
