...
namespace BindingModels
{
    ...
    [XmlRoot]
    public class WFBitacoraCobranzaListWFBindingModel : Validatable
    {

        public WFBitacoraCobranzaListWFBindingModel()
        {
    ...
    [XmlRoot]
    public class WFBitacoraCobranzaListWF_BitacobranzaBindingModel : Validatable
    {

        public WFBitacoraCobranzaListWF_BitacobranzaBindingModel()
        {
            FillCatalogRelatedFields();
        }
