...
namespace BindingModels
{
    ...
    public class MonedaBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public MonedaBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public MonedaBindingModelGenerated(Moneda item)
        {
            FillFromEntity(item);
        }
        ...
        [XmlAttribute][Required(ErrorMessage = "Es requerido")]
        public decimal? Tipocambio { get => _Tipocambio?? 1; set { if (RaiseAcceptPendingChange(value, _Tipocambio)) { _Tipocambio = value?? 1; OnPropertyChanged(); } } }

        public static string GetBaseQuery()
        {

            return $@"SELECT * FROM ""Moneda"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Moneda item)
        {
        ...
        public void FillEntityValues(ref Moneda item)
        {
            ...
            item.Tipocambio = Tipocambio ?? 1;



        }

        public void FillFromEntity(Moneda item)
        {
