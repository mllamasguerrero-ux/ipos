...
namespace BindingModels
{
    ...
    public class TasaiepsBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public TasaiepsBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public TasaiepsBindingModelGenerated(Tasaieps item)
        {
            FillFromEntity(item);
        }
        ...
        private DateTimeOffset? _Primerafecha;
        [XmlAttribute]
        public DateTimeOffset? Primerafecha { get => _Primerafecha; set { if (RaiseAcceptPendingChange(value, _Primerafecha)) { _Primerafecha = value; OnPropertyChanged(); } } }

        public static string GetBaseQuery()
        {

            return $@"SELECT * FROM ""Tasaieps"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Tasaieps item)
        {
        ...
        public void FillEntityValues(ref Tasaieps item)
        {
            ...
            item.Primerafecha = Primerafecha ;



        }

        public void FillFromEntity(Tasaieps item)
        {
            ...
            Primerafecha = item.Primerafecha;
