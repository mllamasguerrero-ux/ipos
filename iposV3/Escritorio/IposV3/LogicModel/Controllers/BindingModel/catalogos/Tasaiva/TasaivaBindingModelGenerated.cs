...
namespace BindingModels
{
    ...
    public class TasaivaBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public TasaivaBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public TasaivaBindingModelGenerated(Tasaiva item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Tasaiva"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        public void FillCatalogRelatedFields(Tasaiva item)
        {
        ...
        public void FillEntityValues(ref Tasaiva item)
        {
            ...
            item.Fechainicia = Fechainicia ;



        }

        public void FillFromEntity(Tasaiva item)
        {
