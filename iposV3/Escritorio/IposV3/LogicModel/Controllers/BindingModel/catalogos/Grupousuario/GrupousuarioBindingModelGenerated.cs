...
namespace BindingModels
{
    ...
    public class GrupousuarioBindingModelGenerated : Validatable, IBaseBindingModel
    
    {
        
        public GrupousuarioBindingModelGenerated()
        {
        }
        
        #if PROYECTO_WEB
        public GrupousuarioBindingModelGenerated(Grupousuario item)
        {
            FillFromEntity(item);
        }
        ...
        public static string GetBaseQuery()
        {
            ...
            return $@"SELECT * FROM ""Grupousuario"" Where ""EmpresaId"" = @1 and ""SucursalId"" = @2 ";
        ...
        #if PROYECTO_WEB
        public void FillCatalogRelatedFields(Grupousuario item)
        {
        ...
        public void FillEntityValues(ref Grupousuario item)
        {
        ...
        public void FillFromEntity(Grupousuario item)
        {
