...
namespace Converters
{
        ...
        IValueConverter
    {
        ...
        class Constant : IExpression
        {
            ...
            {
                if (!decimal.TryParse(text,NumberStyles.Number, new CultureInfo("en-US"),  out _value))
                {
        ...
        class Variable : IExpression
        {
            ...
            {
                if (!int.TryParse(text, NumberStyles.Number, new CultureInfo("en-US"), out _index) || _index<0)
                {
            ...
            public decimal Eval(object[] args)
            {
                ...
                return System.Convert.ToDecimal(args[_index], new CultureInfo("en-US"));
            }
        }
        ...
        class Parser
        {
            ...
            private IExpression ParseExpression()
            {
                ...
                while (true)
                {
                    if ( text == null ||  pos >= text.Length) return left;
            ...
            {
                SkipWhiteSpace();
                if (text == null || pos >= text.Length) throw new ArgumentException("Unexpected end of text");
            ...
            {
                if (text == null || pos >= text.Length || text[pos] != c)
                {
