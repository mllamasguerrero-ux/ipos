...
namespace IposV3.ViewModels
{
    ...
    public class V_pagomultiple_ventadevoViewModel : BaseGenericViewModel
    {

        public V_pagomultiple_ventadevoWFBindingModel? PagoItem { get; set; }

        public bool BProcessSuccess { get; protected set; }


        public V_pagomultiple_ventadevoViewModel(SelectorWebController selectorProvider, IEventAggregator aggregator, IWindowManager winManager, IMessageBoxService messageBoxService) :
            base(selectorProvider, aggregator, winManager, messageBoxService)
        {
            PagoItem = new V_pagomultiple_ventadevoWFBindingModel();
