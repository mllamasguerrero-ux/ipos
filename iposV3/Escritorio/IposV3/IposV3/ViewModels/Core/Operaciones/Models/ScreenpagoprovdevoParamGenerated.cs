...
{
    public class ScreenpagoprovdevoParamGenerated : BaseParam
    {

        public ScreenpagoprovdevoParamGenerated():this(null, null)
        {

        }

        public ScreenpagoprovdevoParamGenerated(BaseParam baseParam): this(baseParam.P_empresaid, baseParam.P_sucursalid)
        {
            
        }
        public ScreenpagoprovdevoParamGenerated(long? empresaid, long? sucursalid) : base(empresaid, sucursalid)
        {
        ...
        public ScreenpagoprovdevoParamGenerated(long? empresaid, long? sucursalid
