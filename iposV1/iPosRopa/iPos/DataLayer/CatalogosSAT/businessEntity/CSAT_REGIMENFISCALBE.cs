...
{
	public class CSAT_REGIMENFISCALBE
	{
	public Hashtable isnull;
 	...
 	private string iSAT_PERSONAFISICA;
        public string ISAT_PERSONAFISICA
        { 
        	get
        	{
         		return this.iSAT_PERSONAFISICA;
        	}
        	set
        	{
        		this.iSAT_PERSONAFISICA= value;
        		this.isnull["ISAT_PERSONAFISICA"]=false;
        	}
        }

 	private string iSAT_PERSONAMORAL;
        public string ISAT_PERSONAMORAL
        { 
        	get
        	{
         		return this.iSAT_PERSONAMORAL;
        	}
        	set
        	{
        		this.iSAT_PERSONAMORAL= value;
        		this.isnull["ISAT_PERSONAMORAL"]=false;
        	}
        }
 	...
 	private DateTime iSAT_FECHAFIN;
		...
		isnull=new Hashtable();
			...
			isnull.Add("ISAT_PERSONAFISICA",true);
	

			isnull.Add("ISAT_PERSONAMORAL",true);
