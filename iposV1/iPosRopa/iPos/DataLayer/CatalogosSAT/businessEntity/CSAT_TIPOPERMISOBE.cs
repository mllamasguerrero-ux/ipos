...
{
	public class CSAT_TIPOPERMISOBE
	{
	public Hashtable isnull;
 	...
 	private string iCLAVETRANSPORTE;
        public string ICLAVETRANSPORTE
        { 
        	get
        	{
         		return this.iCLAVETRANSPORTE;
        	}
        	set
        	{
        		this.iCLAVETRANSPORTE= value;
        		this.isnull["ICLAVETRANSPORTE"]=false;
        	}
        }
 	...
 	private DateTime iFECHAFIN;
		...
		isnull=new Hashtable();
			...
			isnull.Add("ICLAVETRANSPORTE",true);
