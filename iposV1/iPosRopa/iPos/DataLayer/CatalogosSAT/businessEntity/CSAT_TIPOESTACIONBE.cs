...
{
	public class CSAT_TIPOESTACIONBE
	{
	public Hashtable isnull;
 	...
 	private string iCLAVESTRANSPORTE;
        public string ICLAVESTRANSPORTE
        { 
        	get
        	{
         		return this.iCLAVESTRANSPORTE;
        	}
        	set
        	{
        		this.iCLAVESTRANSPORTE= value;
        		this.isnull["ICLAVESTRANSPORTE"]=false;
        	}
        }
 	...
 	private DateTime iFECHAFIN;
		...
		isnull=new Hashtable();
			...
			isnull.Add("ICLAVESTRANSPORTE",true);
