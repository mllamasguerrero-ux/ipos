...
{
	public class CSAT_TIPOCOMPROBANTEBE
	{
	public Hashtable isnull;
 	...
 	private int iSAT_VALORMAXIMO;
        public int ISAT_VALORMAXIMO
        { 
        	get
        	{
 	...
 	private string iSAT_NS;
        public string ISAT_NS
        { 
        	get
        	{
         		return this.iSAT_NS;
        	...
        	{
        		this.iSAT_NS= value;
        		this.isnull["ISAT_NS"]=false;
        	}
        }

 	private string iSAT_NDS;
        public string ISAT_NDS
        { 
        	get
        	{
         		return this.iSAT_NDS;
        	}
        	set
        	{
        		this.iSAT_NDS= value;
        		this.isnull["ISAT_NDS"]=false;
        	}
        }
		
               public CSAT_TIPOCOMPROBANTEBE()
		{
		isnull=new Hashtable();
			...
			isnull.Add("ISAT_NS",true);
	

			isnull.Add("ISAT_NDS",true);
