...
namespace iPosBusinessEntity
{
    ...
    private double iCANT_FAC;
    public double ICANT_FAC
    {
        get
        {
            return this.iCANT_FAC;
        }
        set
        {
            this.iCANT_FAC = value;
            this.isnull["ICANT_FAC"] = false;
        }
    }


    private double iCANT_REM;
    public double ICANT_REM
    {
        get
        {
            return this.iCANT_REM;
        }
        set
        {
            this.iCANT_REM = value;
            this.isnull["ICANT_REM"] = false;
        }
    }



    private double iCANT_IND;
    public double ICANT_IND
    {
        get
        {
            return this.iCANT_IND;
        }
        set
        {
            this.iCANT_IND = value;
            this.isnull["ICANT_IND"] = false;
        }
    }



    private double iPRECREC;
    public double IPRECREC
    {
        get
        {
            return this.iPRECREC;
        }
        set
        {
            this.iPRECREC = value;
            this.isnull["IPRECREC"] = false;
        }
    }
    ...
    public string IIMP_ADU
    {
        ...
        {
            this.iIMP_ADU = value;
            this.isnull["IIMP_ADU"] = false;
        }
    }



    private double iIMP_TC;
    public double IIMP_TC
    {
        get
        {
            return this.iIMP_TC;
    ...
    public string ISUCURSAL
    {
		...
		isnull=new Hashtable();
            ...
            isnull.Add("ICANT_FAC", true);

            isnull.Add("ICANT_REM", true);

            isnull.Add("ICANT_IND", true);

            isnull.Add("IPRECREC", true);

            isnull.Add("IIMP_PED", true);
            isnull.Add("IIMP_FEC", true);
            isnull.Add("IIMP_ADU", true);
            isnull.Add("IIMP_TC", true);
