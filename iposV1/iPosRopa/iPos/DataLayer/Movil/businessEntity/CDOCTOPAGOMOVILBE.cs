...
{
	public class CDOCTOPAGOMOVILBE
	{
	public Hashtable isnull;
 	...
 	private long iDOCTOPAGOMOVILREFID;
        public long IDOCTOPAGOMOVILREFID
        { 
        	get
        	{
         		return this.iDOCTOPAGOMOVILREFID;
        	}
        	set
        	{
        		this.iDOCTOPAGOMOVILREFID= value;
        		this.isnull["IDOCTOPAGOMOVILREFID"]=false;
        	}
        }
 	...
 	private string iVENTACOBRANZA;
		...
		isnull=new Hashtable();
			...
			isnull.Add("IDOCTOPAGOMOVILREFID",true);
