...
namespace iPosBusinessEntity
{
    public class CR_PAGOMOVILBE
    {
        ...
        private long iR_PAGOMOVILREFID;
        public long IR_PAGOMOVILREFID
        {
            get
            {
                return this.iR_PAGOMOVILREFID;
            }
            set
            {
                this.iR_PAGOMOVILREFID = value;
                this.isnull["IR_PAGOMOVILREFID"] = false;
            }
        }
        ...
        private long iPAGOIDORIGINAL;
        public long IPAGOIDORIGINAL
        {
            get
            {
                return this.iPAGOIDORIGINAL;
            }
            set
            {
                this.iPAGOIDORIGINAL = value;
                this.isnull["IPAGOIDORIGINAL"] = false;
            }
        }
        ...
        private List<CR_DOCTOPAGOMOVILBE> detalles;
        public List<CR_DOCTOPAGOMOVILBE> Detalles
        {
            get
            {
        ...
        public CR_PAGOMOVILBE()
        {
            ...
            isnull.Add("IR_PAGOMOVILREFID", true);
            ...
            isnull.Add("IPAGOIDORIGINAL", true);
