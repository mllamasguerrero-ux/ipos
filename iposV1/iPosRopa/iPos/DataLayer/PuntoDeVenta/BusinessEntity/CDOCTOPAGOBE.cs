...
namespace iPosBusinessEntity
{
	...
	public Hashtable isnull;
 	...
 	private decimal iIMPORTECAMBIO;
        ...
        private long iDOCTOSALIDAID;
        public long IDOCTOSALIDAID
        {
            get
            {
                return this.iDOCTOSALIDAID;
            }
            set
            {
                this.iDOCTOSALIDAID = value;
                this.isnull["IDOCTOSALIDAID"] = false;
            }
        }
        ...
        private long iDOCTOPAGOREFID;
        public long IDOCTOPAGOREFID
        {
            get
            {
                return this.iDOCTOPAGOREFID;
            }
            set
            {
                this.iDOCTOPAGOREFID = value;
                this.isnull["IDOCTOPAGOREFID"] = false;
            }
        }
        ...
        public long ISUBTIPOPAGOID
        {
            get
            {
                return this.iSUBTIPOPAGOID;
            }
            set
            {
                this.iSUBTIPOPAGOID = value;
                this.isnull["ISUBTIPOPAGOID"] = false;
            }
        }
        ...
        private decimal iCOMISION2;
        public decimal ICOMISION2
        {
            get
            {
		...
		isnull=new Hashtable();
            ...
            isnull.Add("IDOCTOSALIDAID", true);
            ...
            isnull.Add("IDOCTOPAGOREFID", true);
