...
namespace iPosBusinessEntity
{
	...
	public Hashtable isnull;
 	...
 	private string iCOMISIONISTA;
        public string ICOMISIONISTA
        { 
        	get
        	{
         		return this.iCOMISIONISTA;
        	}
        	set
        	{
        		this.iCOMISIONISTA= value;
        		this.isnull["ICOMISIONISTA"]=false;
        	}
        }
