...
{
	public class CTIPODIFERENCIAINVENTARIOBE
	{
	public Hashtable isnull;
 	...
 	private long iGRUPODIFERENCIAINVENTARIOID;
        public long IGRUPODIFERENCIAINVENTARIOID
        { 
        	get
        	{
         		return this.iGRUPODIFERENCIAINVENTARIOID;
        	}
        	set
        	{
        		this.iGRUPODIFERENCIAINVENTARIOID= value;
        		this.isnull["IGRUPODIFERENCIAINVENTARIOID"]=false;
        	}
        }
		
               public CTIPODIFERENCIAINVENTARIOBE()
		{
		isnull=new Hashtable();
			...
			isnull.Add("IGRUPODIFERENCIAINVENTARIOID",true);
