...
{
	public class CCONTROLPRECIOSBE
	{
	public Hashtable isnull;
 	...
 	private long iIDACTUALIZACION;
        public long IIDACTUALIZACION
        { 
        	get
        	{
         		return this.iIDACTUALIZACION;
        	}
        	set
        	{
        		this.iIDACTUALIZACION= value;
        		this.isnull["IIDACTUALIZACION"]=false;
        	}
        }
		
               public CCONTROLPRECIOSBE()
		{
		isnull=new Hashtable();
			...
			isnull.Add("IIDACTUALIZACION",true);
