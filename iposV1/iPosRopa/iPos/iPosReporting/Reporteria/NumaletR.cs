...
namespace iPosReporting
{
    ...
    public sealed class NumaletR
    {
        ...
        public NumaletR(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        {
            return NumaletR.ToCardinal(Numero, CultureInfo.CurrentCulture);
        }
