...
{
    public partial class FRptVentasXCorteDetalle : Form
    {
        ...
        public FRptVentasXCorteDetalle()
        {
            InitializeComponent();
            m_ieps = false;
        ...
        public FRptVentasXCorteDetalle(bool ieps): this()
        {
            m_ieps = ieps;

        }
        private void FRptVentasXCorteDetalle_Load(object sender, EventArgs e)
        {
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfigReport.getPathForFile("InformeVentasXCorteDETALLE.frx", FastReportsConfigTipoFile.desistema));
