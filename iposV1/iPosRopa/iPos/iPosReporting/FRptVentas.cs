...
{
    public partial class FRptVentas : Form
    {
        ...
        public FRptVentas(bool ieps): this()
        {
            m_ieps = ieps;

        }
        private void FRptVentas_Load(object sender, EventArgs e)
        {
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfigReport.getPathForFile("InformeDiarioVentasIEPSEXP.frx", FastReportsConfigTipoFile.desistema));
