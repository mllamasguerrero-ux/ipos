...
#else
		static int defaultCodePage = System.Globalization.CultureInfo.GetCultureInfo("en-US").TextInfo.OEMCodePage;// Thread.CurrentThread.CurrentCulture.TextInfo.OEMCodePage;
#endif
