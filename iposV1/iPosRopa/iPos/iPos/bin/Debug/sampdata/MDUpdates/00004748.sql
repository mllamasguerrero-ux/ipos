create or alter procedure DEVOLUCION_REVERTIR_PAGOS (
...
BEGIN
   ...
   FROM DOCTOPAGO P
   WHERE P.DOCTOSALIDAID = :DOCTOACANCELARID AND P.tipopagoid = 1 AND P.FORMAPAGOID = 6
   INTO
   ...
   BEGIN
         ...
         INSERT INTO DOCTOPAGO ( DOCTOID, FORMAPAGOID, FECHA, FECHAHORA, CORTEID, IMPORTE, IMPORTERECIBIDO, IMPORTECAMBIO, TIPOPAGOID, DOCTOSALIDAID, ESPAGOINICIAL, CORTETRANSCANCELADA)
                             VALUES (:DOCTOIDBUFFER, 7, CURRENT_DATE, CURRENT_TIME,  :CORTEID, :SALDOBUFFER,:SALDOBUFFER, 0, 1, :DOCTOACANCELARID, 'S', :CORTEACANCELAR);
   ...
   FOR SELECT P.doctoid, P.IMPORTE
   FROM DOCTOPAGO P
   WHERE P.DOCTOSALIDAID = :DOCTOACANCELARID AND P.tipopagoid = 1 AND P.FORMAPAGOID = 18
   INTO
   :DOCTOIDBUFFER, :SALDOBUFFER
   DO
   BEGIN
   ...
   BEGIN
                 INSERT INTO DOCTOPAGO ( DOCTOID, FORMAPAGOID, FECHA, FECHAHORA, CORTEID, IMPORTE, IMPORTERECIBIDO, IMPORTECAMBIO, TIPOPAGOID, DOCTOSALIDAID, ESPAGOINICIAL, CORTETRANSCANCELADA)
                             VALUES (:DOCTODECANCELACION, 7, CURRENT_DATE, CURRENT_TIME,:CORTEID, :SALDOBUFFER,:SALDOBUFFER, 0, 2, :DOCTOACANCELARID, 'S', :CORTEACANCELAR);
   ...
   BEGIN
              ...
              BEGIN
                 INSERT INTO DOCTOPAGO ( DOCTOID, FORMAPAGOID, FECHA, FECHAHORA, CORTEID, IMPORTE, IMPORTERECIBIDO, IMPORTECAMBIO, TIPOPAGOID, DOCTOSALIDAID)
                             VALUES (:DOCTODECANCELACION, 7, CURRENT_DATE, CURRENT_TIME,:CORTEID, :SALDOBUFFER,:SALDOBUFFER, 0, 2, :DOCTOACANCELARID);
               ...
               BEGIN
                 ...
                 INSERT INTO DOCTOPAGO ( DOCTOID, FORMAPAGOID, FECHA, FECHAHORA, CORTEID, IMPORTE, IMPORTERECIBIDO, IMPORTECAMBIO, TIPOPAGOID, DOCTOSALIDAID)
                             VALUES (:DOCTODECANCELACION, 7, CURRENT_DATE, CURRENT_TIME, :CORTEID, :RESTANTEBUFFER,:RESTANTEBUFFER, 0, 2, :DOCTOACANCELARID);
                  RESTANTEBUFFER = 0;
               END
   END   */
