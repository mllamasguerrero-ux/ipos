...
BEGIN
   ...
   if(not(:TIPODOCTOIDENTRADA  in (11,12,13,15,60,61,16,18,202,204,1011,1012,1013,1015) or :TIPODOCTOIDSALIDA in (11,12,13,15,60,61,16,18,202,204,1011,1012,1013,1015))) then
   begin
     exit;
   end
