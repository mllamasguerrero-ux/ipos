...
BEGIN
    ...
    SELECT  ALMACENID, SUCURSALID, TIPODOCTOID, PERSONAID , REFERENCIA, REFERENCIAS ,
            ALMACENTID, SUCURSALTID  , ESTATUSDOCTOID, VENDEDORID , FECHA
    from DOCTO
    where id = :doctoid
        ...
        FOR SELECT
            ...
            BEGIN
                ...
                BEGIN
                      ...
                      UPDATE DOCTO SET DOCTO.plazo = :DIASPLAZO,  doctoplazoorigenid = :DOCTOPLAZOORIGENID WHERE ID = :GRUPO_DOCTOID;
                END
