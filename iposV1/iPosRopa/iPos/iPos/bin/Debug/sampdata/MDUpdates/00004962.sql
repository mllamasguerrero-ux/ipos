...
BEGIN
   ...
   BEGIN         
      SELECT SPRECIO1, SPRECIO2, SPRECIO3, SPRECIO4, SPRECIO5,COSTOPROMEDIO, COSTOPROMEDIO, COSTOULTIMO, COSTOREPOSICION
      FROM PRODUCTO
      WHERE ID = :PRODUCTOID
      INTO :PRECIO1, :PRECIO2, :PRECIO3, :PRECIO4, :PRECIO5, :COSTO, :COSTOPROMEDIO, :COSTOULTIMO, :COSTOREPOSICION;
   END
   ELSE
   BEGIN
      SELECT PRECIO1, PRECIO2, PRECIO3, PRECIO4, PRECIO5,COSTOPROMEDIO,COSTOPROMEDIO, COSTOULTIMO, COSTOREPOSICION
      FROM PRODUCTO
      WHERE ID = :PRODUCTOID
      INTO :PRECIO1, :PRECIO2, :PRECIO3, :PRECIO4, :PRECIO5, :COSTO, :COSTOPROMEDIO, :COSTOULTIMO, :COSTOREPOSICION;
   END
      ...
      begin
        ...
        ELSE IF (:LISTAPRECIO = 'R') THEN
            precioTraspaso = :COSTOREPOSICION;
        ELSE IF (:LISTAPRECIO = 'U') THEN
            precioTraspaso = COALESCE(:COSTOULTIMO, :COSTOREPOSICION);
        ELSE IF (:LISTAPRECIO = 'P') THEN
            precioTraspaso = COALESCE(:COSTOPROMEDIO, :COSTOREPOSICION);
        ELSE 
            precioTraspaso = PRECIO4;
       end
       else
