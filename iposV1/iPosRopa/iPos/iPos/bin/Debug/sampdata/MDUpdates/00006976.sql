...
BEGIN
  ...
  ERRORCODE = 0;
   ...
   SELECT TIPODOCTOID, ESTATUSDOCTOID , SUCURSALID , PERSONAID , FECHA , KITDESGLOSADO, ALMACENID , COTI_ENRUTADA
   FROM DOCTO
   WHERE ID = :DOCTOID
   INTO :TIPODOCTOID, :ESTATUSDOCTOID, :SUCURSALID, :PERSONAID, :FECHAINVENTARIO, :KITDESGLOSADO , :ALMACENID, :COTI_ENRUTADA;
