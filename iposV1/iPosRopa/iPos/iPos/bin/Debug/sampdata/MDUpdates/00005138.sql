   ...
   BEGIN
    ...
    BEGIN
     ...
     BEGIN
        ...
        INTO :SUMACOSTOTOTALSINIMPUESTO, :SUMATOTALCOSTOCONIMPUESTO;
            ...
            FOR SELECT
                        (( COALESCE(KITDEFINICION.COSTOPARTE,0) * COALESCE(KITDEFINICION.CANTIDADPARTE,0)
                         + COALESCE(KITDEFINICION.COSTOPARTE,0) * COALESCE(KITDEFINICION.CANTIDADPARTE,0) * (CASE WHEN PARAMETRO.DESGLOSEIEPS = 'S' THEN COALESCE(PRODUCTO.TASAIEPS,0) / 100.00 ELSE
                          0 END)
                         + (COALESCE(KITDEFINICION.COSTOPARTE,0) * COALESCE(KITDEFINICION.CANTIDADPARTE,0) * (CASE WHEN PARAMETRO.DESGLOSEIEPS = 'S' THEN 1 + (COALESCE(PRODUCTO.TASAIEPS,0) / 100.00)
                          ELSE 1 END)) * (CASE WHEN :EXENTOIVA = 'S' THEN 0.0 ELSE COALESCE(PRODUCTO.TASAIVA,0) END / 100.00) ) / :SUMATOTALCOSTOCONIMPUESTO )  PRORRATEO ,


                       (cast(COALESCE(KITDEFINICION.COSTOPARTE,0) * COALESCE(KITDEFINICION.CANTIDADPARTE,0)  / COALESCE(:SUMACOSTOTOTALSINIMPUESTO, 0.0) as d_decimal_exact)) TASACOSTOTOTALPARTE,
                        ...
                        (CASE WHEN PARAMETRO.DESGLOSEIEPS = 'S' THEN COALESCE(PRODUCTO.TASAIEPS/100.00,0)  ELSE 0.00 END) as d_decimal_exact) AS TASAIEPSPARTE,
                        ...
                        (CASE WHEN PARAMETRO.DESGLOSEIEPS = 'S' THEN 1 + (COALESCE(PRODUCTO.TASAIEPS,0) / 100.00) ELSE 1 END) * (CASE WHEN :EXENTOIVA = 'S' THEN 0.0 ELSE COALESCE(PRODUCTO.TASAIVA,0) END / 100.00) as d_decimal_exact) AS TASAIVAPARTE,
