...
MOVTO.CANTIDAD, CASE WHEN PRODUCTO.descripcion_comodin = 'S' AND
                         ...
                         CASE WHEN MOVTO.eskit = 'S' AND COALESCE(MOVTO.CANTIDAD,0.0) > 0.0 then CAST(MOVTO.TOTAL/MOVTO.cantidad  AS D_PRECIO)
                             WHEN MOVTO.TASAIMPUESTO IS NULL or COALESCE(PARAMETRO.precionetoengrids, 'N') = 'N'  THEN
                                (case when coalesce(movto.estadorebaja,0) not in (0,3) AND coalesce(docto.coti_enrutada,'N') <> 'S' AND coalesce(parametro.versiontopeid,1) <> 2 then movto.precioconrebaja
                                      when coalesce(parametro.versiontopeid,1) = 2 and movto.estatusmovtoid = 0 and movto.tipodoctoid = 21 AND coalesce(docto.coti_enrutada,'N') <> 'S' then MOVTOREBAJA.PRECIOSINREBAJA
                                ...
                                (
                                  CAST(
                                   CAST((
                                       ...
                                       ((100.00 + MOVTO.TASAIEPS) / 100.00) AS d_precio
                                       ) *
                                       ((100.00 + MOVTO.TASAIVA) / 100.00) AS d_precio
                                     )

                                ) / (CASE WHEN DOCTO.TIPOCAMBIO = 0 or  DOCTO.TIPOCAMBIO IS NULL THEN 1 ELSE DOCTO.TIPOCAMBIO END)
                            END
                         AS PRECIOUNIDAD,

                         (case when coalesce(movto.estadorebaja,0) not in (0,3) AND coalesce(docto.coti_enrutada,'N') <> 'S' AND coalesce(parametro.versiontopeid,1) <> 2  then movto.totalconrebaja
                                when coalesce(parametro.versiontopeid,1) = 2 and movto.estatusmovtoid = 0 and movto.tipodoctoid = 21 AND coalesce(docto.coti_enrutada,'N') <> 'S' then
                         ...
                         (case when coalesce(movto.estadorebaja,0) not in (0,3)  AND coalesce(docto.coti_enrutada,'N') <> 'S' AND coalesce(parametro.versiontopeid,1) <> 2   then coalesce(movto.total,0) - coalesce(movto.totalconrebaja,0) + coalesce(movto.descuento,0)
                              when  coalesce(parametro.versiontopeid,1) = 2 and movto.estatusmovtoid = 0 and movto.tipodoctoid = 21 AND coalesce(docto.coti_enrutada,'N') <> 'S' then MOVTOREBAJA.DESCUENTOCONTOPE
                         ...
                         THEN
                            ...
                            cast( (ROUND(
                                      /*PRECIO MAS BAJO POR VALE*/case when ROUND(( CAST(COALESCE(COMISIONTARJETA.FACTORTARJETA,1.00) * MOVTO.PRECIOLISTA AS D_PRECIO)  * ((100 - PARAMETRO.DESCUENTOVALE)/100.00)),2) < MOVTO.PRECIO  THEN   ROUND(( CAST(COALESCE(COMISIONTARJETA.FACTORTARJETA,1.00) * MOVTO.PRECIOLISTA AS D_PRECIO) * ((100 - PARAMETRO.DESCUENTOVALE)/100.00)),2) ELSE MOVTO.PRECIO END
                        ...
                        cast( ROUND((  cast((ROUND(  
                         ...
                         cast( (ROUND(  
                                      /*PRECIO MAS BAJO POR VALE*/case when ROUND(( CAST(COALESCE(COMISIONTARJETA.FACTORTARJETA,1.00) * MOVTO.PRECIOLISTA AS D_PRECIO) * ((100 - descuentotipo2porc)/100.00)),2) < MOVTO.PRECIO  THEN   ROUND(( CAST(COALESCE(COMISIONTARJETA.FACTORTARJETA,1.00) * MOVTO.PRECIOLISTA AS D_PRECIO) * ((100 - PARAMETRO.descuentotipo2porc)/100.00)),2) ELSE MOVTO.PRECIO END
                                      * MOVTO.CANTIDAD , 2)) as d_importe)    +
                        cast( ROUND((  cast((ROUND(   
                                      /*PRECIO MAS BAJO POR VALE*/case when ROUND(( CAST(COALESCE(COMISIONTARJETA.FACTORTARJETA,1.00) * MOVTO.PRECIOLISTA AS D_PRECIO) * ((100 - descuentotipo2porc)/100.00)),2) < MOVTO.PRECIO  THEN   ROUND(( CAST(COALESCE(COMISIONTARJETA.FACTORTARJETA,1.00) * MOVTO.PRECIOLISTA AS D_PRECIO) * ((100 - PARAMETRO.descuentotipo2porc)/100.00)),2) ELSE MOVTO.PRECIO END
                                      * MOVTO.CANTIDAD , 2)) as d_importe)  * (1 + (COALESCE (MOVTO.tasaieps,0)/100.00)) * (COALESCE (MOVTO.tasaiva,0)/100.00)) , 2)  as d_importe) +
                        cast( ROUND((  cast((ROUND(   
                         ...
                         THEN
                                ...
                                cast( (ROUND(   
                                      /*PRECIO MAS BAJO POR VALE*/case when ROUND(( CAST(COALESCE(COMISIONTARJETA.FACTORTARJETA,1.00) * MOVTO.PRECIOLISTA AS D_PRECIO) * ((100 - descuentotipo3porc)/100.00)),2) < MOVTO.PRECIO  THEN   ROUND(( CAST(COALESCE(COMISIONTARJETA.FACTORTARJETA,1.00) * MOVTO.PRECIOLISTA AS D_PRECIO) * ((100 - PARAMETRO.descuentotipo3porc)/100.00)),2) ELSE MOVTO.PRECIO END
                                       * MOVTO.CANTIDAD , 2)) as d_importe)    +
                                cast( ROUND((  cast((ROUND(   
                                      /*PRECIO MAS BAJO POR VALE*/case when ROUND(( CAST(COALESCE(COMISIONTARJETA.FACTORTARJETA,1.00) * MOVTO.PRECIOLISTA AS D_PRECIO) * ((100 - descuentotipo3porc)/100.00)),2) < MOVTO.PRECIO  THEN   ROUND(( CAST(COALESCE(COMISIONTARJETA.FACTORTARJETA,1.00) * MOVTO.PRECIOLISTA AS D_PRECIO) * ((100 - PARAMETRO.descuentotipo3porc)/100.00)),2) ELSE MOVTO.PRECIO END
                                      * MOVTO.CANTIDAD , 2)) as d_importe)  * (1 + (COALESCE (MOVTO.tasaieps,0)/100.00)) * (COALESCE (MOVTO.tasaiva,0)/100.00)) , 2)  as d_importe) +
                         ...
                         (case when coalesce(movto.estadorebaja,0) not in (0,3)  AND coalesce(parametro.versiontopeid,1) <> 2 and coalesce(movto.preciolista,0) <> 0 AND coalesce(docto.coti_enrutada,'N') <> 'S' then (coalesce(movto.PRECIOLISTA,1) - coalesce(MOVTO.PRECIOCONREBAJA,1))/coalesce(movto.PRECIOLISTA,1) else MOVTO.DESCUENTOPORCENTAJE end)   as DESCUENTOPORCENTAJE ,
...
FROM            DOCTO INNER JOIN
                          MOVTO ON MOVTO.DOCTOID = DOCTO.ID LEFT OUTER JOIN  
                           ...
                           (
                            SELECT MOVTO.ID,
                                    case when movto.precio < coalesce(producto.preciotope,0) and coalesce(producto.preciotope,0) > 0 and coalesce(PROMOCION.TIPOPROMOCIONID,0) <> 7 then  round(producto.preciotope,2) else movto.precio end PRECIOSINREBAJA,

                                    movto.descuento - (cast(coalesce(movto.cantidad,0.00) * (( movto.precio  - case when movto.precio < coalesce(producto.preciotope,0) and coalesce(producto.preciotope,0) > 0  and coalesce(PROMOCION.TIPOPROMOCIONID,0) <> 7 then  round(producto.preciotope,2) else movto.precio end) * ((100.00 + MOVTO.TASAIEPS) / 100.00))  as d_precio)) AS DESCUENTOCONTOPE,


                                    case when movto.precio < coalesce(producto.preciotope,0.00) and coalesce(producto.preciotope,0) > 0  and coalesce(PROMOCION.TIPOPROMOCIONID,0) <> 7 then
                                              cast( cast(coalesce(movto.cantidad,0.00) *  round(producto.preciotope,2) as d_precio )  * ((100.00 + MOVTO.TASAIEPS) / 100.00)  * ((MOVTO.TASAIVA) / 100.00) AS d_precio)
                                     else
                                           movto.subtotal + movto.ieps
                                     end  AS IMPORTECONTOPESINIMP  ,

                                            
                                    case when movto.precio < coalesce(producto.preciotope,0.00) and coalesce(producto.preciotope,0) > 0  and coalesce(PROMOCION.TIPOPROMOCIONID,0) <> 7 then
                                              cast( cast( cast(coalesce(movto.cantidad,0.00) *  round(producto.preciotope,2) as d_precio )  * ((100.00 + MOVTO.TASAIEPS) / 100.00) as d_precio) * ((MOVTO.TASAIVA) / 100.00) AS d_precio)
                                     else
                                           movto.iva
                                     end  AS IVACONTOPE   ,

                                    case when movto.precio < coalesce(producto.preciotope,0.00) and coalesce(producto.preciotope,0) > 0  and coalesce(PROMOCION.TIPOPROMOCIONID,0) <> 7 then
                                              cast(coalesce(movto.cantidad,0.00) *  round(producto.preciotope,2) as d_precio ) +
                                              cast( cast(coalesce(movto.cantidad,0.00) *  round(producto.preciotope,2) as d_precio )   * ((MOVTO.TASAIEPS) / 100.00)  AS d_precio) +
                                              cast( cast( cast(coalesce(movto.cantidad,0.00) *  round(producto.preciotope,2) as d_precio )  * ((100.00 + MOVTO.TASAIEPS) / 100.00) as d_precio)  * ((MOVTO.TASAIVA) / 100.00) AS d_precio)
                                     else
                                           movto.total
                                     end  AS TOTALCONTOPE  ,
                         ...
                         PRODUCTOCARACTERISTICAS ON PRODUCTOCARACTERISTICAS.PRODUCTOID = PRODUCTO.ID LEFT OUTER JOIN
                          ...
                          (SELECT DOCTO.ID DOCTOID, 1.00 + CASE WHEN COALESCE(DOCTO.PAGOCONTARJETA ,'N') = 'D' THEN
                                        ...
                                        END FACTORTARJETA
                         FROM DOCTO
                         LEFT JOIN PARAMETRO ON 1 = 1)  COMISIONTARJETA
                         ON COMISIONTARJETA.DOCTOID = DOCTO.ID
