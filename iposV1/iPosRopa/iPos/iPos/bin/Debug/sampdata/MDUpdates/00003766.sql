...
BEGIN
   ...
   WHERE M.DOCTOID = :INVENTARIODOCTOID
      ...
      GROUP BY M.PRODUCTOID,M.LOTE, M.FECHAVENCE, D.PERSONAID , D.VENDEDORID
   INTO
      :PRODUCTOID, :LOTE, :FECHAVENCE,
      :CANTIDAD, :CANTIDADSURTIDA,
      --:CANTIDADFALTANTE,
      :COSTO, :TIPODIFERENCIAINVENTARIOID, :PERSONAID , :VENDEDORID
   DO
   BEGIN
      COSTO = 0;
      ...
      BEGIN
         ...
         --BEGIN
            ...
            FROM MOVTO_INSERT(:DOCTOID, 0, :ALMACENID, :SUCURSALID, :TIPODOCTOID, 0, 0, :PERSONAID, :VENDEDORID, 1, 0,
               ...
               :REFERENCIA, '', :COSTO, :SUCURSALTID, :ALMACENTID, 'N', :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00,NULL,NULL,NULL,NULL,NULL, NULL, NULL, NULL, NULL)
