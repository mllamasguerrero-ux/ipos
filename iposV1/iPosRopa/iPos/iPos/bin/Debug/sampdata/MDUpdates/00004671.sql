...
BEGIN
   ...
   SELECT ALMACENID, SUCURSALID, PERSONAID, SERIE, FOLIO, SUCURSALTID, ALMACENTID, PAGOCONTARJETA , TIPOMAYOREOID , PAGOACREDITO
   FROM DOCTO
   WHERE ID = :DOCTORECALCULARID
   INTO :ALMACENID, :SUCURSALID, :PERSONAID, :SERIE, :FOLIO, :SUCURSALTID, :ALMACENTID, :PAGOCONTARJETA, :TIPOMAYOREOID, :PAGOACREDITO;
   ...
   SELECT  PROMOCION.importe,
    ...
    FOR
        ...
        MOVTO.TIPODIFERENCIAINVENTARIOID , MOVTO.DESCRIPCION1, MOVTO.DESCRIPCION2, MOVTO.DESCRIPCION3 , MOVTO.LOTEIMPORTADO
           ...
           BEGIN
                ...
                BEGIN
                     ...
                     FROM MOVTO_INSERT (
                                           ...
                                           :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, null,NULL ,NULL,NULL,:MOVTOID,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3 , 'N', :LOTEIMPORTADO
                                        ) INTO :ERRORCODE;
                    ...
                    BEGIN
                       ...
                       BEGIN
                            ...
                            BEGIN
                                 ...
                                 FROM GET_PRODUCTO_PRECIO(:PRODUCTOID, :PERSONAID, :CANTIDAD, :PAGOCONTARJETA, :TIPOMAYOREOID,:PAGOACREDITO)
                            ...
                            --CONPROMO
                                 ...
                                 BEGIN
                                        ...
                                        FROM MOVTO_INSERT (
                                           ...
                                           '',  '', :COSTO, :SUCURSALID, :ALMACENID, 'N',
                                           :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, null,NULL ,NULL,NULL,:MOVTOID,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3 , 'S'  ,:LOTEIMPORTADO
                                        ) INTO :ERRORCODE;
