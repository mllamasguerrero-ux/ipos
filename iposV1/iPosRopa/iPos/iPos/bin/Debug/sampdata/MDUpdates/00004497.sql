create or alter procedure PEDIDODEVO_COMPLETAR (
    DOCTOID D_FK,
...
BEGIN
   ...
   -- Si no es documento de compra 82.
   ...
   --insert into traza values('Trapaso completar 1');
    ...
    BEGIN
        ...
        INTO :TIPODOCTOID_REF, :ESTATUSDOCTOID_REF, :DOCTOVENTAID, :FECHAREF;
         ...
         IF (COALESCE(:TIPODOCTOID_REF,0) not in (81,21)) THEN
        BEGIN
            ERRORCODE = 11061;
            SUSPEND;
            EXIT;
        ...
        BEGIN
            ...
            FROM DOCTO WHERE FECHA = :FECHAREF AND DOCTOREFID = :DOCTOTRASLAID AND TIPODOCTOID = 81
            INTO  :DOCTOTRASLAID, :TIPODOCTOID_REF, :ESTATUSDOCTOID_REF, :DOCTOVENTAID;

            IF( COALESCE(:DOCTOTRASLAID,0) = 0 or COALESCE(:TIPODOCTOID_REF,0) not in (81)) THEN
            BEGIN  
                ERRORCODE = 12061;
                SUSPEND;
                EXIT;
        ...
        FOR SELECT MOVTO.ID , MOVTO.PRODUCTOID, MOVTO.LOTE, MOVTO.FECHAVENCE , MOVTO.CANTIDADSURTIDA , MOVTO.PRECIO , MOVTO.LOTEIMPORTADO
         ...
         BEGIN
            ...
            FOLIOSAT,SERIESAT,TIMBRADOFECHA, TIMBRADOUUID,TIMBRADOCERTSAT , ESAPARTADO,:DOCTOVENTAID, 0.00, 0.00 ,7
            ...
            BEGIN
             ...
             UPDATE DOCTO SET SUBTIPODOCTOID = 7, DOCTOREFID = :DOCTONOTACREDITOID WHERE ID = :DOCTOID;
