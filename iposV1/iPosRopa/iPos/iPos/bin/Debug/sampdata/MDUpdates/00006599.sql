create or alter procedure PRODUCTOS_IMPORTAR (
    ...
    SAT_TIPOEMBALAJE_CLAVE D_CLAVE_NULL,
    SAT_CLAVEUNIDADPESO_CLAVE D_CLAVE_NULL,
    PESO D_CANTIDAD,
    ESPELIGROSO D_BOOLCN,
    SAT_MATPELIGROSO_CLAVE D_CLAVE_NULL)
returns (
...
declare variable SAT_TIPOEMBALAJEID D_FK;
declare variable SAT_CLAVEUNIDADPESOID D_FK;
declare variable SAT_MATPELIGROSOID D_FK;
BEGIN
   ...
   select min(id) from sat_tipoembalaje
   where clave = :sat_tipoembalaje_clave
   into :SAT_TIPOEMBALAJEID;
   
   select min(id) from sat_claveunidadpeso
   where clave = :sat_claveunidadpeso_clave
   into :SAT_CLAVEUNIDADPESOID;

   
   select min(id) from sat_matpeligroso
   where clave = :sat_matpeligroso_clave
   into :SAT_MATPELIGROSOID;
  ...
  END
   ...
   BEGIN
    ...
    SAT_TIPOEMBALAJEID=:SAT_TIPOEMBALAJEID,
    SAT_CLAVEUNIDADPESOID=:SAT_CLAVEUNIDADPESOID,
    PESO=:PESO,
    ESPELIGROSO=:ESPELIGROSO,

    SAT_MATPELIGROSOID = :SAT_MATPELIGROSOID
