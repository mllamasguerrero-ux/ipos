create or alter procedure COMPRADEVO_CANCEL_INICIAR (
...
BEGIN
   ...
   IF (:TIPODOCTOCANCELARID = 12) THEN
      TIPODOCTOID = 15;    
   IF (:TIPODOCTOCANCELARID = 1012) THEN
      TIPODOCTOID = 1015;
   ...
   END
        ...
        /*Echar para atras pagos*/
              SELECT ERRORCODE FROM COMPRADEVO_REVERTIR_PAGOS(:DOCTOCANCELARID, :DOCTOID,:VENDEDORID) INTO :ERRORCODE;
