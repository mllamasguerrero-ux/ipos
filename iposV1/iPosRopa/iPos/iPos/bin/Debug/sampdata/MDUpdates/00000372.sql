...
BEGIN
   ...
   IMPORTEEFECTIVONETO = :IMPORTETOTALAPAGAR - :IMPORTETARJETA - :IMPORTECHEQUE - :IMPORTECREDITO - :IMPORTEVALE + :IMPORTECAMBIOCHEQUE;
   ...
   BEGIN
      ...
      FROM DOCTOPAGO_INSERT (
         ...
         :FORMAPAGOID,
         :FECHA, :FECHAHORA, :CORTEID,
         :IMPORTECHEQUE, 0.00, :IMPORTECAMBIOCHEQUE
      ) INTO :ERRORCODE;
   END
