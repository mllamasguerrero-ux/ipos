        ...
        LEFT JOIN ALMACEN ALMACENTRASPASO ON ALMACENTRASPASO.ID = DOCTO.ALMACENTID
         ...
         left join (
                select movto.doctoid,
                        sum(case when ((movto.tipodoctoid = 41 or (movto.tipodoctoid = 11 or coalesce(docto.subtipodoctoid,0) = 23)) and coalesce(movto.cantidad, 0) > 0)  then round(coalesce(movto.subtotal,0) * (coalesce(movto.cantidadsurtida, 0) / coalesce(movto.cantidad, 1)),2) else coalesce(movto.subtotal,0) end) subtotal,
                        sum(case when ((movto.tipodoctoid = 41 or (movto.tipodoctoid = 11 or coalesce(docto.subtipodoctoid,0) = 23)) and coalesce(movto.cantidad, 0) > 0)  then round(coalesce(movto.iva,0) * (coalesce(movto.cantidadsurtida, 0) / coalesce(movto.cantidad, 1)),2) else coalesce(movto.iva,0) end) iva,
                        sum(case when ((movto.tipodoctoid = 41 or (movto.tipodoctoid = 11 or coalesce(docto.subtipodoctoid,0) = 23)) and coalesce(movto.cantidad, 0) > 0)  then round(coalesce(movto.total,0) * (coalesce(movto.cantidadsurtida, 0) / coalesce(movto.cantidad, 1)),2) else coalesce(movto.total,0) end) total,
                        sum(case when ((movto.tipodoctoid = 41 or (movto.tipodoctoid = 11 or coalesce(docto.subtipodoctoid,0) = 23)) and coalesce(movto.cantidad, 0) > 0)  then round(coalesce(movto.cantidadsurtida,0) ,2) else coalesce(movto.cantidad,0) end) numeropiezas,
                        sum(case when ((movto.tipodoctoid = 41 or (movto.tipodoctoid = 11 or coalesce(docto.subtipodoctoid,0) = 23)) and coalesce(movto.cantidad, 0) > 0)  then round(coalesce(movto.descuentovale,0) * (coalesce(movto.cantidadsurtida, 0) / coalesce(movto.cantidad, 1)),2) else coalesce(movto.descuentovale,0) end) descuentovale ,
                        sum(case when ((movto.tipodoctoid = 41 or (movto.tipodoctoid = 11 or coalesce(docto.subtipodoctoid,0) = 23)) and coalesce(movto.cantidad, 0) > 0)  then round(coalesce(movto.ieps,0) * (coalesce(movto.cantidadsurtida, 0) / coalesce(movto.cantidad, 1)),2) else coalesce(movto.ieps,0) end) ieps,
                        sum(case when ((movto.tipodoctoid = 41 or (movto.tipodoctoid = 11 or coalesce(docto.subtipodoctoid,0) = 23)) and coalesce(movto.cantidad, 0) > 0)  then round(coalesce(movto.impuesto,0) * (coalesce(movto.cantidadsurtida, 0) / coalesce(movto.cantidad, 1)),2) else coalesce(movto.impuesto,0) end) impuesto
