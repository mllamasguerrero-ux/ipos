CREATE TABLE EMIDACOMISION (
    ...
    VERSIONEMIDA          D_NOMBRE /* D_NOMBRE = VARCHAR(127) NOT NULL */,
    RESPONSECODE          D_NOMBRE /* D_NOMBRE = VARCHAR(127) NOT NULL */,
    PRODUCTID             D_NOMBRE /* D_NOMBRE = VARCHAR(127) NOT NULL */,
    PRODUCTDESCRIPTION    D_NOMBRE /* D_NOMBRE = VARCHAR(127) NOT NULL */,
    PRODUCTUFEE           D_NOMBRE /* D_NOMBRE = VARCHAR(127) NOT NULL */
);