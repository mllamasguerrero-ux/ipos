...
BEGIN
   ...
   INTO 
    ...
    LINEAID = CASE WHEN COALESCE(:EMIDARECARGALINEAID,0) > 0 THEN  :EMIDARECARGAMARCAID ELSE LINEAID END,
    PROVEEDOR1ID = CASE WHEN COALESCE(:EMIDARECARGAPROVEEDORID,0) > 0 THEN  :EMIDARECARGAPROVEEDORID ELSE PROVEEDOR1ID END,
    COSTOREPOSICION = COALESCE(PRECIO1,0 )  * ((100 - COALESCE(:EMIDAPORCUTILIDADRECARGAS,0)) / 100 )
    ...
    LINEAID = CASE WHEN COALESCE(:EMIDASERVICIOLINEAID,0) > 0 THEN  :EMIDASERVICIOMARCAID ELSE LINEAID END,
