...
declare variable TIPOMAYOREOLINEAIDAPLICADO D_FK;
...
declare variable PRECIOCONREBAJA D_FK;
BEGIN
  ...
  --Checar producto descontinuado en venta
    ...
    select clave, ESKIT from producto where id = :productoid into :PRODUCTOCLAVE, :ESKIT;
      ...
      BEGIN
         ...
         BEGIN
            ...
            IF (  ( :TIPODOCTOID IN (SELECT ID FROM TIPODOCTO WHERE SENTIDOINVENTARIO = -1) or  :TIPODOCTOID IN (211) )
            ...
            BEGIN
               ...
               IF((:TIPODOCTOID IN (/*21,*/25,12,31, 121, 211, 1012) or (:TIPODOCTOID = 21 AND COALESCE(:SUBTIPODOCTOID ,0)<> 8 ) ) AND
         ...
         SELECT PRECIO, ESPROMOCION, PROMOCIONID, PROMOCIONDESGLOSE, MONEDEROABONO, TIPOMAYOREOLINEAIDAPLICADO, ERRORCODE
         ...
         INTO :PRECIONUEVO, :ESPROMOCION, :PROMOCIONID, :PROMOCIONDESGLOSE, :MONEDEROABONO , :TIPOMAYOREOLINEAIDAPLICADO, :ERRORCODE;
         ...
         BEGIN
            ...
            BEGIN
               ...
               PRECIONUEVO = :PRECIO;
               PRECIOMANUAL = CASE WHEN COALESCE(:PRECIOMANUALBUFFER, 0.00) <> 0 THEN :PRECIOMANUALBUFFER ELSE :PRECIO END;
   ...
   BEGIN
      ...
      SELECT CANTIDAD, ENPROCESOPARTES, PRECIOCONREBAJA
      FROM MOVTO
      WHERE ID = :MOVTOID
      INTO :CANTIDADACTUAL, :ENPROCESOPARTES, :PRECIOCONREBAJA;
      ...
      BEGIN
        ...
        -- otras salidas
            ...
            BEGIN
               ...
               --si estamos recalculando
                ...
                BEGIN
                   ...
                   --PAGO CON TARJETA
                   IF ( COALESCE(:PAGOCONTARJETA,'N') IN ('S','D','C')) THEN    --si se esta intentando recalcular
                   BEGIN
         ...
         SELECT LISTAPRECIOID FROM GET_LISTAPRECIO_PORRANGO(:PRODUCTOID,
                                (CASE WHEN COALESCE(:PRECIOCONREBAJA,0) > 0 THEN COALESCE(:PRECIOCONREBAJA,0) ELSE :PRECIO END)) INTO :MOVTOLISTAPRECIOID;
   ...
   END
     ...
     --Ver si aplica algun cambio de tipo de mayoreo si esta activado mayoreo por linea y si es asi recalcula docto
      ...
      BEGIN
         ...
         IF(COALESCE(:PRECIOYAVALIDADO,'N') <> 'S' AND COALESCE(:ESTATUSDOCTOID,0) = 0) THEN
         BEGIN
