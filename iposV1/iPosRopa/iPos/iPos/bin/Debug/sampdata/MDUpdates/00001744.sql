...
declare variable COSTOULTIMO type of D_COSTO;
...
BEGIN
   ...
   begin
      vence = dateadd( :plazo day to :fecha );
   end
...
/* tipo cambio*/
  ...
  --Checar producto descontinuado en venta
   ...
   BEGIN
      SELECT PRECIO1, TASAIVA, CASE WHEN COALESCE(COSTOULTIMO,0) = 0 THEN COALESCE(COSTOREPOSICION,0) ELSE COALESCE(COSTOULTIMO,0) END,
      COALESCE(COSTOPROMEDIO,0), COALESCE(COSTOREPOSICION,0), PRECIOMAXIMOPUBLICO, NEGATIVOS, INVENTARIABLE , UNIDAD, COMISION, ENPROCESODESALIDA , TASAIEPS, TASAIMPUESTO
      FROM PRODUCTO
      WHERE ID = :PRODUCTOID
      INTO :PRECIOLISTA, :TASAIVA, :COSTOULTIMO, :COSTOPROMEDIO, :COSTOREPOSICION, :PRECIOMAXIMOPUBLICO, :NEGATIVOS, :INVENTARIABLE, :UNIDADPRODUCTO, :COMISIONXUNIDAD, :ENPROCESODESALIDA, :TASAIEPS, :TASAIMPUESTO;
   ...
   ELSE
   BEGIN
      SELECT PRECIO1, coalesce(TASAIVA,0),CASE WHEN COALESCE(COSTOULTIMO,0) = 0 THEN COALESCE(COSTOREPOSICION,0) ELSE COALESCE(COSTOULTIMO,0) END,
      COALESCE(COSTOREPOSICION,0), COALESCE(PRECIOMAXIMOPUBLICO,0), COSTOPROMEDIO, NEGATIVOS, INVENTARIABLE , UNIDAD, COMISION , ENPROCESODESALIDA , TASAIEPS, TASAIMPUESTO
      FROM PRODUCTO
      WHERE ID = :PRODUCTOID
      INTO :PRECIOLISTA, :TASAIVA, :COSTOULTIMO, :COSTOREPOSICION, :PRECIOMAXIMOPUBLICO, :COSTOPROMEDIO, :NEGATIVOS, :INVENTARIABLE, :UNIDADPRODUCTO, :COMISIONXUNIDAD, :ENPROCESODESALIDA , :TASAIEPS, :TASAIMPUESTO;
   END
   ...
   BEGIN
    ...
    select clave from producto where id = :productoid into :PRODUCTOCLAVE;
      ...
      BEGIN
         ...
         IF (:PORCENTAJEDESCUENTO IS NOT NULL and (:LLEGOPRECIOMANUAL = 'N' or (:PRECIO = -0.02 and :TIPODOCTOID = 11) )) THEN
         BEGIN
                ...
                BEGIN
                        ...
                        END
                END
                ELSE IF(:TIPODESCUENTOPRODID = 1) THEN
                BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
              ...
              IF (  (:LLEGOPRECIOMANUAL = 'N' or (:PRECIO = -0.02 and :TIPODOCTOID = 11) )  and (:PORCENTAJEDESCUENTO IS NOT NULL) ) THEN
              BEGIN
