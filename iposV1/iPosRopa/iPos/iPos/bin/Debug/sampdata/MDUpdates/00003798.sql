                            ...
                            --CONPROMO
                                 ...
                                 BEGIN
                                        ...
                                        HUBOMOVIMIENTOS = 'S';
                                          ...
                                          PROMOCIONDESGLOSE = 'DESCUENTO DE ' || CAST( :PORCPROMO AS VARCHAR(10))
                                                             || ' EN LA COMPRA SUPERIOR A ' ||  CAST(:IMPORTEPROMO AS VARCHAR(10))
                                                             || ' DE LA LINEA ' || COALESCE(:DESCRIPCIONLINEA,'')
                                          WHERE ID = :MOVTOID;
