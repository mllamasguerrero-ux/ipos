CREATE TABLE BITACOBRANZADET (
    ...
    BITCOBRANZAID         D_FK /* D_FK = BIGINT */,
    ...
    DIAPAGOS              D_STDTEXT_LIGHT /* D_STDTEXT_LIGHT = VARCHAR(64) */,
    ABONO                 D_PRECIO /* D_PRECIO = NUMERIC(18,2) DEFAULT 0.00 */,
    DOCTOPAGOID           D_FK /* D_FK = BIGINT */,
    ESTADO                D_FK /* D_FK = BIGINT */,
    OBSERVACIONES         D_OBSERVACION /* D_OBSERVACION = VARCHAR(512) */,
    NUEVAFECHACOBRO       D_FECHA /* D_FECHA = DATE */
);