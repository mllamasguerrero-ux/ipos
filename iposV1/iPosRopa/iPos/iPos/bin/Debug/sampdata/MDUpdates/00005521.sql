...
BEGIN
   SELECT
      ...
      d.tipodoctoid, d.personaid , M.costo , M.DESCRIPCION1, M.DESCRIPCION2, M.DESCRIPCION3, M.LOTEIMPORTADO
   FROM MOVTO M
      LEFT JOIN DOCTO D
         ON D.ID = M.DOCTOID
   WHERE
   ...
   INTO
      ...
      :TIPODOCTOID, :PERSONAID, :COSTO, :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3, :LOTEIMPORTADO;
