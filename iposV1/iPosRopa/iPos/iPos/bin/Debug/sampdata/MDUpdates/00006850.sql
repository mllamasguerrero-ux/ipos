...
BEGIN
   ...
   SELECT PERSONAID, TIPODOCTOID, PAGOACREDITO,  TIMBRADOFORMAPAGOSAT , SUBTIPODOCTOID , DOCTOREFID, FECHAINI, FECHAFIN, USARDATOSENTREGA
    FROM docto WHERE ID = :DOCTOID
    INTO :PERSONAID, :TIPODOCTOID, :PAGOACREDITO, :PRE_FORMAPAGOSAT, :SUBTIPODOCTOID, :DOCTOREFID, :FECHAINI, :FECHAFIN, :USARDATOSENTREGA;
   ...
   END
     ...
     BEGIN
        ...
        --IF(COALESCE(:PREGUNTARDATOSENTREGA,'N') = 'N' or coalesce(:USARDATOSENTREGA,'N') <> 'S'  or COALESCE(:PERSONAENTREGACALLE, '') = '' ) THEN
        --BEGIN
         ...
         --       PERSONA.ENTREGACODIGOPOSTAL,PERSONA.RFC, PERSONA.nombres || ( CASE when coalesce(PERSONA.apellidos,'') = '' THEN '' ELSE  ' ' || coalesce(PERSONA.apellidos,'') END), '',
         --       PERSONA.nombres || ( CASE when coalesce(PERSONA.apellidos,'') = '' THEN '' ELSE  ' ' || coalesce(PERSONA.apellidos,'') END) ,''
         --       FROM PERSONA
         --       WHERE ID = :PERSONAID
