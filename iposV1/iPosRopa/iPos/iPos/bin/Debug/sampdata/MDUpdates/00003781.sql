...
BEGIN
   ...
   FOR SELECT
      ...
      M.TIPODIFERENCIAINVENTARIOID  , M.CANTIDADDEFACTURA, M.CANTIDADDEREMISION, M.CANTIDADDEINDEFINIDO, M.DESCRIPCION1, M.DESCRIPCION2, M.DESCRIPCION3, D.PERSONAID , M.descuentoporcentaje
   FROM MOVTO M
   LEFT JOIN DOCTO D ON D.id = M.DOCTOID
   WHERE M.DOCTOID = :DOCTOSAVEID
   INTO
      :MOVTOID, :PRODUCTOID, :LOTE, :FECHAVENCE, :CANTIDAD, :PRECIO, :COSTO,
      :TIPODIFERENCIAINVENTARIOID , :CANTIDADDEFACTURA, :CANTIDADDEREMISION, :CANTIDADDEINDEFINIDO , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3 , :PERSONAID, :PORCENTAJEDESCUENTO
   DO
   BEGIN
      ...
      FROM MOVTO_INSERT (
         ...
         :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, :PORCENTAJEDESCUENTO ,NULL,NULL,NULL,NULL,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3 , NULL
