CREATE TABLE MOVILSESION (
    ...
    VENDEDORCLAVE         D_CLAVE /* D_CLAVE = VARCHAR(31) NOT NULL */,
    FECHAINICIOVENTA      D_FECHA /* D_FECHA = DATE */,
    FECHAINICIOCOBRA      D_FECHA /* D_FECHA = DATE */,
    FOLIOINICIOVENTA      D_FK /* D_FK = BIGINT */,
    FOLIOINICIOCOBRA      D_FK /* D_FK = BIGINT */,
    FECHAFINVENTA         D_FECHA /* D_FECHA = DATE */,
    FECHAFINCOBRA         D_FECHA /* D_FECHA = DATE */,
    FOLIOFINVENTA         D_FK /* D_FK = BIGINT */,
    FOLIOFINCOBRA         D_FK /* D_FK = BIGINT */
);
