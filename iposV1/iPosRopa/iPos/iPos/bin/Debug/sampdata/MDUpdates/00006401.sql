...
BEGIN
   ...
   -- Leer del DOCTO a cancelar.
   SELECT ALMACENID, SUCURSALID, PERSONAID, SERIE, FOLIO, SUCURSALTID, ALMACENTID , DOCTOREFID , REFERENCIAS
   FROM DOCTO
   WHERE ID = :DOCTOORIGINALID
   INTO :ALMACENID, :SUCURSALID, :PERSONAID, :SERIE, :FOLIO, :SUCURSALTID, :ALMACENTID, :DOCTOREFID, :REFERENCIAS;
   ...
   FOR SELECT
      ...
      TIPODIFERENCIAINVENTARIOID  , CANTIDADDEFACTURA, CANTIDADDEREMISION, CANTIDADDEINDEFINIDO, DESCRIPCION1, DESCRIPCION2, DESCRIPCION3, CANTIDADSURTIDA, MOVTO.descuentoporcentaje, LOTEIMPORTADO
   FROM MOVTO
   ...
   INTO
      ...
      :TIPODIFERENCIAINVENTARIOID , :CANTIDADDEFACTURA, :CANTIDADDEREMISION, :CANTIDADDEINDEFINIDO , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3 , :CANTIDADSURTIDA ,:PORCENTAJEDESCUENTO , :LOTEIMPORTADO
   DO
   BEGIN


      PRECIO = CASE WHEN COALESCE(:PRECIO, 0)  = 0 THEN -0.01 ELSE :PRECIO END;
      ...
      FROM MOVTO_INSERT (
         ...
         :REFERENCIA, :REFERENCIAS, :PRECIO, :SUCURSALID, :ALMACENID, 'N',
