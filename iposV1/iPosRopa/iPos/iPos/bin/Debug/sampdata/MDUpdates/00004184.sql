...
BEGIN
   ...
   BEGIN
      ...
      FROM MOVTO_INSERT (
         ...
         :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, null,NULL ,NULL,NULL,:MOVTOID,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3 , NULL ,:LOTEIMPORTADO
      ) INTO :ERRORCODE;
