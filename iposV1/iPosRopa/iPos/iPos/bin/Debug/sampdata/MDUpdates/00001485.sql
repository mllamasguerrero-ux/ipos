...
BEGIN
   ...
   BEGIN
       ...
       SELECT PERSONA.ID FROM SUCURSAL INNER JOIN PERSONA ON SUCURSAL.CLIENTECLAVE = PERSONA.CLAVE AND PERSONA.tipopersonaid = 50 INTO :PERSONASUCURSALID;
        ...
        FOLIOSAT,SERIESAT,TIMBRADOFECHA, TIMBRADOUUID,TIMBRADOCERTSAT , ESAPARTADO,ID, 0.00, 0.00 ,7
        ...
        UPDATE DOCTO SET SUBTIPODOCTOID = 7, DOCTOREFID = :DOCTOVENTAID WHERE ID = :DOCTOID;
