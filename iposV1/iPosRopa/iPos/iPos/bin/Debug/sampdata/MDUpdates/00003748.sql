...
BEGIN
   ...
   BEGIN
        ...
        FOR SELECT
            FECHAVENCE, LOTE, coalesce(CANTIDAD,0)
        FROM INVENTARIO
        where PRODUCTOID = :PRODUCTOID  and coalesce(cantidad,0) > 0
        order by fechavence
        INTO
            :FECHAVENCE, :LOTE, :CANTIDADINVENTARIO
        DO
        BEGIN
           ...
           END
            ...
            END
              ...
              BEGIN
                  ...
                  UPDATE MOVTO SET CANTIDAD = :CANTIDADASIGNAR , LOTE = :LOTE, FECHAVENCE = :FECHAVENCE WHERE ID = :MOVTOID;
                  ...
                  SELECT ERRORCODE
                    ...
                    :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00 ,NULL,NULL,NULL,:MOVTOID,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3  , NULL
                ) INTO :ERRORCODE;
