...
BEGIN
   ...
   FROM MOVTO_INSERT (
      ...
      :REFERENCIA, :REFERENCIAS, :COSTO, :SUCURSALTID, :ALMACENTID, 'N', 0, :FECHA, :VENCE, 0.00 ,NULL,NULL,NULL,NULL,NULL, NULL, NULL, NULL , NULL , NULL , 'N','N'
   ) INTO :DOCTOID, :MOVTOID;

    
   UPDATE MOVTO SET  PRECIOLISTA = :PRECIOVISIBLETRASLADO,
   MOVTO.descuentovaleporcentaje = :DESCUENTOOTORGADO,
   MOVTO.descuentovale = :PRECIOACT WHERE ID = :MOVTOID ;
