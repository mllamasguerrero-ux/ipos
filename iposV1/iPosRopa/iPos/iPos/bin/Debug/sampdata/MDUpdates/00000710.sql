...
BEGIN
  ...
  select TIPODOCTOID, FECHA, FECHAHORA, ALMACENID , COALESCE(ESFACTURAELECTRONICA , 'N') , ORIGENFISCALID
  from DOCTO
  where ID = :DOCTOID
  into :TIPODOCTOID, :FECHA, :FECHAHORA, :ALMACENID, :ESFACTURAELECTRONICA, :DOCTOORIGENFISCAL;
  ...
  -- inventario fisico entrada
   IF(:TIPODOCTOID IN (51) AND  :CANTIDADDEFACTURA = 0 AND :CANTIDADDEREMISION = 0 AND :CANTIDADDEINDEFINIDO = 0) THEN
   BEGIN
  ...
  END
   ...
   BEGIN
      ...
      VALUES
         (:TIPODOCTOID, :DOCTOID, :MOVTOID, :FECHA, :FECHAHORA,
          :AlmacenId, :PRODUCTOID, :LOTE, :FECHAVENCE, :CANTIDADDEFACTURA, :PRECIO, :COSTO,3, :ESAPARTADO);
   ...
   BEGIN
      ...
      VALUES
         (:TIPODOCTOID, :DOCTOID, :MOVTOID, :FECHA, :FECHAHORA,
          :AlmacenId, :PRODUCTOID, :LOTE, :FECHAVENCE, :CANTIDADDEREMISION, :PRECIO, :COSTO,2, :ESAPARTADO);
   ...
   BEGIN
      ...
      VALUES
         (:TIPODOCTOID, :DOCTOID, :MOVTOID, :FECHA, :FECHAHORA,
          :AlmacenId, :PRODUCTOID, :LOTE, :FECHAVENCE, :CANTIDADDEINDEFINIDO, :PRECIO, :COSTO,1,:ESAPARTADO);
