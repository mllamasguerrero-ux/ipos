...
MOVTO.CANTIDAD, CASE WHEN PRODUCTO.descripcion_comodin = 'S' AND
                        ...
                        cast( ROUND((  cast((ROUND( ROUND((MOVTO.PRECIO * ((100 - PARAMETRO.DESCUENTOVALE)/100.00)),2) * MOVTO.CANTIDAD , 2)) as d_importe) * (COALESCE (MOVTO.tasaieps,0)/100.00)) ,2 )  as d_importe)
                         ...
                         cast( (ROUND( ROUND((MOVTO.PRECIO * ((100 - PARAMETRO.descuentotipo1porc)/100.00)),2) * MOVTO.CANTIDAD , 2)) as d_importe)    +
                        cast( ROUND((  cast((ROUND( ROUND((MOVTO.PRECIO * ((100 - PARAMETRO.descuentotipo1porc)/100.00)),2) * MOVTO.CANTIDAD , 2)) as d_importe)  * (1 + (COALESCE (MOVTO.tasaieps,0)/100.00)) * (COALESCE (MOVTO.tasaiva,0)/100.00)) , 2)  as d_importe) +
                        cast( ROUND((  cast((ROUND( ROUND((MOVTO.PRECIO * ((100 - PARAMETRO.descuentotipo1porc)/100.00)),2) * MOVTO.CANTIDAD , 2)) as d_importe) * (COALESCE (MOVTO.tasaieps,0)/100.00)) ,2 )  as d_importe)
                         ...
                         cast( (ROUND( ROUND((MOVTO.PRECIO * ((100 - PARAMETRO.descuentotipo2porc)/100.00)),2) * MOVTO.CANTIDAD , 2)) as d_importe)    +
                        cast( ROUND((  cast((ROUND( ROUND((MOVTO.PRECIO * ((100 - PARAMETRO.descuentotipo2porc)/100.00)),2) * MOVTO.CANTIDAD , 2)) as d_importe)  * (1 + (COALESCE (MOVTO.tasaieps,0)/100.00)) * (COALESCE (MOVTO.tasaiva,0)/100.00)) , 2)  as d_importe) +
                        cast( ROUND((  cast((ROUND( ROUND((MOVTO.PRECIO * ((100 - PARAMETRO.descuentotipo2porc)/100.00)),2) * MOVTO.CANTIDAD , 2)) as d_importe) * (COALESCE (MOVTO.tasaieps,0)/100.00)) ,2 )  as d_importe)
                         ...
                         cast( (ROUND( ROUND((MOVTO.PRECIO * ((100 - PARAMETRO.descuentotipo3porc)/100.00)),2) * MOVTO.CANTIDAD , 2)) as d_importe)    +
                        cast( ROUND((  cast((ROUND( ROUND((MOVTO.PRECIO * ((100 - PARAMETRO.descuentotipo3porc)/100.00)),2) * MOVTO.CANTIDAD , 2)) as d_importe)  * (1 + (COALESCE (MOVTO.tasaieps,0)/100.00)) * (COALESCE (MOVTO.tasaiva,0)/100.00)) , 2)  as d_importe) +
                        cast( ROUND((  cast((ROUND( ROUND((MOVTO.PRECIO * ((100 - PARAMETRO.descuentotipo3porc)/100.00)),2) * MOVTO.CANTIDAD , 2)) as d_importe) * (COALESCE (MOVTO.tasaieps,0)/100.00)) ,2 )  as d_importe)
