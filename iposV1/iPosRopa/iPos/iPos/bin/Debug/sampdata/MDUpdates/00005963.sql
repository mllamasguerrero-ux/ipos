  ...
  FOR SELECT TASA
   ...
   BEGIN
     ...
     BEGIN
        ...
        WHERE (MOVTO.DOCTOID = :DOCTOID or MOVTO.DOCTOID = :DOCTOREFKITID)
        AND MOVTO.TASAIVA = 0
        INTO :SUBTOTALIVA0;
        ...
        BEGIN     
            ...
            FROM MOVTO  
            LEFT JOIN PRODUCTO ON MOVTO.PRODUCTOID = PRODUCTO.ID
            WHERE (MOVTO.DOCTOID = :DOCTOID or MOVTO.DOCTOID = :DOCTOREFKITID)--IN (:DOCTOID, :DOCTOREFKITID) --AND COALESCE(ESKIT,'N') = 'N'
