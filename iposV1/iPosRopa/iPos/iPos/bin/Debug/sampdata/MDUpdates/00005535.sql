create or alter procedure TRASLADOPROMOCION_APLICAR (
...
BEGIN
   ...
   IF (:TIPODOCTOID NOT IN (1001)) THEN
   BEGIN
      ERRORCODE = 4003;
      SUSPEND;
      EXIT;
   ...
   BEGIN
      ...
      SUCURSALTID = 0;
            ...
            FROM MOVTO_INSERT(:DOCTOIDAJUSTE, 0, :ALMACENTID, :SUCURSALID, :TIPODOCTOIDAJUSTE, 0, 0, :PERSONAID, :VENDEDORID, 1, 0,
               ...
               :REFERENCIA, '', :COSTO, :SUCURSALTID, :ALMACENID, 'N', NULL, CURRENT_DATE, CURRENT_DATE, 0.00,:TRASLADOPROMOCIONID,NULL,NULL,NULL,:MOVTOREFID, :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3, NULL, :LOTEIMPORTADO, 'N', 'N')
