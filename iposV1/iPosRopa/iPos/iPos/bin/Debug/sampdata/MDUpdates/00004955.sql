...
BEGIN
   ...
   BEGIN
      ...
      UPDATE DOCTO SET DOCTO.vendedorfinal = :vendedorid where ID = :DOCTOID;
   END
   ELSE
   BEGIN
   ...
   FROM MOVTO_INSERT (
      ...
      :REFERENCIA, :REFERENCIAS, 0, 0, 0, 'N', 0, :FECHA, NULL, 0.00, NULL,NULL,NULL,NULL,NULL , NULL, NULL, NULL  , NULL, NULL
