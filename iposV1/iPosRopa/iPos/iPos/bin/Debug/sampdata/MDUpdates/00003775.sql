...
BEGIN
   ...
   INTO
      ...
      :TOTAL, :SUBTOTAL, :DOCTOREFID , :MOVTOPARENTREFID
   DO
   BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            FROM MOVTO_INSERT(:DOCTOIDFORKIT, 0, :ALMACENID, :SUCURSALID, :TIPODOCTOIDFORKIT, 0, 0, :PERSONAID, :VENDEDORID, 1, 0,
               ...
               :REFERENCIA, '', :COSTO, :SUCURSALTID, :ALMACENID, 'N', NULL, CURRENT_DATE, CURRENT_DATE, 0.00,:DOCTOIDPARALLENAR,NULL,NULL,NULL,:MOVTOREFID, :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3, NULL)
            ...
            DETALLEKITIEPS = :DETALLEKITSUBTOTAL * (:DETALLEKITTASAIEPS/100.00);
            DETALLEKITIVA = (:DETALLEKITSUBTOTAL * (1.00 + :DETALLEKITTASAIEPS/100.00)) * (:DETALLEKITTASAIVA/100.00);
