...
SELECT        DOCTO.ID AS DOCTOID,
              ...
              CASE WHEN MOVTO.TASAIMPUESTO IS NULL or COALESCE(PARAMETRO.precionetoengrids, 'N') = 'N'
                         THEN MOVTO.COSTO ELSE ( CAST( CAST( MOVTO.COSTO * ((100.00 + MOVTO.TASAIEPS) / 100.00) AS D_IMPORTE) * ((100.00 + MOVTO.TASAIVA) / 100.00) AS D_IMPORTE) ) END AS PRECIOUNIDAD,
                         ...
                         MOVTO.fechavence ,
                         MOVTO.DESCRIPCION1 AS MOVTODESCRIPCION1,
                         MOVTO.DESCRIPCION2 AS MOVTODESCRIPCION2,
                         MOVTO.DESCRIPCION3 AS MOVTODESCRIPCION3,
                         MOVTO.PRODUCTOID
