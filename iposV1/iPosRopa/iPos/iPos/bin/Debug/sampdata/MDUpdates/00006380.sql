CREATE OR ALTER VIEW CORTE_BASE_POR_PAGOYFORMAPAGO(
    CORTEID,
    DOCTOID,
    TIPODOCTOID,
    SUBTIPODOCTOID,
...
cortebaseformapago.doctopagoid,
...
(
  ...
  select
    ...
    (
        ...
        group by base.corteid, base.doctoid, base.formapagoid, base.tipoabonoid, base.tipodoctoid,  base.mismocorte , base.subtipodoctoid, base.doctopagoid
 )
   cortebaseformapago
