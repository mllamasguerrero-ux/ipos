           ...
           2 cargoabono ,
            ...
            case
                when p.formapagoid in (1,2,3,5,14,15,16) then
                    ...
                    case when p.formapagoid = 1 and de.tipodoctoid = 12 then
                      0
            ...
            case when p.formapagoid in (6,7,8,9,10,11,12,13) then
                ...
                when p.formapagoid = 1 and de.tipodoctoid = 12 then      --*********
                        case when p.tipopagoid = 2 then
                            coalesce(p.importe,0) * -1
                        else
                            coalesce(p.importe,0)
            ...
            and (p.tipopagoid = 2 and ds.tipodoctoid in (11,12,13,15,16,18) or (de.tipodoctoid in (11,12,13,15,16,18)) )
            and not(p.tipopagoid = 1 and ds.tipodoctoid = 13 and p.formapagoid = 6)
            and not(p.tipopagoid = 1 and ds.tipodoctoid = 12 and p.formapagoid = 6)
            and not(p.tipopagoid = 2 and ds.tipodoctoid = 12 and de.estatusdoctoid = 2 and ds.estatusdoctoid = 2 and p.formapagoid in (6,7))
;