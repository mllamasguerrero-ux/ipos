...
declare variable SUMADESCUENTOCONVALE D_PRECIO;
...
BEGIN
  ...
  /* SELECT COUNT(*) CUENTAREGISTROS,
   ...
   ;       */
    ...
    SUMADESCUENTOCONVALE  = 0;
    DESCUENTO = 0;

   SELECT CUENTAREGISTROS, SUMATOTAL, SUMASALDO, SUMAABONO, SUMACARGO, SUMAIMPORTE, MINFOLIO, MAXFOLIO, SUMASUBTOTAL, SUMAIVA, SUMAIEPS, SUMADESCUENTOCONVALE
   FROM CONSOLIDADO_PORCONSOLIDARSUMA (
    :FECHAINICIAL, :FECHAFINAL , :OMITIRVENTASAFRANQUICIAS, :INCLUIRGASTOS, :MAXIMOMONTO, :OMITIRVALES)
    INTO :CUENTAREGISTROS, :SUMATOTAL, :SUMASALDO, :SUMAABONO, :SUMACARGO, :SUMAIMPORTE, :MINFOLIO, :MAXFOLIO, :SUMASUBTOTAL, :SUMAIVA, :SUMAIEPS, :SUMADESCUENTOCONVALE;


    DESCUENTO = COALESCE(:SUMADESCUENTOCONVALE, 0);
   ...
   (
    ...
    for select id , doctopagoid ,TIPOAPLICACION , APLICADO
        FROM  CONSOLIDADO_PORCONSOLIDAR (:FECHAINICIAL, :FECHAFINAL , :OMITIRVENTASAFRANQUICIAS, :INCLUIRGASTOS, :MAXIMOMONTO, :OMITIRVALES)
