    ...
    BEGIN
     ...
     BEGIN
            ...
            BEGIN
              ...
              BEGIN
                 INSERT INTO DOCTOPAGO ( DOCTOID, FORMAPAGOID, FECHA, FECHAHORA, CORTEID, IMPORTE, IMPORTERECIBIDO, IMPORTECAMBIO, TIPOPAGOID, DOCTOSALIDAID, FECHARECEPCION, FECHAELABORACION, FECHAAPLICADO)
                             VALUES (:DOCTOIDBUFFER, 6, NEW.FECHA, NEW.FECHAHORA,NEW.CORTEID, :SALDOBUFFER,:SALDOBUFFER, 0, 1, NEW.DOCTOSALIDAID, COALESCE(NEW.FECHARECEPCION, CURRENT_DATE), COALESCE(NEW.FECHAELABORACION, CURRENT_DATE), COALESCE(NEW.FECHAAPLICADO, CURRENT_DATE));
              ...
              BEGIN
                   ...
                   INSERT INTO DOCTOPAGO ( DOCTOID, FORMAPAGOID, FECHA, FECHAHORA, CORTEID, IMPORTE, IMPORTERECIBIDO, IMPORTECAMBIO, TIPOPAGOID, DOCTOSALIDAID, FECHARECEPCION, FECHAELABORACION, FECHAAPLICADO)
                             VALUES (:DOCTOIDBUFFER, 6, NEW.FECHA, NEW.FECHAHORA,NEW.CORTEID, :RESTANTEBUFFER,:RESTANTEBUFFER, 0, 1, NEW.DOCTOSALIDAID, COALESCE(NEW.FECHARECEPCION, CURRENT_DATE), COALESCE(NEW.FECHAELABORACION, CURRENT_DATE), COALESCE(NEW.FECHAAPLICADO, CURRENT_DATE));
                    RESTANTEBUFFER = 0;
              END
            END
