...
BEGIN
  ...
  FOR SELECT
    ...
    FACTURAELECTRONICA_XML_CORE(:DOCTOID)
    WHERE :TIPODOCTOID <> 701 or  COALESCE(tipolinea,'') NOT IN('CONCEPTO_ISRRETENIDO','CONCEPTO_IVARETENIDO', 'CONCEPTO_IVA', 'CONCEPTO_IEPS',  'TOTAL_TRASLADOSRETENCIONES', 'COMPROBANTE_ISRRETENIDO', 'COMPROBANTE_IVARETENIDO', 'COMPROBANTE_IVA','COMPROBANTE_IEPS' )
