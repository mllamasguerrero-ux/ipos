...
sum(((case when trans.tipodoctoid in (62,64) then trans.efectivo * cortecalculo.sentidoefectivo else 0 end )) +
((case when trans.tipodoctoid in (62,64) then trans.credito * cortecalculo.sentidocredito else 0 end )) +
((case when trans.tipodoctoid in (62,64) then trans.tarjeta * cortecalculo.sentidotarjeta else 0 end )) +
((case when trans.tipodoctoid in (62,64) then trans.cheque * cortecalculo.sentidocheque else 0 end )) +
((case when trans.tipodoctoid in (62,64) then trans.cambiocheque * cortecalculo.sentidocambiocheque else 0 end )) +
((case when trans.tipodoctoid in (62,64) then trans.vale * cortecalculo.sentidovale else 0 end )) +
((case when trans.tipodoctoid in (62,64) then trans.monedero * cortecalculo.sentidomonedero else 0 end ))  +
((case when trans.tipodoctoid in (62,64) then trans.transferencia * cortecalculo.sentidotransferencia else 0 end )) +
((case when trans.tipodoctoid in (62,64) then trans.indefinido * cortecalculo.sentidoindefinido else 0 end ))) retirosdecaja,


sum(((case when trans.tipodoctoid in (63,65) then trans.efectivo * cortecalculo.sentidoefectivo else 0 end )) +
((case when trans.tipodoctoid in (63,65) then trans.credito * cortecalculo.sentidocredito else 0 end )) +
((case when trans.tipodoctoid in (63,65) then trans.tarjeta * cortecalculo.sentidotarjeta else 0 end )) +
((case when trans.tipodoctoid in (63,65) then trans.cheque * cortecalculo.sentidocheque else 0 end )) +
((case when trans.tipodoctoid in (63,65) then trans.cambiocheque * cortecalculo.sentidocambiocheque else 0 end )) +
((case when trans.tipodoctoid in (63,65) then trans.vale * cortecalculo.sentidovale else 0 end )) +
((case when trans.tipodoctoid in (63,65) then trans.monedero * cortecalculo.sentidomonedero else 0 end ))  +
((case when trans.tipodoctoid in (63,65) then trans.transferencia * cortecalculo.sentidotransferencia else 0 end )) +
((case when trans.tipodoctoid in (63,65) then trans.indefinido * cortecalculo.sentidoindefinido else 0 end ))) gastos
