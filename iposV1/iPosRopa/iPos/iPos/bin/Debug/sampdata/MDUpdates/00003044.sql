create or alter procedure RETIRO_CAJA_CANCEL (
...
BEGIN
   ...
   IF (:TIPODOCTOCANCELARID = 62) THEN
      TIPODOCTOID = 64;
   ...
   UPDATE DOCTO SET CORTEID = :CORTEID WHERE ID = :DOCTOID;
        ...
        /*Echar para atras pagos*/
              SELECT ERRORCODE FROM RETIRO_CAJA_REVERTIR_PAGOS(:DOCTOCANCELARID, :DOCTOID,:VENDEDORID) INTO :ERRORCODE;
        /*Fin echar para atras pagos*/
    
   IF(COALESCE(:ERRORCODE,0) <> 0) THEN
   BEGIN    
     ERRORCODE = :VENDEDORID;
      SUSPEND;
      EXIT;
   END
