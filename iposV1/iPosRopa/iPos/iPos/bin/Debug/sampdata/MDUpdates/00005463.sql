...
BEGIN
  ...
  /* SELECT COUNT(*) CUENTAREGISTROS,
   ...
   FROM CONSOLIDADO_PORCONSOLIDARSUMA (
    :FECHAINICIAL, :FECHAFINAL , :OMITIRVENTASAFRANQUICIAS, :INCLUIRGASTOS, :MAXIMOMONTO, :OMITIRVALES,'N')
   ...
   (
    ...
    BEGIN
        ...
        FROM CONSOLIDADO_PORCONSOLIDARSUMA (
            :FECHAINICIAL, :FECHAFINAL , :OMITIRVENTASAFRANQUICIAS, :INCLUIRGASTOS, :MAXIMOMONTO, 'N','S')
    ...
    for select id , doctopagoid ,TIPOAPLICACION , APLICADO
        FROM  CONSOLIDADO_PORCONSOLIDAR (:FECHAINICIAL, :FECHAFINAL , :OMITIRVENTASAFRANQUICIAS, :INCLUIRGASTOS, :MAXIMOMONTO, 'N','N')
