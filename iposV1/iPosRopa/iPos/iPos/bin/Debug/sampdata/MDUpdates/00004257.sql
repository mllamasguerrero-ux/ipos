...
BEGIN
   ...
   END
    ...
    UPDATE DOCTO SET VENDEDORFINAL = :VENDEDORFINAL, VENDEDORID = :VENDEDORID, CORTEID = :CORTEID, VENDEDOREJECUTIVOID = :VENDEDOREJECUTIVOID WHERE ID = :DOCTOID;
