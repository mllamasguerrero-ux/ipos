...
BEGIN
   ...
   INSERT INTO DOCTO
    ...
    CAJAID, REFERENCIA, REFERENCIAS, SUCURSALTID, ALMACENTID, PROMOCION, ORIGENFISCALID, DOCTOREFID)
   SELECT
    ...
    CAJAID, :REFERENCIA, :REFERENCIAS, SUCURSALTID, ALMACENTID, 'N', ORIGENFISCALID , ID
