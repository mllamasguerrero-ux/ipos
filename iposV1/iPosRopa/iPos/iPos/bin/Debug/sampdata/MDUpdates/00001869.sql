...
BEGIN
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF(:tipodoctoid IN (21,25,12,31) AND OLD.registroprocesosalida = 'S' ) THEN
         BEGIN
            ...
            BEGIN
                ...
                IF((COALESCE(:sumaenprocesodesalidaalmacen,0) - COALESCE(NEW.CANTIDAD,0)) > 0) THEN
                BEGIN
   ...
   BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                VALUES('S',NEW.claveprod,new.productoid, :almacenid ,(COALESCE(NEW.CANTIDAD,0) - COALESCE(OLD.CANTIDAD,0)));
            END
