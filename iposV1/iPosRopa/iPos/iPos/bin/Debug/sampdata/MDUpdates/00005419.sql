...
BEGIN
  ...
  /* SELECT COUNT(*) CUENTAREGISTROS,
   ...
   FROM CONSOLIDADO_PORCONSOLIDARSUMA (
    :FECHAINICIAL, :FECHAFINAL , :OMITIRVENTASAFRANQUICIAS, :INCLUIRGASTOS, :MAXIMOMONTO)
   ...
   (
    ...
    for select id , doctopagoid ,TIPOAPLICACION , APLICADO
        FROM  CONSOLIDADO_PORCONSOLIDAR (:FECHAINICIAL, :FECHAFINAL , :OMITIRVENTASAFRANQUICIAS, :INCLUIRGASTOS, :MAXIMOMONTO)
