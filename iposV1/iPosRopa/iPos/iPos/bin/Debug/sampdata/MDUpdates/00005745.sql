...
BEGIN
   ...
   IF (:TIPODOCTOCANCELARID NOT IN (11,16, 111, 14, 41,1011)) THEN
   BEGIN
      ERRORCODE = 1008;
      SUSPEND;
      EXIT;
   ...
   IF (:TIPODOCTOCANCELARID = 11) THEN
    ...
    ELSE if (:TIPODOCTOCANCELARID = 111) then
      TIPODOCTOID = 113; 
   else IF (:TIPODOCTOCANCELARID = 14) THEN
      TIPODOCTOID = 15;
   else IF (:TIPODOCTOCANCELARID = 41) THEN
      TIPODOCTOID = 43; 
    ELSE if (:TIPODOCTOCANCELARID = 1011) then
      TIPODOCTOID = 1013;
   -- Agrega el DOCTO.
   INSERT INTO DOCTO
   ...
   BEGIN
      ...
      FROM MOVTO_INSERT (
         ...
         :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00 ,:DOCTOCANCELARID,NULL,NULL,NULL,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3 , NULL ,:LOTEIMPORTADO , 'N','N'
   ...
   END
        ...
        IF (:TIPODOCTOCANCELARID not in (111, 14,41)) THEN
        BEGIN
