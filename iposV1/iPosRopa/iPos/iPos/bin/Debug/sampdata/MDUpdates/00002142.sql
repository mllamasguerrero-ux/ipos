...
BEGIN
    ...
    (
        ...
        SELECT
            ...
            (SUM((COALESCE(M.CANTIDAD,0) - COALESCE(PKIT.existencia,0)) * COALESCE(K.cantidadparte,0)) - COALESCE(PPARTE.existencia,0) ) FALTANTE
             ...
             FROM MOVTO M
               ...
               HAVING   (SUM((COALESCE(M.CANTIDAD,0) - COALESCE(PKIT.existencia,0)) * COALESCE(K.cantidadparte,0)) - COALESCE(PPARTE.existencia,0) ) > 0
