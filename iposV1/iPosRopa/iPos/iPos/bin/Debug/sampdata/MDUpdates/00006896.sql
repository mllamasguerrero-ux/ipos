...
BEGIN
   ...
   impuesto = cast(cast(((cantidadsurtida * preciomanual) * ( 1.00 + (TASAIEPS / 100.00))) as d_precio) * (TASAIVA / 100.00) as d_precio) +  cast((cantidadsurtida * preciomanual) * (tasaieps / 100.00) as d_precio),
   total =    cast(cast(((cantidadsurtida * preciomanual) * ( 1.00 + (TASAIEPS / 100.00))) as d_precio) * (TASAIVA / 100.00) as d_precio) +  cast((cantidadsurtida * preciomanual) * (tasaieps / 100.00) as d_precio)
   ...
   update docto set tipodoctoid = 11 , subtipodoctoid = 16,
                    ...
                    corteid = :corteid , almacenid = coalesce(:almacenid, almacenid) where id = :doctoid;
