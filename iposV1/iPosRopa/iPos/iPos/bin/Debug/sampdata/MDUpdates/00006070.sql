...
BEGIN
     ...
     SELECT FECHACORTE, SALDOREAL ,FONDODINAMICOFINAL
            FROM CORTE WHERE ID = :CORTEID  INTO :FECHACORTE, :SALDOREALANTERIOR, :FONDODINAMICOFINAL;
    ...
    :TIPODECAMBIO ,:P1000 ,:P500 ,:P200 ,:P100 ,:P50 ,:P20 ,
            ...
            :SALDOFINAL ,
            :CHEQUES ,:VALES ,:TARJETA ,:CREDITO ,:MONEDERO ,:TRANSFERENCIA ,:INDEFINIDO ,
            :TIPOMONTOBILLETESID , :DOCTOID, :DEPOSITO ,:DEPTERCERO, :FONDODINAMICOFINAL)
INTO 
