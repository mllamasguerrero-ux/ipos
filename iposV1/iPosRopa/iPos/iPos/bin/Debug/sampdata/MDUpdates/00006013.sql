...
declare variable MOVTOIDCOMPRA D_FK;
BEGIN
   ...
   SELECT ALMACENID, SUCURSALID, CAJAID, REFERENCIA
   FROM DOCTO
   WHERE ID = :COMPRADOCTOID
   INTO :ALMACENID, :SUCURSALID, :CAJAID, :REFERENCIA;
   ...
   BEGIN
      ...
      FROM MOVTO_INSERT(:DOCTOID, 0, :ALMACENID, :SUCURSALID, :TIPODOCTOID, 0, 0, :PERSONAID, :VENDEDORID, 1, 0,
         ...
         :FECHA, :FECHA, 0.00,:COMPRADOCTOID,NULL,NULL,NULL, :MOVTOIDCOMPRA, :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3, NULL,:LOTEIMPORTADO, 'N','N')
