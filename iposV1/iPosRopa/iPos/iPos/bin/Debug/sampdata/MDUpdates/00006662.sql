...
BEGIN
  ...
  FOR SELECT
    ...
    WHERE (:TIPODOCTOID NOT IN (701, 21,22) or  COALESCE(tipolinea,'') NOT IN('CONCEPTO_PARTE', 'CONCEPTO_ISRRETENIDO','CONCEPTO_IVARETENIDO', 'CONCEPTO_IVA', 'CONCEPTO_IEPS',  'TOTAL_TRASLADOSRETENCIONES', 'COMPROBANTE_ISRRETENIDO', 'COMPROBANTE_IVARETENIDO', 'COMPROBANTE_IVA','COMPROBANTE_IEPS' ))
     INTO
    :ID    ,
    :TIPOLINEA    ,
    :PADRELINEA    ,
