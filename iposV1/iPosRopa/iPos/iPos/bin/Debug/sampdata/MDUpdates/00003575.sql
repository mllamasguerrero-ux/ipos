...
SELECT        DOCTO.ID AS DOCTOID,
              ...
              CASE WHEN MOVTO.TASAIMPUESTO IS NULL
                         ...
                         round(MOVTO.total * coalesce(movto.cantidadsurtida,0)/coalesce(movto.cantidad,0),2) AS TOTAL,
                         round(MOVTO.iva * coalesce(movto.cantidadsurtida,0)/coalesce(movto.cantidad,0),2) AS IVA,
                         round(MOVTO.ieps * coalesce(movto.cantidadsurtida,0)/coalesce(movto.cantidad,0),2) AS IEPS,
                         round(MOVTO.total * coalesce(movto.cantidadsurtida,0)/coalesce(movto.cantidad,0),2) AS IMPORTE,
                         round(MOVTO.subtotal * coalesce(movto.cantidadsurtida,0)/coalesce(movto.cantidad,0),2) AS SUBTOTAL, 
                         round(MOVTO.impuesto * coalesce(movto.cantidadsurtida,0)/coalesce(movto.cantidad,0),2) AS IMPUESTO,
                         '' AS TITULOSTOTALES, 
                         MOVTO.DESCUENTO,
