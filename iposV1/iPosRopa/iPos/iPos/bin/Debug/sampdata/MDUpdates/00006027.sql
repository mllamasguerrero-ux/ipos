  ...
  FOR SELECT
    ...
    BEGIN
        ...
        BEGIN
            ...
            SELECT COUNT(*) FROM TASASIEPS WHERE TASA = :ieps_x_porc AND COALESCE(GPOIMP,'') = COALESCE(:GPOIMP,'') INTO :CUENTAEXISTENTES;
            ...
            BEGIN
                UPDATE TASASIEPS SET CANTIDADREG = CANTIDADREG + 1,
                                  ...
                                  WHERE TASA = :IEPS_X_PORC AND coalesce(GPOIMP,'') = COALESCE(:GPOIMP,'');
            END
