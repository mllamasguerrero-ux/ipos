...
--Initialitation
   ...
   FOR 
    select PRODUCTOID, LOTE, FECHAVENCE, CANTIDADSURTIDA, NOMBRE, DESCRIPCION1, ID, COSTOPRECIOMANEJADO  from (
   ...
   BEGIN
    ...
    BEGIN
        ...
        select COALESCE(sum(cantidad),0) from inventariokitdesg_proc
