...
BEGIN
   ...
   SELECT ESTATUSDOCTOID, TIPODOCTOID, SUBTIPODOCTOID  , FACTCONSID , DEVCONSID
   FROM DOCTO
   WHERE ID = :DOCTOCANCELARID
   INTO :ESTATUSDOCTOID, :TIPODOCTOCANCELARID, :SUBTIPODOCTOID, :DOCTOFACTCONSID, :DOCTODEVCONSID;
   ...
   -- Si no esta vigente: Salir.
   IF (COALESCE(:DOCTOFACTCONSID,0) <> 0 or COALESCE(:DOCTODEVCONSID,0) <> 0 ) THEN
   BEGIN
      ERRORCODE = 5009;
      SUSPEND;
      EXIT;
