...
BEGIN
   ...
   FOR SELECT
      ...
      D.PERSONAID,
      D.VENDEDORID  , M.DESCRIPCION1, M.DESCRIPCION2, M.DESCRIPCION3
   FROM MOVTO M
     LEFT JOIN DOCTO D
       ON D.ID = M.DOCTOID
   ...
   INTO
      :PRODUCTOID, :LOTE, :FECHAVENCE, :CANTIDAD, :COSTO, :TIPODIFERENCIAINVENTARIOID, :PERSONAID, :VENDEDORID , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3
   DO
   BEGIN
      COSTO = 0;
