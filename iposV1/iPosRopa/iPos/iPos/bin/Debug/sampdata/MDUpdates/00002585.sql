...
BEGIN
   ...
   END
        ...
        FOR SELECT
            ...
            CASE WHEN (COALESCE(PRODUCTO.existencia,0) - COALESCE(PRODUCTO.enprocesodesalida,0)) >= MOVTO.cantidad THEN MOVTO.cantidad ELSE (COALESCE(PRODUCTO.existencia,0) - COALESCE(PRODUCTO.enprocesodesalida,0)) END AS CANTIDAD ,
