create or alter procedure MOVTO_INSERT (
    ...
    P_MOVTOID D_FK,
    P_MOVTOREFID D_FK,
    DESCRIPCION1 D_STDTEXT_LARGE,
    DESCRIPCION2 D_STDTEXT_LARGE,
    DESCRIPCION3 D_STDTEXT_LARGE,
...
declare variable MOVTOLISTAPRECIOID D_FK;
BEGIN
    ERRORCODE = 0;
   ...
   BEGIN
    ...
    select clave, ESKIT from producto where id = :productoid into :PRODUCTOCLAVE, :ESKIT;
      ...
      BEGIN
         ...
         IF (:TIPODOCTOID in (24, 26, 331, 42, 901, 902, 341 )) THEN
         BEGIN
               PRECIONUEVO = :PRECIO;
               PRECIOLISTA = :PRECIO;
         END
         ...
         -- Para tipo 21=Venta
         IF ( :TIPODOCTOID  in (21, 31,25,22, 321,821) AND COALESCE(:SUBTIPODOCTOID,0) NOT IN (13) /* y no es una nc x rebaja*/) THEN
         BEGIN
         ...
         BEGIN
                ...
                BEGIN   
                    ...
                    IF(COALESCE(:SUBTIPODOCTOID,0) <> 13) THEN
                    BEGIN
                        SELECT ERRORCODE
   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
                    ...
                    NUEVOSENPROCESOPARTES =  :ENPROCESOPARTES + :CANTIDAD - (COALESCE(:EXISTENCIAACTUAL,0) - COALESCE(:ENPROCESODESALIDA,0));
      ...
      BEGIN
        ...
        -- otras salidas
         ...
         IF (:TIPODOCTOID IN ( 42, 331,341)) THEN
         BEGIN
               PRECIONUEVO = :PRECIO;
               PRECIOLISTA = :PRECIO;
         END
         ...
         SET
            ...
            LISTAPRECIOID = :MOVTOLISTAPRECIOID
         WHERE ID = :MOVTOID;
