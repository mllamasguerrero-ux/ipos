      ...
      BEGIN
         ...
         BEGIN
            ...
            BEGIN
               ...
               IF((:TIPODOCTOID IN (/*21,*/25,12,31, 121) or (:TIPODOCTOID = 21 AND COALESCE(:SUBTIPODOCTOID ,0)<> 8 ) ) AND
         ...
         BEGIN
            ...
            BEGIN
                ...
                IF( COALESCE(:PRECIOYAVALIDADO,'N') = 'N' AND  COALESCE(:SUBTIPODOCTOID,0) <> 15 AND COALESCE(:SUBTIPODOCTOID,0) <> 22) THEN  /*Si no es una venta movil*/
                BEGIN
