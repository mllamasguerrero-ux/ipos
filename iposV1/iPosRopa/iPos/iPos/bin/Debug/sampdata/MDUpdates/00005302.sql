...
declare variable INGRESOEFECTIVOSOLOTRASLADO D_IMPORTE;
declare variable INGRESOEFECTIVOVENTATRASLADO D_IMPORTE;
...
BEGIN
   ...
   select FECHACORTE, HAYCORTEACTIVO, CORTEID
    ...
    SELECT    EGRESOEFECTIVO , INGRESOEFECTIVO , EGRESOCHEQUE ,
            ...
            INGRESOEFECTIVOSOLOTRASLADO, INGRESOEFECTIVOVENTATRASLADO, RETIRO
     FROM CORTE
     WHERE ID = :CORTEID
     ...
     TOTALCAJA = COALESCE(:INGRESOEFECTIVO,0) -  COALESCE(:EGRESOEFECTIVO,0) +
                  COALESCE(:RETIRO_CAJA,0) +  COALESCE(:PAGOPROVEEDORES,0) + COALESCE(:RETIRO,0) -
                  :INGRESOEFECTIVOSOLOTRASLADO - :INGRESOEFECTIVOVENTATRASLADO;
