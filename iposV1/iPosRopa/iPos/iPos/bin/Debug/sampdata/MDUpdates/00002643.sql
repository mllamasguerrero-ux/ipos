CREATE OR ALTER VIEW LOTESINVENTARIOVIEW_CAMBIOLOTES(
    PRODUCTOID,
    PRODUCTO,
    LOTE,
    CANTIDAD,
...
FROM            inventario LEFT OUTER JOIN
                         ...
                         parametro on 1 = 1
    group by producto.id,     producto.clave, inventario.lote, inventario.fechavence ,PARAMETRO.cortacaducidad , inventario.almacenid
