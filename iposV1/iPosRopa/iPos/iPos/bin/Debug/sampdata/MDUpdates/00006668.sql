...
BEGIN
  ...
  FOR SELECT
    ...
    WHERE
        ...
        AND  (:TIPODOCTOID NOT IN (21,22) or  COALESCE(tipolinea,'') NOT IN(  'TOTAL_TRASLADOSRETENCIONES', 'COMPROBANTE_ISRRETENIDO', 'COMPROBANTE_IVARETENIDO', 'COMPROBANTE_IVA','COMPROBANTE_IEPS' ))
