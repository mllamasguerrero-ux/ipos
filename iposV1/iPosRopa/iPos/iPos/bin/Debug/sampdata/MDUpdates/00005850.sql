CREATE TABLE COMISION_CALC_V2 (
    ...
    COMISION              D_PORCENTAJE /* D_PORCENTAJE = NUMERIC(18,2) DEFAULT 0.00 */,
    CLIENTEPORCOME        D_BOOLCN /* D_BOOLCN = CHAR(1) DEFAULT 'N' NOT NULL CHECK (VALUE IN ('S', 'N')) */
);
