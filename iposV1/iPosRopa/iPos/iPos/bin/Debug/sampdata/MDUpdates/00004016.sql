...
BEGIN
   SELECT
      ...
      PARAMETRO.aplicarmayoreoporlinea, /*D.tipomayoreoid ,*/ D.ID , M.PRODUCTOID
   FROM MOVTO M
      LEFT JOIN DOCTO D
         ON D.ID = M.DOCTOID
   ...
   WHERE
      M.ID = :MOVTOID
   INTO
      :ESTATUSDOCTOID, :ESTATUSMOVTOID, :PROMOCION, :ESVENDEDORMOVIL, :TIPODOCTOID, :APLICARMAYOREOPORLINEA, /*:TIPOMAYOREOID,*/ :DOCTOID, :PRODUCTOID;
