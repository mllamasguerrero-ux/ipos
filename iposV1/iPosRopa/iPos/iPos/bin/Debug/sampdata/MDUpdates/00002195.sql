...
BEGIN
   ...
   FOR SELECT
    ...
    FROM  KITDEFINICION INNER JOIN PRODUCTO ON PRODUCTO.ID = KITDEFINICION.productoparteid
   ...
   END
    ...
    FROM  KITDEFINICION LEFT JOIN PRODUCTOALMACEN ON PRODUCTOALMACEN.PRODUCTOID = KITDEFINICION.productoparteid AND PRODUCTOALMACEN.ALMACENID = :ALMACENID
