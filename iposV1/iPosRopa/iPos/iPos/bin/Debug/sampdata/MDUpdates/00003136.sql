create or alter procedure VALIDAR_PRECIOS_DOCTO (
    ...
    VENDEDORID D_FK)
returns (
    MOVTOIDSNOVALIDOS blob sub_type 0 segment size 80,
    VALIDO D_BOOLCS,
...
BEGIN
        ...
        FOR SELECT
            ...
            DOCTO.tipodoctoid, DOCTO.SUBTIPODOCTOID , docto.PAGOCONTARJETA, docto.TIPOMAYOREOID
            ...
            :TIPODOCTOID, :SUBTIPODOCTOID , :PAGOCONTARJETA, :TIPOMAYOREOID
        DO
        BEGIN
            ...
            SELECT PRECIO, ERRORCODE FROM GET_PRODUCTO_PRECIO_DOCTO (
                ...
                :SUCURSALID,
                NULL,
                :COSTOPROMEDIO, :PAGOCONTARJETA, :TIPOMAYOREOID) INTO :PRECIOSTD, :ERRORCODE;
