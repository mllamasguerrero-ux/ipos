...
BEGIN
   ...
   FOR
      SELECT
        ...
        detailtable.TASAIEPS_,
        detailtable.MONTOIEPS_,
        ...
        (
                 SELECT 'CORTE SUMARIZADO' AS TITULO, sucursal.clave AS SUCURSAL,
                        ...
                        SUM(CORTE.NUMEROTICKETS) AS NUMERO_TICKETS, 
                         ...
                         SUM(CASE WHEN (corte.subtotalsiniva + corte.subtotalconiva + (corte.montoimpuesto * -1)) IS NOT NULL THEN (corte.subtotalsiniva + corte.subtotalconiva  + (corte.montoimpuesto * -1)) ELSE INGRESO END) AS TOTAL,
