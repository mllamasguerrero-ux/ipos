...
basico.doctoimporteendolar ,
 ...
 MIN(coalesce(MKITREF.id,0)) KITMOVTOID,
 MKITREF.productoid KITPRODUCTOID,
 ...
 SUM(COALESCE(MKITREF.cantidad,0)) KITCANTIDAD
...
left join movto on
 ...
 left join MOVTO MKITREF ON MKITREF.doctoid = COALESCE(basico.doctokitrefid,0) AND MKITREF.movtorefid = MOVTO.ID --and MKITREF.TIPODOCTOID = 505
