...
BEGIN
   ...
   BEGIN
      ...
      FROM MOVTO_INSERT (
         ...
         :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00 ,:DOCTOCANCELARID,NULL,NULL,NULL,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3 , NULL ,:LOTEIMPORTADO
