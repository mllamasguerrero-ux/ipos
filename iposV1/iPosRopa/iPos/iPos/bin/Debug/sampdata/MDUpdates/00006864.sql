...
BEGIN
   ...
   BEGIN
      ...
      INTO :PRECIO, :ESPROMOCION, :PROMOCIONID, :PROMOCIONDESGLOSE, :MONEDEROABONO, :TIPOMAYOREOLINEAIDAPLICADO, :ERRORCODE;
   ...
   BEGIN
      ...
      BEGIN      
        SELECT SPRECIO1, SPRECIO2, SPRECIO3, SPRECIO4, SPRECIO5 , COSTOPROMEDIO, COSTOULTIMO, COSTOREPOSICION
         FROM PRODUCTO
        WHERE ID = :PRODUCTOID
        INTO :PRECIO1, :PRECIO2, :PRECIO3, :PRECIO4, :PRECIO5, :COSTOPROMEDIO, :COSTOULTIMO, :COSTOREPOSICION;
      END
      ELSE BEGIN
        SELECT PRECIO1, PRECIO2, PRECIO3, PRECIO4, PRECIO5, COSTOPROMEDIO, COSTOULTIMO, COSTOREPOSICION
         FROM PRODUCTO
        WHERE ID = :PRODUCTOID
        INTO :PRECIO1, :PRECIO2, :PRECIO3, :PRECIO4, :PRECIO5, :COSTOPROMEDIO, :COSTOULTIMO, :COSTOREPOSICION;
      END
      ...
      ELSE IF (:LISTAPRECIO = '0') THEN
         PRECIO = 0;        
      ELSE IF (:LISTAPRECIO = 'R') THEN
         PRECIO = :COSTOREPOSICION;
      ELSE IF (:LISTAPRECIO = 'U') THEN
         PRECIO = COALESCE(:COSTOULTIMO, :COSTOREPOSICION);
      ELSE IF (:LISTAPRECIO = 'P') THEN
         PRECIO = COALESCE(:COSTOPROMEDIO, :COSTOREPOSICION);
      ELSE 
         PRECIO = PRECIO4;
   END
