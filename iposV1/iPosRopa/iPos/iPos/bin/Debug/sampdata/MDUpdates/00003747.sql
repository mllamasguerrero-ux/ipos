...
BEGIN
   ...
   FOR SELECT
      ...
      TIPODIFERENCIAINVENTARIOID  , CANTIDADDEFACTURA, CANTIDADDEREMISION, CANTIDADDEINDEFINIDO , MOVTOREFID , DESCRIPCION1, DESCRIPCION2, DESCRIPCION3
   FROM MOVTO
   ...
   BEGIN
      ...
      FROM MOVTO_INSERT (
         ...
         :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00 ,:DOCTOEDITARID,NULL,NULL,NULL,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3, NULL
