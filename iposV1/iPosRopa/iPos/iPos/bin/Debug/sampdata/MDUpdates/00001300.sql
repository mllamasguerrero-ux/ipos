           ...
           2 cargoabono ,
            ...
            case
                when p.formapagoid in (1,2,3,5,14,15,16) then
                    ...
                    case when p.formapagoid = 1 and ds.tipodoctoid = 22 then
                      0
            ...
            case when p.formapagoid in (6,7,8,9,10,11,12,13) then
                ...
                when p.formapagoid = 1 and ds.tipodoctoid = 22 then
                        case when p.tipopagoid = 2 then
                            coalesce(p.importe,0) * -1
                        else
                            coalesce(p.importe,0)
            ...
            and (p.tipopagoid = 2 and ds.tipodoctoid in (21,22,23,24,25,26) or (de.tipodoctoid in (21,22,23,24,25,26)) )
