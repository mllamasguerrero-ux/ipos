...
BEGIN
    ...
    SELECT  ALMACENID, SUCURSALID, TIPODOCTOID, PERSONAID , REFERENCIA, REFERENCIAS ,
            ALMACENTID, SUCURSALTID  , ESTATUSDOCTOID, VENDEDORID , FECHA, ORIGENFISCALID , CAJAID , PAGOCONTARJETA  , COMISIONPAGOTARJETA , PAGOACREDITO, ESSERVDOMICILIO, RUTAEMBARQUEID
    from DOCTO
    where id = :doctoid
