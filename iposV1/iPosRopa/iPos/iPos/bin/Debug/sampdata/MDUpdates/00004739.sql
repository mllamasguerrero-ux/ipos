...
coalesce((dpe.importe *
          (CASE WHEN ((dpe.TIPOPAGOID = 1 AND dpe.FORMAPAGOID IN (1,2,3,4,5,6,9,14,18)) or (dpe.TIPOPAGOID = 2 AND dpe.FORMAPAGOID IN (7,19)))  THEN 1
                when ((dpe.TIPOPAGOID = 1 AND dpe.FORMAPAGOID IN (7,19)) or (dpe.TIPOPAGOID = 2 AND dpe.FORMAPAGOID IN (6,8, 18))) THEN -1
                ELSE 0 END)
          ),0)
...
coalesce((dps.importe *
           (CASE WHEN ((dps.TIPOPAGOID = 2 AND dps.FORMAPAGOID IN (1,2,3,4,5,7,14, 19)) or (dps.TIPOPAGOID = 1 AND dps.FORMAPAGOID IN (6,18)))  THEN 1
                when ((dps.TIPOPAGOID = 1 AND dps.FORMAPAGOID IN (7,19)) or (dps.TIPOPAGOID = 2 AND dps.FORMAPAGOID IN (6,18)))  THEN -1
                ELSE 0 END)
          ),0)
...
coalesce((dpe.importe *
          (CASE WHEN ((dpe.TIPOPAGOID = 1 AND dpe.FORMAPAGOID IN (1,2,3,4,5,6,14,18)) or (dpe.TIPOPAGOID = 2 AND dpe.FORMAPAGOID IN (7,19)))  THEN 1
                when ((dpe.TIPOPAGOID = 1 AND dpe.FORMAPAGOID IN (7, 19)) or (dpe.TIPOPAGOID = 2 AND dpe.FORMAPAGOID IN (6,18))) THEN -1
                ELSE 0 END)
          ),0)
...
coalesce((dps.importe *
           (CASE WHEN ((dps.TIPOPAGOID = 2 AND dps.FORMAPAGOID IN (1,2,3,4,5,7,14, 19)) or (dps.TIPOPAGOID = 1 AND dps.FORMAPAGOID IN (6,9, 18)))  THEN 1
                when ((dps.TIPOPAGOID = 1 AND dps.FORMAPAGOID IN (7, 19)) or (dps.TIPOPAGOID = 2 AND dps.FORMAPAGOID IN (6,8, 18)))  THEN -1
                ELSE 0 END)
          ),0)
