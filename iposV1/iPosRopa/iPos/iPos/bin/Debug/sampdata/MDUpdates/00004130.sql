...
BEGIN
  ...
  ERRORCODE = 0;
   ...
   (SELECT MOVTO.ID FROM MOVTO
    ...
    update inventario set lote = null, fechavence = null
    where (lote is not null or fechavence is not null)  and productoid in (select id from producto where manejalote = 'N');
