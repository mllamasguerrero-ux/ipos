   ...
   BEGIN
      ...
      SUCURSALTID = 0;
            ...
            FROM MOVTO_INSERT(:DOCTOIDPARTE, 0, :ALMACENTID, :SUCURSALID, :TIPODOCTOIDPARTE, 0, 0, :PERSONAID, :VENDEDORID, 1, 0,
               ...
               :REFERENCIA, '', :COSTO, :SUCURSALTID, :ALMACENID, 'N', NULL, CURRENT_DATE, CURRENT_DATE, 0.00,:KITDOCTOID,NULL,NULL,NULL,NULL, :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3, NULL)
