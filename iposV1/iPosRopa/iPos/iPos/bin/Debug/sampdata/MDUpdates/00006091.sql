...
BEGIN
   ...
   BEGIN
        ...
        RESULTADOEXACTO = COALESCE(:RESULTADOEXACTO, 0)  + cast(( cast((COALESCE(:MOVTOTOTAL,0.00) / COALESCE(:DOCTOTOTAL,0.00)) as d_precio) * COALESCE(:IMPORTEVALE,0.00)) as d_precio);
