...
BEGIN
   ...
   FROM
  CONSOLIDADO_PORCONSOLIDAR(:FECHAINICIAL, :FECHAFINAL, :OMITIRVENTASAFRANQUICIAS, :INCLUIRGASTOS, :MAXIMOMONTO, :OMITIRVALES, :SUMACOMPLETAVENTAS, :GRUPOUSUARIOID, :OMITIRCLIENTESRFC)
