CREATE OR ALTER TRIGGER DOCTO_AI0_UTILIDAD FOR DOCTO
...
begin
  ...
  IF(NEW.estatusdoctoid = 1 AND NEW.TIPODOCTOID IN (21,22,23,24,25,26)) THEN
  BEGIN
         ...
         BEGIN
            ...
            ANIO = EXTRACT (YEAR FROM NEW.FECHA);
            MES = EXTRACT (MONTH FROM NEW.FECHA);
