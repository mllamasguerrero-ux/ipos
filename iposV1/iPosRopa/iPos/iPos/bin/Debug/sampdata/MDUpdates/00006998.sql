...
BEGIN
  ...
  -- FALTA COMPLETAR
   ...
   BEGIN
        ...
        INSERT INTO GUIA
        (ENCARGADOGUIAID , ESTADOGUIAID, cajeroid,  CORTEID, FECHA, FECHAHORA, NOTA, TIPOENTREGAID, GUIAPAQUETERIA,VEHICULOID , FECHAESTIMADAREC ,HORAESTIMADREC, NOTARECEPCION)
        VALUES
        (:ENCARGADOGUIAID,  :ESTADOGUIAID  , :CAJEROID, :CORTEID2,  :FECHA,  :FECHAHORA, :NOTA, :TIPOENTREGAID, :GUIAPAQUETERIA,:VEHICULOID , :FECHAESTIMADAREC ,:HORAESTIMADREC, :NOTARECEPCION)
  ...
  /* -- si es entrega directa el estado de guia detalle sera recibido de inicio
   ...
   UPDATE DOCTO SET ESTADOGUIAID = :ESTADOGUIAID,
    ...
    BEGIN             
          SELECT PERSONA.dias FROM DOCTO INNER JOIN PERSONA ON PERSONA.ID = DOCTO.personaid WHERE  DOCTO.ID = :DOCTOID INTO :DIAS;
