create or alter procedure REP_VENTA_CONIEPS_DETALLE_EXP (
    FECHAINI D_FECHA,
    FECHAFIN D_FECHA,
    TIPODOCTOID D_FK,
    ALMACENID D_FK,
...
BEGIN
  ...
  FOR SELECT TASA
    ...
    INTO :IEPS_X_PORC --, :CURR_ALMACENID, :CURR_VENDEDORID
    DO
    BEGIN
   ...
   WHERE (d.TIPODOCTOID = :TIPODOCTOID  OR (:TIPODOCTOID = -21 AND d.TIPODOCTOID IN (21,31,22,81))
          OR (:TIPODOCTOID = -31 AND d.TIPODOCTOID IN (31,81)) OR (:TIPODOCTOID = -11 AND d.TIPODOCTOID IN (11, 41, 12)) )
     AND (D.tipodoctoid <> 21 or COALESCE(D.subtipodoctoid, 0) NOT IN (7,8) )
   ...
   BEGIN
    ...
    BEGIN
       ...
       BEGIN
        ...
        BEGIN     
            ...
            WHERE (MOVTO.ID = :MOVTOID or (DOCTOID = :DOCTOREFKITID  AND MOVTOREFID = :MOVTOID))
                AND MOVTO.TASAIEPS = :IEPS_01_PORC
            INTO :IEPS_X_IMPORTE;
        ...
        BEGIN     
            ...
            FROM MOVTO
            WHERE  (MOVTO.ID = :MOVTOID or (DOCTOID = :DOCTOREFKITID  AND MOVTOREFID = :MOVTOID))
            AND MOVTO.TASAIEPS = :IEPS_02_PORC
            INTO :IEPS_X_IMPORTE;
        ...
        BEGIN     
            ...
            FROM MOVTO
            WHERE (MOVTO.ID = :MOVTOID or (DOCTOID = :DOCTOREFKITID  AND MOVTOREFID = :MOVTOID))
            AND MOVTO.TASAIEPS = :IEPS_03_PORC
            INTO :IEPS_X_IMPORTE;
        ...
        BEGIN     
            ...
            FROM MOVTO
            WHERE (MOVTO.ID = :MOVTOID or (DOCTOID = :DOCTOREFKITID  AND MOVTOREFID = :MOVTOID))
            AND MOVTO.TASAIEPS = :IEPS_04_PORC
            INTO :IEPS_X_IMPORTE;
        ...
        BEGIN     
            ...
            FROM MOVTO
            WHERE (MOVTO.ID = :MOVTOID or (DOCTOID = :DOCTOREFKITID  AND MOVTOREFID = :MOVTOID))
            AND MOVTO.TASAIEPS = :IEPS_05_PORC
            INTO :IEPS_X_IMPORTE;
        ...
        BEGIN     
            ...
            FROM MOVTO
            WHERE (MOVTO.ID = :MOVTOID or (DOCTOID = :DOCTOREFKITID  AND MOVTOREFID = :MOVTOID))
            AND MOVTO.TASAIEPS = :IEPS_06_PORC
            INTO :IEPS_X_IMPORTE;
        ...
        BEGIN     
            ...
            FROM MOVTO
            WHERE (MOVTO.ID = :MOVTOID or (DOCTOID = :DOCTOREFKITID  AND MOVTOREFID = :MOVTOID))
            AND MOVTO.TASAIEPS = :IEPS_08_PORC
            INTO :IEPS_X_IMPORTE;
        ...
        BEGIN     
            ...
            FROM MOVTO
            WHERE (MOVTO.ID = :MOVTOID or (DOCTOID = :DOCTOREFKITID  AND MOVTOREFID = :MOVTOID))
            AND MOVTO.TASAIEPS = :IEPS_09_PORC
            INTO :IEPS_X_IMPORTE;
        ...
        BEGIN     
            ...
            FROM MOVTO
            WHERE (MOVTO.ID = :MOVTOID or (DOCTOID = :DOCTOREFKITID  AND MOVTOREFID = :MOVTOID))
            AND MOVTO.TASAIEPS = :IEPS_10_PORC
            INTO :IEPS_X_IMPORTE;
     ...
     BEGIN
            ...
            IF(COALESCE(:IEPS_01_PORC,-1) <> -1 AND :IEPS_01_PORC = COALESCE(:TASAIEPSDETALLE,-1)) THEN
            BEGIN
                IEPS_01_IMPORTE = COALESCE(:IEPS,0);
            END   
            
            IF(COALESCE(:IEPS_02_PORC,-1) <> -1 AND :IEPS_02_PORC = COALESCE(:TASAIEPSDETALLE,-1)) THEN
            BEGIN
                IEPS_02_IMPORTE = COALESCE(:IEPS,0);
            END
               
            IF(COALESCE(:IEPS_03_PORC,-1) <> -1 AND :IEPS_03_PORC = COALESCE(:TASAIEPSDETALLE,-1)) THEN
            BEGIN
                IEPS_03_IMPORTE = COALESCE(:IEPS,0);
            END   
            
            IF(COALESCE(:IEPS_04_PORC,-1) <> -1 AND :IEPS_04_PORC = COALESCE(:TASAIEPSDETALLE,-1)) THEN
            BEGIN
                IEPS_04_IMPORTE = COALESCE(:IEPS,0);
            END   

            IF(COALESCE(:IEPS_05_PORC,-1) <> -1 AND :IEPS_05_PORC = COALESCE(:TASAIEPSDETALLE,-1)) THEN
            BEGIN
                IEPS_05_IMPORTE = COALESCE(:IEPS,0);
            END   
            
            IF(COALESCE(:IEPS_06_PORC,-1) <> -1 AND :IEPS_06_PORC = COALESCE(:TASAIEPSDETALLE,-1)) THEN
            BEGIN
                IEPS_06_IMPORTE = COALESCE(:IEPS,0);
            END    
            
            IF(COALESCE(:IEPS_07_PORC,-1) <> -1 AND :IEPS_07_PORC = COALESCE(:TASAIEPSDETALLE,-1)) THEN
            BEGIN
                IEPS_07_IMPORTE = COALESCE(:IEPS,0);
            END   
            
            IF(COALESCE(:IEPS_08_PORC,-1) <> -1 AND :IEPS_08_PORC = COALESCE(:TASAIEPSDETALLE,-1)) THEN
            BEGIN
                IEPS_08_IMPORTE = COALESCE(:IEPS,0);
            END   
            
            IF(COALESCE(:IEPS_09_PORC,-1) <> -1 AND :IEPS_09_PORC = COALESCE(:TASAIEPSDETALLE,-1)) THEN
            BEGIN
                IEPS_09_IMPORTE = COALESCE(:IEPS,0);
            END   
            
            IF(COALESCE(:IEPS_10_PORC,-1) <> -1 AND :IEPS_10_PORC = COALESCE(:TASAIEPSDETALLE,-1)) THEN
            BEGIN
