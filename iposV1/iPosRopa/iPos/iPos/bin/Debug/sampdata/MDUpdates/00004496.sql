create or alter procedure UPD_EXP_FILES_PEDIDODEVO (
    FOLIO D_DOCTOFOLIO)
returns (
...
select count(*) cuenta from exp_files where TIPO = 'PD'  and DOCTOFOLIO = :FOLIO
into :COUNTEXISTE;
    ...
    BEGIN
        ...
        where tipodoctoid = 11  and   TRASLADOAFTP = 'N'  and docto.estatusdoctoid = 1 and docto.folio = :FOLIO;
    ...
    BEGIN
        ...
        UPDATE exp_files set  ESTATUS = 'A'
         where TIPO = 'PD'  and DOCTOFOLIO = :FOLIO  ;
