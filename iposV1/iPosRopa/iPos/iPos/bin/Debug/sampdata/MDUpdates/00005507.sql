create or alter procedure INVFIS_DIF_GENERAR_XLOC (
...
BEGIN
   ...
   FOR SELECT
      ...
      M.FECHAVENCE,
      MIN(M.CANTIDAD),
      SUM(M.CANTIDADSURTIDA),
      --M.CANTIDADFALTANTE,
      MIN(M.COSTO),
      MIN(M.TIPODIFERENCIAINVENTARIOID),
      D.PERSONAID  ,
      COALESCE(:VENDEDORID, D.VENDEDORID),
      M.LOTEIMPORTADO
   FROM MOVTO M
     LEFT JOIN DOCTO D
       ON D.ID = M.DOCTOID
   WHERE M.DOCTOID = :INVENTARIODOCTOID
      ...
      GROUP BY M.PRODUCTOID,M.LOTE, M.FECHAVENCE, D.PERSONAID , D.VENDEDORID , M.LOTEIMPORTADO
   INTO
      :PRODUCTOID, :LOTE, :FECHAVENCE,
      :CANTIDAD, :CANTIDADSURTIDA,
      --:CANTIDADFALTANTE,
      :COSTO, :TIPODIFERENCIAINVENTARIOID, :PERSONAID , :VENDEDORID, :LOTEIMPORTADO
   DO
   BEGIN
      COSTO = 0;
      ...
      BEGIN
         ...
         --BEGIN
            ...
            FROM MOVTO_INSERT(:DOCTOID, 0, :ALMACENID, :SUCURSALID, :TIPODOCTOID, 0, 0, :PERSONAID, :VENDEDORID, 1, 0,
               ...
               :REFERENCIA, '', :COSTO, :SUCURSALTID, :ALMACENTID, 'N', :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00,NULL,NULL,NULL,NULL,NULL, NULL, NULL, NULL, NULL, :LOTEIMPORTADO, 'N','N')
