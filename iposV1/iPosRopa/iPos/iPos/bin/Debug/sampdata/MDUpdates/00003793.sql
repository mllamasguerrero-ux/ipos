...
BEGIN
   ...
   if(COALESCE(:TIPODOCTOCANCELARID,21) = 21 AND COALESCE(:SUBTIPODOCTOCANCELARID,0) NOT IN (7,8) ) THEN
   BEGIN
    TIPODOCTOID = :TIPODOCTOCANCELARID;
   END
   ELSE IF((COALESCE(:TIPODOCTOCANCELARID,21) = 21 AND COALESCE(:SUBTIPODOCTOCANCELARID,0) IN (7,8))
           or (COALESCE(:TIPODOCTOCANCELARID,21) IN (31,81)))  THEN
   BEGIN
    TIPODOCTOID = 31;
   END
