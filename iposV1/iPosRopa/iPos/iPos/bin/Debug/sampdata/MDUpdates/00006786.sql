...
declare variable CORTEIDACTIVO D_FK;
...
BEGIN
   ...
   SELECT ESTATUSDOCTOID, TIPODOCTOID, FACTCONSID, SUBTIPODOCTOID, DOCTOREFID, VENTAFUTUID, CORTEID
   FROM DOCTO
   WHERE ID = :DOCTOCANCELARID
   INTO :ESTATUSDOCTOID, :TIPODOCTOCANCELARID, :DOCTOFACTCONSID, :SUBTIPODOCTOID, :DOCTOREFID, :VENTAFUTUID, :CORTEID;
   ...
   --VER SI HAY CORTE ACTIVO... SI LO HAY EL CORTE SE CALCULARA AUTOAMTICAMENTE, SI NO SE PONDRA EL CORTE DE LA VENTA
   SELECT HAYCORTEACTIVO,CORTEID,ERRORCODE
   FROM HAY_CORTE_ACTIVO(:VENDEDORID)
   INTO :HAYCORTEACTIVO, :CORTEIDACTIVO, :ERRORCODE;

   IF(COALESCE(:HAYCORTEACTIVO,'N') = 'S') THEN
   BEGIN
        CORTEID = 0;
   END
