...
BEGIN
   ...
   BEGIN
    ...
    WHERE MOVTO.ID = :MOVTOID AND
     ...
     IF(COALESCE(:TIPOVENDEDORMOVIL,0) IN (3,4) AND COALESCE(:HABSURTIDOPOSTPUESTO,'N') = 'N' AND COALESCE(:MOVILCONTADO,'S') = 'N') THEN
     BEGIN
        ...
        SELECT HABSURTIDOPOSTPUESTO FROM PARAMETRO INTO :HABSURTIDOPOSTPUESTO;
