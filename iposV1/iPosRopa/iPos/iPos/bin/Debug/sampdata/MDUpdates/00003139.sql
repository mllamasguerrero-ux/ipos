...
select
      ...
      where
          ...
          ( (:INCLUIRTRASL = 'S' AND TIPODOCTOID IN (21,22,23,24)) or (:INCLUIRTRASL = 'N' AND TIPODOCTOID IN (21,22,23,24) AND SUBTIPODOCTOID NOT IN (7,8))  OR   (:INCLUIRTRASL = 'S' AND TIPODOCTOID IN (31,32,33,81,83) AND SUBTIPODOCTOID NOT IN (7,8))    )
