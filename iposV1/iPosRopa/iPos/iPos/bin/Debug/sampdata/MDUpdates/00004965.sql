create or alter procedure EXISTE_PEDIDO_MOVIL (
...
BEGIN
   ...
   SELECT SUCURSALID FROM PARAMETRO INTO :SUCURSALID;
      ...
      SELECT COUNT(*) FROM DOCTO WHERE TIPODOCTOID = 331 AND VENDEDORID = :VENDEDORID AND COALESCE(REFERENCIA, '') = COALESCE(:REFERENCIA, '') INTO :cuentasimilares;
