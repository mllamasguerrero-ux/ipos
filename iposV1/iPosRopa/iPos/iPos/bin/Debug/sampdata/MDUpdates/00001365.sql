create or alter procedure APARTADA_CANCEL_INICIAR (
...
BEGIN
   ...
   IF (:TIPODOCTOCANCELARID = 25) THEN
      TIPODOCTOID = 26;
   ...
   INSERT INTO DOCTO
    ...
    CAJAID, REFERENCIA, REFERENCIAS, SUCURSALTID, ALMACENTID, PROMOCION,MERCANCIAENTREGADA, PERSONAAPARTADOID, DOCTOREFID, IEPS, IMPUESTO)
   SELECT
    ...
    CAJAID, :REFERENCIA, :REFERENCIAS, SUCURSALTID, ALMACENTID, 'N', 'S' , PERSONAAPARTADOID , ID , 0.00, 0.00
   ...
   BEGIN
      ...
      FROM MOVTO_INSERT (
         ...
         :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00 ,:DOCTOCANCELARID,NULL,NULL ,NULL,NULL
   ...
   END
        ...
        /*Echar para atras pagos*/
              SELECT ERRORCODE FROM APARTADA_REVERTIR_PAGOS(:DOCTOCANCELARID, :DOCTOID,:VENDEDORID) INTO :ERRORCODE;
