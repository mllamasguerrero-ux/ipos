     ...
     BEGIN
      ...
      BEGIN
       ...
       BEGIN
        ...
        FROM MOVTO
        WHERE (DOCTOID = :CURR_DOCTOID or DOCTOID = :CURR_DOCTOREFKITID)
        AND TASAIVA = 0
        ...
        BEGIN     
            ...
            FROM MOVTO
            WHERE (DOCTOID = :CURR_DOCTOID or DOCTOID = :CURR_DOCTOREFKITID)--IN (:DOCTOID, :DOCTOREFKITID) --AND COALESCE(ESKIT,'N') = 'N'
