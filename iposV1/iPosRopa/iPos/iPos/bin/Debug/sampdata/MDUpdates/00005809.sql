create or alter procedure RETIRO_CAJA_REVERTIR_PAGOS (
...
BEGIN
   ...
   -- Si no es devolucion
   IF (:TIPODOCTOCANCELARID NOT IN (62)) THEN
   BEGIN
      ERRORCODE = 1008;
      SUSPEND;
      EXIT;
   ...
   --RESTANTEBUFFER = :TOTAL;
    ...
    FOR SELECT P.doctoid, P.IMPORTE , P.FORMAPAGOID ,P.TIPOABONOID, P.REVERTIDO , P.FECHA , P.FORMAPAGOSATID  , APLICADO
   FROM DOCTOPAGO P
   WHERE P.DOCTOSALIDAID = :DOCTOACANCELARID AND P.tipopagoid = 2 AND P.FORMAPAGOID IN (1,2,3,4,5,14,15,16,20,21)
   INTO
   :DOCTOIDBUFFER, :SALDOBUFFER, :FORMAPAGOID, :TIPOABONOID, :REVERTIDO , :FECHAPAGO  , :FORMAPAGOSATID  , :APLICADO
   DO
   BEGIN
         ...
         INSERT INTO DOCTOPAGO ( DOCTOID, FORMAPAGOID, FECHA, FECHAHORA, CORTEID, IMPORTE, IMPORTERECIBIDO, IMPORTECAMBIO, TIPOPAGOID, DOCTOSALIDAID, ESPAGOINICIAL, TIPOABONOID, REVERTIDO, CORTETRANSCANCELADA, FORMAPAGOSATID, APLICADO)
                             VALUES (:DOCTODECANCELACION, :FORMAPAGOID, :FECHAPAGO, CURRENT_TIME,  :CORTEACANCELAR, :SALDOBUFFER,:SALDOBUFFER, 0, 1, :DOCTOACANCELARID, 'S', :TIPOABONOID, :REVERTIDO, :CORTEACANCELAR, :FORMAPAGOSATID, :APLICADO);
