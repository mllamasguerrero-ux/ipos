...
BEGIN
   ...
   INTO :ESTATUSDOCTOID, :TIPODOCTOCANCELARID, :CORTEID;
   ...
   IF (:TIPODOCTOCANCELARID NOT IN (11, 21, 31, 41, 821, 205)) THEN
   BEGIN
      ERRORCODE = 1008;
      SUSPEND;
      EXIT;
   ...
   ELSE IF (:TIPODOCTOCANCELARID = 41) THEN
      TIPODOCTOID = 43;   
   ELSE IF (:TIPODOCTOCANCELARID = 821) THEN
      TIPODOCTOID = 823;   
   ELSE IF (:TIPODOCTOCANCELARID = 205) THEN
      TIPODOCTOID = 206;
