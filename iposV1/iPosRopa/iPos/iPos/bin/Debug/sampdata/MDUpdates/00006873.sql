...
declare variable ESSERVDOMICILIO D_BOOLCN_NULL;
declare variable RUTAEMBARQUEID D_FK;
declare variable COMISIONPAGOTARJETADEB D_PORCENTAJE;
BEGIN
    ...
    SELECT  ALMACENID, SUCURSALID, TIPODOCTOID, PERSONAID , REFERENCIA, REFERENCIAS ,
            ALMACENTID, SUCURSALTID  , ESTATUSDOCTOID, VENDEDORID , FECHA, ORIGENFISCALID , CAJAID , PAGOCONTARJETA  , COMISIONPAGOTARJETA , PAGOACREDITO, ESSERVDOMICILIO, RUTAEMBARQUEID ,  COMISIONPAGOTARJETADEB
    from DOCTO
    where id = :doctoid
       ...
       GRUPO_MOVTOCUENTA = 0;
        ...
        FOR SELECT
            ...
            BEGIN
                ...
                :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, :VENCE, 0.00 ,NULL,NULL,NULL,NULL,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3 , NULL  , :LOTEIMPORTADO, 'N','N'
