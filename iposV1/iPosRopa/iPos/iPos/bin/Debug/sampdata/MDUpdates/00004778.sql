  ...
  END
   ...
   FOR SELECT
      ...
      coalesce(c.texto2,''),
                ...
                case when coalesce(P.PZACAJA,0) = 0 then 0 else TRUNC( (CORE.CANTIDAD / p.pzacaja) ) end cajas,
                case when coalesce(P.PZACAJA,0) = 0 then 0 else mod(CORE.CANTIDAD , p.pzacaja) end piezassueltas ,
