create or alter procedure ANTICIPOCLIENTE_CANCEL_INICIAR (
...
BEGIN
   ...
   IF (:TIPODOCTOCANCELARID = 201) THEN
      TIPODOCTOID = 203;
   ...
   END
        ...
        /*Echar para atras pagos*/
              SELECT ERRORCODE FROM ANTICIPOCLIENTE_REVERTIR_PAGOS(:DOCTOCANCELARID, :DOCTOID, :VENDEDORID) INTO :ERRORCODE;
