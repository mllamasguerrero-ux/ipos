...
declare variable APLICAESTAPROMOCION D_BOOLCN;
BEGIN
    ...
    BEGIN
        ...
        TOTALPARAPROMOCION = NULL;
        APLICAESTAPROMOCION = 'N';
        ...
        BEGIN
            ...
            FROM MOVTO
            LEFT JOIN PRODUCTO
            ON MOVTO.PRODUCTOID = PRODUCTO.ID
            WHERE DOCTOID = :DOCTOID
        ...
        BEGIN
            ...
            APLICAESTAPROMOCION = 'S';
        END

        IF(COALESCE(:APLICAESTAPROMOCION,'N') = 'S') THEN
        BEGIN
        
            IF(:TIPOPROMOCIONID = 8) THEN
            BEGIN
                UPDATE CUPONESAPLICADOS
                SET CUPONESAPLICADOS.cantidad = 1
                WHERE CUPONESAPLICADOS.DOCTOID = :DOCTOID AND CUPONESAPLICADOS.PROMOCIONCUPONID = :PROMOCIONID;
            END
            ...
            BEGIN
                ...
                SET CUPONESAPLICADOS.cantidad =
                    FLOOR(coalesce(:TOTALPARAPROMOCION,0) / coalesce(:IMPORTEPROMO,0))
                WHERE CUPONESAPLICADOS.DOCTOID = :DOCTOID AND CUPONESAPLICADOS.PROMOCIONCUPONID = :PROMOCIONID;
            END
