...
((COALESCE(D2.TOTAL ,0) -  COALESCE(D1.TOTAL ,0)) /  CASE WHEN COALESCE(D1.TOTAL,0)  <> 0 THEN D1.TOTAL  WHEN COALESCE(D2.TOTAL,0)  <> 0 THEN D2.TOTAL ELSE 1 END) * 100  PORCDIFERENCIA
