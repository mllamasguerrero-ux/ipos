create or alter procedure PRODUCTO_UPDATE (
    ...
    PLAZOID D_FK,
    ESPRODPROMO D_BOOLCN,
    BASEPRODPROMOID D_FK,
    VIGENCIAPRODPROMO D_FECHA,
    SAT_PRODUCTOSERVICIOID D_FK,
    VIGENCIAPRODKIT D_FECHA,
    KITTIENEVIG D_BOOLCN,
    ...
    SAT_TIPOEMBALAJEID D_FK,
    SAT_CLAVEUNIDADPESOID D_FK,
    PESO D_CANTIDAD,
    ESPELIGROSO D_BOOLCN,
    SAT_MATPELIGROSOID D_FK,
    ESOFERTA D_BOOLCN)
returns (
...
UNIDAD = :UNIDAD ,
    ...
    VIGENCIAPRODKIT = :VIGENCIAPRODKIT ,
    KITTIENEVIG = :KITTIENEVIG  ,
    VALXSUC = :VALXSUC ,
