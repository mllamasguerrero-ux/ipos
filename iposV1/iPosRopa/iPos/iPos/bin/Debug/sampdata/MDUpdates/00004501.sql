...
declare variable EXISTENCIASEXPORTADAS D_BOOLCS_NULL;
BEGIN
   ...
   SELECT COALESCE(P.INVENTARIABLE, 'S')  , COALESCE(EXISTENCIASEXPORTADAS, 'S')
   FROM PRODUCTO P
   WHERE P.ID = NEW.PRODUCTOID
   INTO :INVENTARIABLE, :EXISTENCIASEXPORTADAS;
   ...
   BEGIN
      ...
      BEGIN
         ...
         IF(:EXISTENCIASEXPORTADAS = 'S') THEN
         BEGIN
            UPDATE PRODUCTO SET EXISTENCIASEXPORTADAS = 'N' WHERE ID = NEW.PRODUCTOID;
         END
         ...
         IF(:tipodoctoid IN (21,25,12,31, 501,121) AND OLD.registroprocesosalida = 'S' ) THEN
         BEGIN
      ...
      BEGIN
           ...
           begin
              ...
              BEGIN
                  ...
                  :AlmacenId, NEW.PRODUCTOID, NEW.LOTE, NEW.FECHAVENCE, NEW.CANTIDADDEFACTURA*-1, NEW.PRECIO, NEW.COSTO,3, 'S', NEW.LOTEIMPORTADO);
              ...
              BEGIN
                 ...
                 (TIPODOCTOID, DOCTOID, MOVTOID, FECHA, FECHAHORA,
                  ...
                  VALUES          
                   (:TIPODOCTOID, NEW.DOCTOID, NEW.ID, :FECHA, :FECHAHORA,
                  :AlmacenId, NEW.PRODUCTOID, NEW.LOTE, NEW.FECHAVENCE, NEW.CANTIDADDEREMISION*-1, NEW.PRECIO, NEW.COSTO,2,  'S', NEW.LOTEIMPORTADO);
              ...
              BEGIN
                  ...
                  VALUES       
                   (:TIPODOCTOID, NEW.DOCTOID, NEW.ID, :FECHA, :FECHAHORA,
                  :AlmacenId, NEW.PRODUCTOID, NEW.LOTE, NEW.FECHAVENCE, NEW.CANTIDADDEINDEFINIDO*-1, NEW.PRECIO, NEW.COSTO,1, 'S', NEW.LOTEIMPORTADO);
