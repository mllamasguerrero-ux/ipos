   ...
   DOCTOMAXIMOID = 0;
    ...
    BEGIN
       ...
       SELECT
        ...
        FROM
            CONSOLIDADO_PORCONSOLIDAR(:FECHAINICIAL, :FECHAFINAL, :OMITIRVENTASAFRANQUICIAS, :INCLUIRGASTOS, 0, :OMITIRVALES, :SUMACOMPLETAVENTAS, :GRUPOUSUARIOID, :OMITIRCLIENTESRFC, 0.00)
