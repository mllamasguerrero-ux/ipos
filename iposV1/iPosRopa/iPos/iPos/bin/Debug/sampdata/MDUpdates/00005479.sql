create or alter procedure APARTADA_EDIT_INICIAR (
    DOCTOEDITARID D_FK,
    VENDEDORID D_FK)
returns (
    DOCTOID D_FK,
...
BEGIN
   ...
   -- Si no es devolucion
   IF (:TIPODOCTOEDITARID NOT IN (25)) THEN
   BEGIN
      ERRORCODE = 1008;
      SUSPEND;
      EXIT;
   ...
   FROM    apartada_cancel_iniciar ( :DOCTOEDITARID,:VENDEDORID)
   ...
   END
      /*
   SELECT ERRORCODE FROM  DOCTO_PAGOS (
    :DOCTOEDITARID,
    current_date,
    current_time,
    :VENDEDORID,
   ...
   SELECT ERRORCODE FROM DOCTO_SAVE( :DOCTOCANCELID) INTO :ERRORCODE;
   ...
   INSERT INTO DOCTO
    ...
    CAJAID, REFERENCIA, REFERENCIAS, SUCURSALTID, ALMACENTID, PROMOCION, DOCTOREFID, MERCANCIAENTREGADA, PERSONAAPARTADOID, IEPS, IMPUESTO)
   SELECT
    ...
    CAJAID, :REFERENCIA, :REFERENCIAS, SUCURSALTID, ALMACENTID, 'N', DOCTOREFID , MERCANCIAENTREGADA, PERSONAAPARTADOID , 0.00, 0.00
   ...
   FOR SELECT
      ...
      TIPODIFERENCIAINVENTARIOID  , CANTIDADDEFACTURA, CANTIDADDEREMISION, CANTIDADDEINDEFINIDO , MOVTOREFID , DESCRIPCION1, DESCRIPCION2, DESCRIPCION3, LOTEIMPORTADO
   FROM MOVTO
   ...
   BEGIN
      ...
      FROM MOVTO_INSERT (
         ...
         :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00 ,:DOCTOEDITARID,NULL,NULL,NULL,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3, NULL, :LOTEIMPORTADO, 'N','N'
