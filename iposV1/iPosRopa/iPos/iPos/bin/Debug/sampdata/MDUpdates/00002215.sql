...
BEGIN
   ...
   IF (:TIPODOCTOID NOT IN (11,21,25,31,41,321)) THEN
   BEGIN
      ERRORCODE = 4007;
      SUSPEND;
      EXIT;
   ...
   BEGIN
        ...
        SELECT SUMACOSTOTOTALCONIMPUESTO ,ERRORCODE
        FROM KIT_TOTALIZARIMPUESTOS(:PRODUCTOID)
        INTO :SUMATOTALCOSTOCONIMPUESTO, :ERRORCODE;
        ...
        FOR SELECT
               ...
               (( COALESCE(KITDEFINICION.COSTOPARTE,0) * COALESCE(KITDEFINICION.CANTIDADPARTE,0)
                         ...
                         + (COALESCE(KITDEFINICION.COSTOPARTE,0) * COALESCE(KITDEFINICION.CANTIDADPARTE,0) * (CASE WHEN PARAMETRO.DESGLOSEIEPS = 'S' THEN 1 + (COALESCE(PRODUCTO.TASAIEPS,0) / 100.00)
                          ELSE 1 END)) * (COALESCE(PRODUCTO.TASAIVA,0) / 100.00) ) / :SUMATOTALCOSTOCONIMPUESTO )  PRORRATEO,
        ...
        FROM KITDEFINICION
        INNER JOIN PRODUCTO  ON PRODUCTO.ID = KITDEFINICION.productoparteid
        ...
        BEGIN
            ...
            FROM MOVTO_INSERT(:DOCTOIDFORKIT, 0, :ALMACENID, :SUCURSALID, :TIPODOCTOIDFORKIT, 0, 0, :PERSONAID, :VENDEDORID, 1, 0,
               ...
               :REFERENCIA, '', :COSTO, :SUCURSALTID, :ALMACENID, 'N', NULL, CURRENT_DATE, CURRENT_DATE, 0.00,:DOCTOIDPARALLENAR,NULL,NULL,NULL,:MOVTOREFID, :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3)
