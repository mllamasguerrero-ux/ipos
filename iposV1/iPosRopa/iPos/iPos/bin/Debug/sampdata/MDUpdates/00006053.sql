...
BEGIN
   ...
   INTO :TIPODOCTOID, :ESTATUSDOCTOID ,:ALMACENID, :SUCURSALID, :CAJAID, :PERSONAID, :VENDEDORID, :ORIGENFISCALID, :SENTIDOINVENTARIO, :DOCTOREFID;
            ...
            insert into traza(valor) values('kkl. a' );
   ...
   WHERE M.DOCTOID = :DOCTOIDPARALLENAR  AND COALESCE(PRODUCTO.ESKIT, 'N') = 'S'
    ...
    INTO :CUENTAKITS;
            ...
            insert into traza(valor) values('kkl. b' );
    ...
    END
            ...
            insert into traza(valor) values('kkl. c' );
   ...
   TIPODOCTOIDFORKIT = 505;
    ...
    SELECT DOCTOID, ERRORCODE
     ...
     END
            ...
            insert into traza(valor) values('kkl. d' );
   ...
   BEGIN
            ...
            insert into traza(valor) values('kkl. e' );
    ...
    BEGIN
        ...
        FOR SELECT   DETALLEKITCANTIDAD ,
                    ...
                    ERRORCODE FROM KIT_OBTENREFERENCIA ( :DOCTOIDPARALLENAR,:MOVTOREFID,'N')
                    INTO
                    :CANTIDADFINAL ,
                    :DETALLEKITTASAIVA ,
                    :DETALLEKITTASAIEPS ,
                 ...
                 BEGIN
                        ...
                        insert into traza(valor) values('kkl. f' );
