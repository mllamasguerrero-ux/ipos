...
BEGIN
  ...
  -- FALTA COMPLETAR
   ...
   END
        ...
        VALUES
        (:ENCARGADOGUIAID,  :ESTADOGUIAID  , :CAJEROID, :CORTEID2,  current_date,  CURRENT_TIME, :NOTA, :TIPOENTREGAID, :GUIAPAQUETERIA,:VEHICULOID , :FECHAESTIMADAREC ,:HORAESTIMADREC, :NOTARECEPCION )
