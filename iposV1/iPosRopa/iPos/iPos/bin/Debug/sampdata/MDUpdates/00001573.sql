...
--existencia normal
   ...
   IF (:FECHAINI > coalesce(:FECHAINICIAL,'01/01/2020')) THEN
   BEGIN
      SELECT
   ...
   ELSE
   BEGIN
      CANTIDADMOVTOSINICIAL = 200;
   END


   CANTIDADINI = 0;
   CANTIDADFIN = coalesce(:EXISTENCIAINICIAL,0) + coalesce(:CANTIDADMOVTOSINICIAL,0);
