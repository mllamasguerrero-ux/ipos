...
BEGIN
  ...
  --Checar producto descontinuado en venta
   ...
   END
    ...
    select coalesce(SUBTIPODOCTOID,0), PAGOCONTARJETA/*, TIPOMAYOREOID*/, PAGOACREDITO from docto where id = :doctoid into :SUBTIPODOCTOID, :PAGOCONTARJETA/*, :TIPOMAYOREOID*/, :PAGOACREDITO;
   ...
   BEGIN
    ...
    select clave, ESKIT from producto where id = :productoid into :PRODUCTOCLAVE, :ESKIT;
      ...
      BEGIN
         ...
         IF (:TIPODOCTOID in (11,50,51,52,53,54,55,41,16,17, 501,502,503,504)) THEN
         BEGIN
            PRECIOLISTA = :COSTO;
         ...
         IF (:TIPODOCTOID IN (23, 323, 823)) THEN
         BEGIN
      ...
      VALUES (
         ...
         :DESCRIPCION3  ,
         :DESCUENTOPORCENTAJE ,
         :NUEVOSENPROCESOPARTES ,
         :ESKIT,
         :LOTEIMPORTADO ,
         :COSTOENDOLAR , (:COSTOENDOLAR * :CANTIDAD)
   ...
   BEGIN
      ...
      BEGIN
        ...
        -- otras salidas
         ...
         END
         -- Aqui llega si se cumplieron una de dos condiciones:
         --   > El precio es el estandar --   > El precio es menor al estandar pero el usuario tiene derecho. -- Calcular descuento.
         IF(:TIPODESCUENTOPRODID = 1 and :DESCUENTOCALCULADO = 'N') THEN
         BEGIN
                    SELECT PRECIO1 FROM  PRODUCTO WHERE ID = :PRODUCTOID INTO :TEMPPRECIO;
         END
