...
BEGIN
  ...
  SELECT  importe, RECIBOELECTRONICOID,
    CASE WHEN COALESCE(FORMAPAGOSAT.CLAVE, '') = '02' THEN  -- SI ES CHEQUE ENTONCES TOMAR LA FECHA DE APLICADO
         ...
         WHEN COALESCE(FORMAPAGOSAT.CLAVE, '') in ('01','03','04', '28') THEN  -- SI ES TRANSFERENCIA ENTONCES TOMAR LA FECHA DE RECEPCION
          ...
          WHERE PDS.PAGOSATID = :PAGOSATID
           ...
           BEGIN
                                    ...
                                    BEGIN
                                         ...
                                         IF(COALESCE(:TIPOIMPUESTO,'') = 'CONCEPTO_IVA' and COALESCE(:tasa, 0) > 0) THEN
                                         BEGIN
                                         ...
                                         END
                                         ELSE IF(COALESCE(:TIPOIMPUESTO,'') = 'CONCEPTO_IEPS' and COALESCE(:tasa, 0) > 0) THEN
                                            ...
                                            BEGIN     
                                                ...
                                                IMPORTE = 0;
                                            END
                                         ELSE IF(COALESCE(:TIPOIMPUESTO,'') = 'CONCEPTO_IVARETENIDO' and COALESCE(:tasa, 0) > 0) THEN 
                                            ...
                                            BEGIN     
                                                ...
                                                IMPORTE = 0;
                                            END
                                         ELSE IF(COALESCE(:TIPOIMPUESTO,'') = 'CONCEPTO_ISRRETENIDO' and COALESCE(:tasa, 0) > 0) THEN 
                                        ...
                                        BASEIMP = CAST(ROUND(CASE WHEN  COALESCE(:TASA,0) <> 0 THEN (COALESCE(:IMPORTE,0.00) * 100.00) / COALESCE(:Tasa,0.00) ELSE 0.00 END, 2) AS D_IMPORTE);
                                    ...
                                    WHERE I.PAGODOCTOSATID = :PAGODOCTOSATID and COALESCE(I.baseimp,0) > 0
