...
BEGIN
   ...
   IF (:LISTAPRECIOCLIENTE = '2' AND (:PRECIO > :PRECIO2 OR COALESCE(:PRECIOSORDENADOS,'S') = 'N') ) THEN
      PRECIO = :PRECIO2;
   ELSE IF (:LISTAPRECIOCLIENTE = '3' AND (:PRECIO > :PRECIO3  OR COALESCE(:PRECIOSORDENADOS,'S') = 'N') ) THEN
      PRECIO = :PRECIO3;
   ELSE IF (:LISTAPRECIOCLIENTE = '4' AND (:PRECIO > :PRECIO4  OR COALESCE(:PRECIOSORDENADOS,'S') = 'N') ) THEN
      PRECIO = :PRECIO4;
   ELSE IF (:LISTAPRECIOCLIENTE = '5' AND (:PRECIO > :PRECIO5  OR COALESCE(:PRECIOSORDENADOS,'S') = 'N') ) THEN
      PRECIO = :PRECIO5;
