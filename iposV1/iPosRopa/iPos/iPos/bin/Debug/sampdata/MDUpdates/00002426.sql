...
BEGIN
   ...
   BEGIN
      ...
      if (
       ...
       (abs(COALESCE(precio5,0) - COALESCE(aprecio5,0)) >= 0.01)
      ) then
      BEGIN
      ...
      BEGIN
        ...
        UPDATE OR INSERT INTO PRODUCTOPRECIOLOG
          (FECHA, PRODUCTOID, PRECIO1, PRECIO2, PRECIO3, PRECIO4, PRECIO5, FECHAPRECIO1)
        VALUES 
          (CURRENT_DATE, :PRODUCTOID, :PRECIO1, :PRECIO2, :PRECIO3, :PRECIO4, :PRECIO5, :FECHAPRECIO1)
