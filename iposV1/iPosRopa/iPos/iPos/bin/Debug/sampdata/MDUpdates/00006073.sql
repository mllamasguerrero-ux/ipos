...
returns (
    ...
    DEVOLUCIONDEPOSITO D_IMPORTE,
    INGRESODEPOSITOSOLOTRASLADO D_IMPORTE,
    INGRESODEPOSITOVENTATRASLADO D_IMPORTE,
    CANCELACIONDEPOSITO D_IMPORTE,
    INGRESODEP_OD D_IMPORTE,
    INGRESODEP_OD_VENTATRASLADO D_IMPORTE,
    REV_ABONODEP_OD D_IMPORTE,
    REV_ABONODEP_MD D_IMPORTE,
    REV_ABONODEP_VENTATRASLA_OD D_IMPORTE,
    REV_ABONODEP_VENTATRASLA_MD D_IMPORTE,
    INGRESODEPTERCERO D_IMPORTE,
    EGRESODEPTERCERO D_IMPORTE,
    DEVOLUCIONDEPTERCERO D_IMPORTE,
    INGRESODEPTERSOLOTRASLADO D_IMPORTE,
    INGRESODEPTERCEROVENTATRASLADO D_IMPORTE,
    CANCELACIONDEPTERCERO D_IMPORTE,
    INGRESODEPTER_OD D_IMPORTE,
    INGRESODEPTER_OD_VENTATRASLADO D_IMPORTE,
    REV_ABONODEPTER_OD D_IMPORTE,
    REV_ABONODEPTER_MD D_IMPORTE,
    REV_ABONODEPTER_VENTATRASLA_OD D_IMPORTE,
    REV_ABONODEPTER_VENTATRASLA_MD D_IMPORTE,
    INGRESOINDEFSOLOTRASLADO D_IMPORTE,
    INGRESOINDEFVENTATRASLADO D_IMPORTE,
    INGRESOINDEF_OD D_IMPORTE,
    INGRESOINDEF_OD_VENTATRASLADO D_IMPORTE,
    REV_ABONOINDEF_OD D_IMPORTE,
    REV_ABONOINDEF_MD D_IMPORTE,
    REV_ABONOINDEF_VENTATRASLA_OD D_IMPORTE,
    REV_ABONOINDEF_VENTATRASLA_MD D_IMPORTE,
...
declare variable INTERCAMBIOMERCANCIA D_IMPORTE;
declare variable FONDEOSDECAJA D_IMPORTE;
declare variable EGRESO_OD_COMPRA D_IMPORTE;
declare variable EGRESOEFE_OD_COMPRA D_IMPORTE;
declare variable EGRESOCRED_OD_COMPRA D_IMPORTE;
declare variable EGRESOTARJ_OD_COMPRA D_IMPORTE;
declare variable EGRESOCHEQUE_OD_COMPRA D_IMPORTE;
declare variable EGRESOVALE_OD_COMPRA D_IMPORTE;
declare variable EGRESOMONED_OD_COMPRA D_IMPORTE;
declare variable EGRESOTRANSF_OD_COMPRA D_IMPORTE;
declare variable EGRESODEP_OD_COMPRA D_IMPORTE;
declare variable EGRESODEPTER_OD_COMPRA D_IMPORTE;
declare variable EGRESOIND_OD_COMPRA D_IMPORTE;
declare variable FONDODINAMICOINICIAL D_IMPORTE;
declare variable FONDODINAMICOFINAL D_IMPORTE;
declare variable FONDODINAMICODIFERENCIA D_IMPORTE;
declare variable HABFONDODINAMICO D_BOOLCN;
BEGIN
   ...
   SELECT  ACTIVO, SALDOINICIAL, APORTACION, RETIRO, FECHACORTE , SALDOREAL, coalesce(SALDOREALCREDITO,0),
            FONDODINAMICO, FONDODINAMICOFINAL
   FROM CORTE
   WHERE ID = :CORTEID
   INTO :ACTIVO, :SALDOINICIAL, :APORTACION, :RETIRO,  :FECHACORTE, :SALDOREAL, :SALDOREALCREDITO,
            :FONDODINAMICOINICIAL, :FONDODINAMICOFINAL;


    SELECT FIRST 1 HABFONDODINAMICO FROM PARAMETRO INTO :HABFONDODINAMICO;
   ...
   INTO :NUMEROCANCSOLOTRASLADOS;
    ...
    --FONDO DINAMICO
    IF(COALESCE(:HABFONDODINAMICO,'N') = 'S') THEN
    BEGIN 
        FONDODINAMICODIFERENCIA = COALESCE(:FONDODINAMICOINICIAL,0.00)  - COALESCE(:FONDODINAMICOFINAL,0.00);
    END
    ELSE
    BEGIN
        FONDODINAMICODIFERENCIA = 0;
    END
    --FIN FONDO DINAMICO


   SALDOFINAL = :SALDOINICIAL + :TOTALAFECTACION + :FONDODINAMICODIFERENCIA;  --+ :INGRESO - :EGRESO;
   ...
   SET
      ...
      DEVOLUCION = :DEVOLUCION,
        ...
        INTERCAMBIOMERCANCIA = :INTERCAMBIOMERCANCIA,

        INGRESODEPOSITO = :INGRESODEPOSITO,
        EGRESODEPOSITO = :EGRESODEPOSITO,
        DEVOLUCIONDEPOSITO = :DEVOLUCIONDEPOSITO,
        INGRESODEPOSITOSOLOTRASLADO = :INGRESODEPOSITOSOLOTRASLADO,
        INGRESODEPOSITOVENTATRASLADO = :INGRESODEPOSITOVENTATRASLADO,
        CANCELACIONDEPOSITO = :CANCELACIONDEPOSITO,
        INGRESODEP_OD = :INGRESODEP_OD,
        INGRESODEP_OD_VENTATRASLADO = :INGRESODEP_OD_VENTATRASLADO,
        REV_ABONODEP_OD = :REV_ABONODEP_OD,
        REV_ABONODEP_MD = :REV_ABONODEP_MD,
        REV_ABONODEP_VENTATRASLA_OD = :REV_ABONODEP_VENTATRASLA_OD,
        REV_ABONODEP_VENTATRASLA_MD = :REV_ABONODEP_VENTATRASLA_MD,
        INGRESODEPTERCERO = :INGRESODEPTERCERO,
        EGRESODEPTERCERO = :EGRESODEPTERCERO,
        DEVOLUCIONDEPTERCERO = :DEVOLUCIONDEPTERCERO,
        INGRESODEPTERSOLOTRASLADO = :INGRESODEPTERSOLOTRASLADO,
        INGRESODEPTERCEROVENTATRASLADO = :INGRESODEPTERCEROVENTATRASLADO,
        CANCELACIONDEPTERCERO = :CANCELACIONDEPTERCERO,
        INGRESODEPTER_OD = :INGRESODEPTER_OD,
        INGRESODEPTER_OD_VENTATRASLADO = :INGRESODEPTER_OD_VENTATRASLADO,
        REV_ABONODEPTER_OD = :REV_ABONODEPTER_OD,
        REV_ABONODEPTER_MD = :REV_ABONODEPTER_MD,
        REV_ABONODEPTER_VENTATRASLA_OD = :REV_ABONODEPTER_VENTATRASLA_OD,
        REV_ABONODEPTER_VENTATRASLA_MD = :REV_ABONODEPTER_VENTATRASLA_MD,

        INGRESOINDEFSOLOTRASLADO = :INGRESOINDEFSOLOTRASLADO  ,
        INGRESOINDEFVENTATRASLADO =  :INGRESOINDEFVENTATRASLADO,
        INGRESOINDEF_OD = :INGRESOINDEF_OD ,
        INGRESOINDEF_OD_VENTATRASLADO  = :INGRESOINDEF_OD_VENTATRASLADO,
        REV_ABONOINDEF_OD  = :REV_ABONOINDEF_OD ,
        REV_ABONOINDEF_MD  = :REV_ABONOINDEF_MD,
        REV_ABONOINDEF_VENTATRASLA_OD  = :REV_ABONOINDEF_VENTATRASLA_OD,
        REV_ABONOINDEF_VENTATRASLA_MD  = :REV_ABONOINDEF_VENTATRASLA_MD,
        FONDEOSDECAJA = :FONDEOSDECAJA,

                    
        EGRESO_OD_COMPRA = :EGRESO_OD_COMPRA ,
        EGRESOEFE_OD_COMPRA = :EGRESOEFE_OD_COMPRA,
        EGRESOCRED_OD_COMPRA = :EGRESOCRED_OD_COMPRA ,
        EGRESOTARJ_OD_COMPRA = :EGRESOTARJ_OD_COMPRA,
        EGRESOCHEQUE_OD_COMPRA = :EGRESOCHEQUE_OD_COMPRA,
        EGRESOVALE_OD_COMPRA = :EGRESOVALE_OD_COMPRA,
        EGRESOMONED_OD_COMPRA = :EGRESOMONED_OD_COMPRA,
        EGRESOTRANSF_OD_COMPRA = :EGRESOTRANSF_OD_COMPRA,
        EGRESODEP_OD_COMPRA = :EGRESODEP_OD_COMPRA,
        EGRESODEPTER_OD_COMPRA = :EGRESODEPTER_OD_COMPRA,
        EGRESOIND_OD_COMPRA = :EGRESOIND_OD_COMPRA
