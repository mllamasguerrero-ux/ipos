   ...
   DOCTOMAXIMOID = 0;
    ...
    BEGIN
       ...
       SELECT
        ...
        FROM
            CONSOLIDADO_PORCONSOLIDAR(:FECHAINICIAL, :FECHAFINAL, :OMITIRVENTASAFRANQUICIAS, :INCLUIRGASTOS, 0, :OMITIRVALES, :SUMACOMPLETAVENTAS, :GRUPOUSUARIOID, :OMITIRCLIENTESRFC, 0.00,'S')
   ...
   FROM            DOCTO LEFT OUTER JOIN
    ...
    WHERE DOCTO.FECHA >= :FECHAINICIAL AND DOCTO.FECHA <= :FECHAFINAL
        ...
        FROM    DOCTO DOCTODEV LEFT join
                ...
                DOCTO DOCTOVENTA ON DOCTOVENTA.ID = DOCTODEV.DOCTOREFID
