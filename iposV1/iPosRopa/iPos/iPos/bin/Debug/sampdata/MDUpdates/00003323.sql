  ...
  --Checar producto descontinuado en venta
   ...
   BEGIN
    ...
    select clave, ESKIT from producto where id = :productoid into :PRODUCTOCLAVE, :ESKIT;
      ...
      IF(:CANTIDAD < 0 AND :TIPODOCTOID IN (11,12,21,22,25,16,17, 321, 111, 121)) THEN
      BEGIN 
            ERRORCODE = 3005;
            SUSPEND;
            EXIT;
   ...
   BEGIN
      ...
      /* no puede haber cantidades negativas en compras , ventas, devoluciones de compras y devoluciones de ventas*/
      IF((:CANTIDAD + :CANTIDADACTUAL) < 0 AND :TIPODOCTOID IN (11,12,21,22,25,16,17, 321, 111, 121)) THEN
      BEGIN 
            ERRORCODE = 3005;
            SUSPEND;
            EXIT;
