   ...
   BEGIN
      ...
      BEGIN
         ...
         BEGIN
          ...
          BEGIN
              SELECT PRECIODEVOLUCION,ERRORCODE, MOVTOREFID FROM GET_REFERENCIAS_DEVOLUCION(:productoid,  :DOCTOID, :DOCTOREFID)
         ...
         BEGIN
            SELECT PRECIODEVOLUCION,ERRORCODE, MOVTOREFID FROM GET_REFERENCIAS_COMPRADEVO(:productoid,  :DOCTOID, :DOCTOREFID)
            INTO :PRECIONUEVO, :ERRORCODE, :MOVTOREFID;
