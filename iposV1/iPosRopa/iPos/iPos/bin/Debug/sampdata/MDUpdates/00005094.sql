   ...
   BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            DETALLEKITTOTAL = ROUND(:DETALLEKITTOTAL,2);
            DETALLEKITSUBTOTAL =  ROUND(:DETALLEKITSUBTOTAL,2);
            DETALLEKITIVA = ROUND(:DETALLEKITIVA,2);
            DETALLEKITIEPS = ROUND(:DETALLEKITIEPS,2);
            DETALLEKITPRECIO = ROUND(:DETALLEKITPRECIO,2) ;
