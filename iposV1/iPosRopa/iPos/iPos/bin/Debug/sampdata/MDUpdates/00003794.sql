...
BEGIN
   ...
   SELECT  PROMOCION.importe,
     ...
     PROMOCION.lineaid
     FROM PROMOCION WHERE ID = :PROMOCIONIDBUFFER
     INTO  :IMPORTEPROMO, :PORCPROMO, :ENMONEDERO, :LINEAID ;
    ...
    FOR
        ...
        BEGIN
           ...
           BEGIN
                ...
                SUMATOTALSINPROMO = :TOTALORIGINAL;
                SUMATOTALCONPROMO = :TOTALORIGINAL;
           ...
           BEGIN
                ...
                BEGIN
                     ...
                     SELECT SUBTOTAL, IVA, IEPS
                     FROM MOVTO
                     WHERE ID = :MOVTOID
                     INTO :SUBTOTALSINPROMO, :IVASINPROMO, :IEPSSINPROMO;



                     IMPUESTOSINPROMO = IVASINPROMO + IEPSSINPROMO;
                     SUMATOTALSINPROMO = :SUBTOTALSINPROMO + :IMPUESTOSINPROMO;
                ...
                --CONPROMO
                     ...
                     SUMATOTALCONPROMO = :SUBTOTALCONPROMO + :IMPUESTOCONPROMO;
        ...
        BEGIN
             ...
             BEGIN
                ...
                PORCPROMOAPLICAREXACTO = :PORCPROMOAPLICAREXACTO + 0.005;
                            ...
                            --CONPROMO
                                 ...
                                 BEGIN
                                        ...
                                        HUBOMOVIMIENTOS = 'S';
                                          ...
                                          UPDATE MOVTO SET  APLICOPROMOXMONTOMIN = 'S', INGRESOPRECIOMANUAL = 'N', PROMOCION = 'S'
                                          WHERE ID = :MOVTOID;
