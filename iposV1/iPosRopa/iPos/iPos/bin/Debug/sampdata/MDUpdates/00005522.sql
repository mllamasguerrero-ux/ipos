...
declare variable CANTIDADTOTALDEVOLVER D_CANTIDAD;
BEGIN
   ...
   SELECT SUM(  coalesce(CANTIDAD,0) - coalesce(CANTIDADDEVUELTA,0) )
   FROM MOVTO
   WHERE DOCTOID = :DOCTODEVOLVERID
   INTO :CANTIDADTOTALDEVOLVER;

     
   -- Si no esta vigente: Salir.
   IF (COALESCE(:CANTIDADTOTALDEVOLVER,0) <= 0) THEN
   BEGIN
      ERRORCODE = 5026;
      SUSPEND;
      EXIT;
   ...
   BEGIN
      ...
      FROM MOVTO_INSERT (
         ...
         :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00 ,NULL,NULL,NULL,NULL, :MOVTOID, :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3, NULL  , :LOTEIMPORTADO, 'N','N'
