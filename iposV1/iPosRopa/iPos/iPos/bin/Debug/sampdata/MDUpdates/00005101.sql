...
declare variable NOMBANCOORDEXT D_STDTEXT_SHORT;
...
declare variable NOMBREBANCODELQUEHIZOPAGO D_STDTEXT_SHORT;
...
BEGIN
  ...
  SELECT  importe, RECIBOELECTRONICOID, FECHAHORA  , FORMAPAGOSAT.CLAVE ,
  ...
  :RFCBANCODELQUEHIZOPAGO, :CUENTABANCOEMPRESAID, :NOMBREBANCODELQUEHIZOPAGO;
   ...
   (
    ...
    IF(COALESCE(:sat_bancarizado, 'N') like 'S%') THEN
    BEGIN
    ...
    FOR SELECT DOCTOPAGO.ID, DOCTOPAGO.IMPORTE, DOCTOPAGO.DOCTOID FROM DOCTOPAGO WHERE PAGOID = :PAGOID
        INTO :DOCTOPAGOID , :TOTALDETALLE, :DOCTOIDORIGEN
        DO
        BEGIN
