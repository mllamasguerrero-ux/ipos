...
BEGIN
  ...
  SELECT TIPODOCTOID, DOCTO.OMITIRVALES , SUBTIPODOCTOID , ESFACTURAELECTRONICA
   FROM DOCTO
   WHERE ID = :DOCTOID INTO :TIPODOCTOID, :OMITIRVALES, :SUBTIPODOCTOID, :ESFACTURAELECTRONICA;
        ...
        BEGIN
            ...
            BEGIN
                 ...
                 BEGIN
                    ...
                    SELECT COALESCE(PERSONA.RFC,'XAXX010101000'), PERSONA.nombres || ' ' || PERSONA.apellidos, ''
                    FROM DOCTO
                    INNER JOIN PERSONA ON PERSONA.ID = DOCTO.PERSONAID
                    WHERE DOCTO.ID = :DOCTOID
                    INTO :RFC, :RAZONSOCIAL, :RESIDENCIAFISCAL ;
