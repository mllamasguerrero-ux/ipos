...
BEGIN
   ...
   update producto set existencia = 0, existenciafacturado = 0, existenciaremisionado = 0, existenciafacturadoapartado = 0,
                       existenciaremisionadoapartado = 0, comision = 0, exist_fac_intercambio = 0,exist_rem_intercambio = 0,
                        COSTOULTIMO = 0, COSTOPROMEDIO = 0, COSTOREPOSICION = 0, CANTTOTALENTRADAS = NULL, COSTOTOTALENTRADAS = NULL, enprocesodesalida = 0;
