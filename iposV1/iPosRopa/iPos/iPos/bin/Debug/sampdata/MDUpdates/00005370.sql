...
BEGIN
   ...
   WHERE ID = :FIRSTMOVTOID;
    ...
    SELECT ERRORCODE
                    ...
                    :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00 ,NULL,NULL,NULL,:FIRSTMOVTOID,NULL , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3 , NULL , :LOTEIMPORTADO, 'N','N'
                ) INTO :ERRORCODE;
