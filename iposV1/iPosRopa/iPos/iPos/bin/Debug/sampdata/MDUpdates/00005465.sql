        ...
        FOR SELECT                  FX.ID,
                                                        ...
                                                        CASE
                                                            ...
                                                            WHEN TIPOLINEA = 'CONCEPTO_IEPS'  THEN
                                                                CASE WHEN MOVTO.IEPS > 0 THEN
                                                                    ((COALESCE(MOVTO.IEPS,0) - COALESCE(MOVTO.SINVALE_IEPS,0))/ COALESCE(MOVTO.IVA,0))
                                                                ELSE 0.0
                                                                END
                                                            ELSE
                                                               0.0
          ...
          BEGIN
                ...
                BEGIN
                    ...
                    ELSE
                    BEGIN
                        RESULTADOEXACTOIVA =  COALESCE(:RESULTADOEXACTOIVA,0) + CAST(((COALESCE(:DIF,0.00) / COALESCE(:SUMADIF_IVA,0.00)) * COALESCE(:TOTALDIF_IVA,0.00)) AS D_DECIMAL_EXACT);
                ...
                BEGIN
                    ...
                    ELSE
                    BEGIN
                        RESULTADOEXACTOIEPS =  COALESCE(:RESULTADOEXACTOIEPS,0) + CAST(((COALESCE(:DIF,0.00) / COALESCE(:SUMADIF_IEPS,0.00)) * COALESCE(:TOTALDIF_IEPS,0.00)) AS D_DECIMAL_EXACT);
                    END
