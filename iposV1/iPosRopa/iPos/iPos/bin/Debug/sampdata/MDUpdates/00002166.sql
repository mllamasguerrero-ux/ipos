...
BEGIN
   ...
   SELECT TIPODOCTOID, ESTATUSDOCTOID  , ALMACENID, SUCURSALID, CAJAID
   FROM DOCTO
   WHERE ID = :KITDOCTOID
   INTO :TIPODOCTOID, :ESTATUSDOCTOID ,:ALMACENID, :SUCURSALID, :CAJAID;
   ...
   BEGIN
      ...
      ALMACENTID = 0;
            ...
            FROM MOVTO_INSERT(:DOCTOIDPARTE, 0, :ALMACENID, :SUCURSALID, :TIPODOCTOIDPARTE, 0, 0, :PERSONAID, :VENDEDORID, 1, 0,
               :PRODUCTOID, :LOTE, :FECHAVENCE, :CANTIDAD, :CANTIDADSURTIDA, :CANTIDADFALTANTE, 0, 0, 0, 0,
               :REFERENCIA, '', :COSTO, :SUCURSALTID, :ALMACENTID, 'N', NULL, CURRENT_DATE, CURRENT_DATE, 0.00,:KITDOCTOID,NULL,NULL,NULL,NULL, :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3)
