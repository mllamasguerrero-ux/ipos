...
BEGIN
   ...
   WHERE M.DOCTOID = :DOCTOIDPARALLENAR  AND COALESCE(PRODUCTO.ESKIT, 'N') = 'S'  AND COALESCE(PRODUCTO.KITIMPFIJO,'N') <> 'S'
      AND (M.CANTIDAD > 0)
    INTO :CUENTAKITS;
        ...
        INTO  :SUMAIEPS,  :SUMAIVA, :MAXIEPS, :MAXIVA;
         ...
         END
            ...
            FOR SELECT
                        ...
                        CASE WHEN COALESCE(PRODUCTO.ESKIT, 'N') = 'S'  AND COALESCE(PRODUCTO.KITIMPFIJO,'N') <> 'S' THEN 'S' ELSE 'N' END ESKIT
