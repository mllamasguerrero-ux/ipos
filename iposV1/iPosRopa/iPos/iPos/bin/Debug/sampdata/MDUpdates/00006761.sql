...
declare variable CUENTAPRODSINSAT D_INTEGER;
...
BEGIN
   ...
   SELECT first 1 versioncfdi FROM PARAMETRO INTO :VERSIONCFDI;
 ...
 INTO
    ...
    BEGIN
         STRINGERRORES  = 'EL RFC DEL CLIENTE O PROVEEDOR ESTA VACIO ' || cast(:PERSONAID as varchar(10));
         VALIDEZ = 'N';
         SUSPEND;
         EXIT;
    END
    ...
    BEGIN
       ...
       SELECT COUNT(*) FROM  MOVTO LEFT JOIN PRODUCTO ON PRODUCTO.ID = MOVTO.PRODUCTOID
       WHERE MOVTO.DOCTOID = :DOCTOID AND COALESCE(PRODUCTO.sat_productoservicioid,0) = 0
       INTO :CUENTAPRODSINSAT;

       IF(COALESCE(:cuentaprodsinsat, 0) > 0 ) THEN
       BEGIN
       
         STRINGERRORES  = 'HAY PRODUCTOS SIN CLAVE SAT';
         VALIDEZ = 'N';
         SUSPEND;
         EXIT;
