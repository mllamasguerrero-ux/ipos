          ...
          INTO :PZACAJA, :DESCPES, :PROVEEDORCLAVE, :ADESCPES, :PRECIO1, :POR_COME;
           ...
           TASAIMPUESTO = ( 1.00 + (:TASAIEPS / 100.00)) * :TASAIVA ;
             ...
             BEGIN
                ...
                BEGIN 
                    RANGOENCONTRADO = 'S';
                    COMISIONPORC = CASE WHEN COALESCE(:COMISIONPORCBUFFER,0) = -1 THEN COALESCE(:POR_COME,0) ELSE COALESCE(:COMISIONPORCBUFFER,0) END ;
