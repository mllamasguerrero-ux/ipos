...
BEGIN
   ...
   INSERT INTO DOCTO
    ...
    CAJAID, REFERENCIA, REFERENCIAS, SUCURSALTID, ALMACENTID, PROMOCION, DOCTOREFID, ORIGENFISCALID, IEPS, IMPUESTO)
   SELECT
    ...
    CAJAID, :REFERENCIA, :REFERENCIAS, SUCURSALTID, ALMACENTID, 'N', DOCTOREFID , ORIGENFISCALID, 0.00, 0.00
