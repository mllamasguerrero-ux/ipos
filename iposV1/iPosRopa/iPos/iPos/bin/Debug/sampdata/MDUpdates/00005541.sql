...
BEGIN
   ...
   INTO
      :PRODUCTOID, :LOTE, :FECHAVENCE, :CANTIDAD, :COSTO, :TIPODIFERENCIAINVENTARIOID , :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3, :PRECIO, :LOTEIMPORTADO
   DO
   BEGIN
      COSTO = 0;
     ...
     ALMACENTID = 0;
      ...
      FROM MOVTO_INSERT(:DOCTOID, 0, :ALMACENID, :SUCURSALID, :TIPODOCTOID, 0, 0, 0, :VENDEDORID, 1, 0,
         :PRODUCTOID, :LOTE, :FECHAVENCE, :CANTIDAD, 0, :CANTIDAD, 0, 0, :PRECIO, 0,
         :REFERENCIA, '', :COSTO, :SUCURSALTID, :ALMACENTID, 'N', :TIPODIFERENCIAINVENTARIOID, CURRENT_DATE, CURRENT_DATE, 0.00,NULL,NULL,NULL,NULL,NULL, :DESCRIPCION1, :DESCRIPCION2, :DESCRIPCION3, NULL, :LOTEIMPORTADO, 'N', 'N')
