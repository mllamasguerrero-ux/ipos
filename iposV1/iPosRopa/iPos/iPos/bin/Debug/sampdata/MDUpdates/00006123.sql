create or alter procedure POLIZALINEAV2_DET_PARTE2 (
    ...
    LEYENDA = :LEYENDAINICIAL;
        ...
        begin
           ...
           NUMLINEA = :NUMERO + 1; DTL_ORDEN = 0;
            ...
            for
                select docto.id,coalesce(docto.total,0) , DOCTO.FECHA, DOCTO.ESFACTURAELECTRONICA        
                ...
                and (docto.tipodoctoid in (21) or (docto.tipodoctoid = 31 and coalesce(docto.subtipodoctoid,0) not in (7,8)) )
            ...
            begin
                ...
                DTL_NIV2_CONCEPTO = :DTL_NIV1_CONCEPTO;
                DTL_NIV2_NOMBREID1 = :DTL_NIV1_NOMBREID1;
                DTL_NIV2_NOMBREFECHA1 = :DTL_NIV1_NOMBREFECHA1;
                DTL_NIV2_NOMBREMONTO1 = :DTL_NIV1_NOMBREMONTO1;
                DTL_NIV2_MONTO1  = :DTL_NIV1_MONTO1;
                DTL_NIV2_NOMBREID2 = :DTL_NIV1_NOMBREID2;
                DTL_NIV2_NOMBREREFERENCIA1 = :DTL_NIV1_NOMBREREFERENCIA1;
                DTL_NIV1_ID1  = :DTL_NIV1_ID1;
                DTL_NIV1_FECHA1  = :DTL_NIV1_FECHA1;
                DTL_NIV1_ID2  = :DTL_NIV1_ID2;
                DTL_NIV1_REFERENCIA1 = :DTL_NIV1_REFERENCIA1;


                BUFFERMONTO2 = 0;
            
                for
                    select (case when coalesce(:AUXESFACTURAELECTRONICA,'N') = 'S' then 0 else
                 ...
                 begin
                        ...
                        DTL_NIV1_CONCEPTO = 'DEVOLUCION,CRED/CONT: CRED,ESTATUS:COMP,FACT/REM:' || CASE WHEN COALESCE(:ESFACT,'N') = 'S' THEN 'FACT' ELSE 'REM' END || ', PZO: NO TEQ'   ;
        ...
        begin    
                HDR_CONCEPTO1 = 'VENTA CONTADO NO TEQ ' || CASE WHEN COALESCE(:ESFACT,'N') = 'S' THEN 'FACT' ELSE 'REM' END ; HDR_CONCEPTO2 = '';
                NUMLINEA = :NUMERO + 1; DTL_ORDEN = 0;
                ...
                for
                     select sum(coalesce(doctopago.importe,0))  subtotal        
                        ...
                        ,:DTL_NIV1_REFERENCIA3,:DTL_NIV1_REFERENCIA4,:DTL_NIV1_REFERENCIA5,:DTL_NIV1_REFERENCIA6
                 do
                 begin
                 
                    DTL_NIV1_CONCEPTO = 'VENTA,CRED/CONT:CONTADO,ESTATUS:TODOS,FACT/REM:' || CASE WHEN COALESCE(:ESFACT,'N') = 'S' THEN 'FACT' ELSE 'REM' END || ', PZO: NO TEQ'   ;
                    DTL_NIV1_NOMBREID1 = 'VENTA ID';
                    DTL_NIV1_NOMBREFECHA1 = 'FECHA VENTA';
                    DTL_NIV1_NOMBREMONTO1 = 'PAGO';
                ...
                HDR_CONCEPTO1 = 'CANCELACION,CRED/CONT: CRED,ESTATUS:COMP,FACT/REM:' || CASE WHEN COALESCE(:ESFACT,'N') = 'S' THEN 'FACT' ELSE 'REM' END || ', PZO: NO TEQ'  ;
                HDR_CONCEPTO2 = '';
                NUMLINEA = :NUMERO + 1; DTL_ORDEN = 0;
                ...
                for
                 ...
                 begin
                    ...
                    DTL_NIV1_CONCEPTO = 'CANCELACION,CRED/CONT:CONTADO,ESTATUS:TODOS,FACT/REM:' || CASE WHEN COALESCE(:ESFACT,'N') = 'S' THEN 'FACT' ELSE 'REM' END || ', PZO: NO TEQ'   ;
                    DTL_NIV1_NOMBREID1 = 'CANC VENTA ID';
                    DTL_NIV1_NOMBREFECHA1 = 'FECHA CANC VENTA';
                    DTL_NIV1_NOMBREMONTO1 = 'PAGO';
                    DTL_NIV1_MONTO1  = :monto;
                    DTL_NIV1_NOMBREID2 = 'FOLIO';
                    DTL_NIV1_NOMBREREFERENCIA1 = 'REFERENCIA'; 
