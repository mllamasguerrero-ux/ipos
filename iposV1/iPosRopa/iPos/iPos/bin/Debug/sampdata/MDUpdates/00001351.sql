...
select
    ...
    (
        select
          a_i.corteid, a_i.tipodoctoid, sum(a_i.abonomismocorte) as abonomismocorte
        from
            (
            select
             p.corteid,
            ...
            group by p.corteid, p.tipopagoid, ds.tipodoctoid, de.tipodoctoid, ds.esapartado, de.esapartado
          ) a_i
          group by a_i.corteid, a_i.tipodoctoid
        ...
        group by base.corteid,base.tipodoctoid, base.tipoabonoid, base.mismocorte ,abonos_mc.abonomismocorte
;