...
select
       ...
       case when docto.tipodoctoid = 41 then docto.total - coalesce(dt.total,0) else docto.total end TOTAL  ,
...
left join docto dt on dt.fecha = docto.fecha and dt.tipodoctoid = 42 and dt.doctorefid = docto.id --el traslado
