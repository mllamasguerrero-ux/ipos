create or alter procedure FACTURAELECTRONICA_GUARDAR (
    ...
    CARTAPORTE_IDCCP D_STDTEXT_MEDIUM)
returns (
    CFDIID D_FK,
...
declare variable DESCRIPCION D_SAT_DESCRIPCION;
...
declare variable EXPORTACION D_STDTEXT_64;
declare variable OBJETOIMP D_STDTEXT_64;
declare variable DOMICILIOFISCAL D_STDTEXT_64;
declare variable PERIODICIDAD D_STDTEXT_64;
declare variable MESES D_STDTEXT_64;
declare variable ANIO D_STDTEXT_64;
declare variable PESOBRUTOVEHICULAR D_PESOVEHICULAR;
BEGIN
        ...
        BEGIN
         ...
         BEGIN
             ...
             SET
                ...
                RC_REGIMENFISCAL = :REGIMENFISCAL,
                RC_DOMICILIOFISCAL = :DOMICILIOFISCAL

             WHERE ID = :CFDIID;

         END     
         ELSE IF(COALESCE(:TIPOLINEA,'') = 'INFORMACIONGLOBAL') THEN
         BEGIN
