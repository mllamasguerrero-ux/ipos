...
BEGIN
   ...
   -- Validar estatus.
   SELECT TIPODOCTOID, ESTATUSDOCTOID, REFERENCIAS , PERSONAID , VENDEDORID , ESFACTURAELECTRONICA , FECHA, RUTAEMBARQUEID --,MOVILCONTADO
   FROM DOCTO
   WHERE ID = :DOCTOID
   INTO :TIPODOCTOID, :ESTATUSDOCTOID, :REFERENCIAS, :PERSONAID, :VENDEDORID, :ESFACTURAELECTRONICA, :FECHA, :RUTAEMBARQUEID--, :MOVILCONTADO
   ;
   ...
   END
      ...
      END
        ...
        FOLIOSAT,SERIESAT,TIMBRADOFECHA, TIMBRADOUUID,TIMBRADOCERTSAT,ESAPARTADO,DOCTOREFID, IEPS, IMPUESTO, SUBTIPODOCTOID, OBSERVACION, RUTAEMBARQUEID, TIMBRADOFORMAPAGOSAT, MOVILCONTADO, MOVILPLAZOS
        )
        SELECT
        ...
        FOLIOSAT,SERIESAT,TIMBRADOFECHA, TIMBRADOUUID,TIMBRADOCERTSAT , ESAPARTADO,ID, 0.00, 0.00 ,15, OBSERVACION , :RUTAEMBARQUEID , 99 , MOVILCONTADO, MOVILPLAZOS
        ...
        FOR SELECT
            ...
            FROM MOVTO LEFT JOIN PRODUCTO ON PRODUCTO.ID = MOVTO.PRODUCTOID
                LEFT JOIN INVENTARIO ON INVENTARIO.productoid = PRODUCTO.ID AND (   COALESCE(INVENTARIO.ALMACENID,1) = 1 )
            ...
            GROUP BY MOVTO.ID, MOVTO.productoid,  PRODUCTO.manejalote,  MOVTO.LOTE, MOVTO.FECHAVENCE,MOVTO.cantidadsurtida, 
                     ...
                     MOVTO.PRECIO, MOVTO.COSTO,
                      MOVTO.TIPODIFERENCIAINVENTARIOID  , MOVTO.CANTIDADDEFACTURA, MOVTO.CANTIDADDEREMISION, MOVTO.CANTIDADDEINDEFINIDO , MOVTO.DESCRIPCION1, MOVTO.DESCRIPCION2, MOVTO.DESCRIPCION3,
                      PRODUCTO.manejaloteimportado, MOVTO.LOTEIMPORTADO  ,parametro.manejaALMACEN
            HAVING COALESCE(case when parametro.manejaALMACEN = 'S' then SUM(INVENTARIO.cantidad) else  PRODUCTO.EXISTENCIA END,0) - COALESCE(PRODUCTO.enprocesodesalida,0) >= 0
            INTO
       ...
       HAYPRECIOSNOVALIDOS = 'N';
        ...
        BEGIN
            ...
            SELECT DOCTOPAGOID, ERRORCODE
                ...
                :DOCTOVENTAID,
                CASE WHEN COALESCE(:MOVILCONTADO,'N') = 'S'  THEN 1 ELSE 4 END,
              ...
              BEGIN
                ...
                IF(COALESCE(:ESFACTURAELECTRONICA,'N')= 'S') THEN
                BEGIN
