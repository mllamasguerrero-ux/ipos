...
BEGIN
   ...
   FROM DOCTOPAGO P
   left join DOCTO D ON D.ID = P.DOCTOID
   WHERE P.DOCTOSALIDAID = :DOCTOACANCELARID AND P.tipopagoid = 2 AND P.FORMAPAGOID = 19  AND D.estatusdoctoid = 1
   INTO
   :DOCTOIDBUFFER, :SALDOBUFFER
   DO
   BEGIN
         ...
         INSERT INTO DOCTOPAGO ( DOCTOID, FORMAPAGOID, FECHA, FECHAHORA, CORTEID, IMPORTE, IMPORTERECIBIDO, IMPORTECAMBIO, TIPOPAGOID, DOCTOSALIDAID, ESPAGOINICIAL, CORTETRANSCANCELADA, TIPOABONOID)
                             VALUES (:DOCTOIDBUFFER, 18, CURRENT_DATE, CURRENT_TIME,  :CORTEID, :SALDOBUFFER,:SALDOBUFFER, 0, 2, :DOCTOACANCELARID, 'S', :CORTEACANCELAR, 2);
