CREATE TABLE SAT_IMPUESTO (
    ...
    SAT_RETENCION         D_STDTEXT_SHORT /* D_STDTEXT_SHORT = VARCHAR(32) */,
    SAT_TRASLADO          D_STDTEXT_SHORT /* D_STDTEXT_SHORT = VARCHAR(32) */,
    SAT_LOCALFEDERAL      D_STDTEXT_SHORT /* D_STDTEXT_SHORT = VARCHAR(32) */,
    SAT_ENTIDADAPLICA     D_STDTEXT_SHORT /* D_STDTEXT_SHORT = VARCHAR(32) */
);
