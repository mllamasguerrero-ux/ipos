...
BEGIN
   ...
   SELECT PRODUCTID, DESCRIPTION, SHORTDESCRIPTION, AMOUNT  FROM EMIDAPRODUCT
   WHERE ID = :EMIDAPRODUCTOID INTO :EMIDAID, :EMIDADESCRIPTION, :EMIDASHORTDESCRIPTION, :EMIDAMONTO;
   ...
   END
    ...
    1,-- MONEDAID D_FK,
    :MONTO, --COSTOREPOSICION D_COSTO,
    :MONTO, -- COSTOULTIMO D_COSTO,
    :MONTO, --COSTOPROMEDIO D_COSTO,
