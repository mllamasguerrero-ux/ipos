...
{
    public partial class WFProveedorTrasladosProdPromo : IposForm
    {
        public WFProveedorTrasladosProdPromo()
        {
            InitializeComponent();
        }
        ...
        private void BTEnviar_Click(object sender, EventArgs e)
        {
            ...
            report1.SetParameterValue("provee", p_cliente);
            report1.SetParameterValue("proveeNombre", this.PERSONALabel.Text);
        ...
        private void WFProveedorTrasladosProdPromo_Load(object sender, EventArgs e)
        {
            report1.Load(FastReportsConfig.getPathForFile("InformeProdPromoProvee.frx", FastReportsTipoFile.desistema));
        ...
        private void WFProveedorTrasladosProdPromo_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
