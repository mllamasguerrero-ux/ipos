...
namespace iPos
{
    public partial class WFTrasladoProdProm : IposForm
    {
        CDOCTOBE m_Docto;
        CPRODUCTOBE m_prod;
        ...
        public WFTrasladoProdProm()
        {
            InitializeComponent();
            m_prod = new CPRODUCTOBE();
            m_Docto = new CDOCTOBE();
            m_Docto.ITIPODOCTOID = DBValues._DOCTO_TIPO_TRASLADO_PRODUCTO_PROMOCION;
            LlenarGrid();
        ...
        private void LlenarGrid()
        {
            try
            {
                ...
                if (P_IDDOCTO == 0)
                {
                    this.dSProductoPromocion.Clear();
                    return;
                }
        ...
        private void Process()
        {
            ...
            if (m_prod.IESPRODPROMO == null || !m_prod.IESPRODPROMO.Equals("S") || m_prod.IBASEPRODPROMOID == 0)
            {
                MessageBox.Show("No es un producto promocion valido");
                return;
            }
        ...
        {
            WFListaEnsamblados look = new WFListaEnsamblados((int)DBValues._DOCTO_TIPO_TRASLADO_PRODUCTO_PROMOCION);
            look.ShowDialog();
        ...
        private bool TRASLADOPROMOCION_APLICAR(long lDoctoID, FbTransaction st)
        {
            ...
            try
            {
                ...
                string commandText = @"TRASLADOPROMOCION_APLICAR";
        ...
        private bool ProcessAplicar()
        {
            ...
            try
            {
                //aqui hay que verificar existencias
                ...
                if (TRASLADOPROMOCION_APLICAR(m_Docto.IID, fTrans) == false)
                {
                    fTrans.Rollback();
                    fConn.Close();
        ...
        private void WFTrasladoProdProm_Load(object sender, EventArgs e)
        {
