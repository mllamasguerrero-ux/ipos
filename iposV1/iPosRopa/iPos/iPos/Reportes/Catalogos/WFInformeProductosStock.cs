...
{
    public partial class WFInformeProductosStock : IposForm
    {
        public WFInformeProductosStock()
        {
            InitializeComponent();
        }
        ...
        private void BTEnviar_Click(object sender, EventArgs e)
        {
            ...
            if(comboOrden.SelectedIndex >= 0)
                report1.SetParameterValue("Orden", (Decimal)comboOrden.SelectedIndex + 1);

            if (cbDebajoStock.Checked)
                report1.SetParameterValue("BajoStock", "S");
            else
                report1.SetParameterValue("BajoStock", "N");
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfig.getPathForFile("InformeProductosXStock.frx", FastReportsTipoFile.desistema));
        ...
        private void WFInformeProductosStock_Load(object sender, EventArgs e)
        {
            RecargarReport();
        }

        private void WFInformeProductosStock_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
