...
{
    public partial class WFProductosListaPrecios : IposForm
    {
        public WFProductosListaPrecios()
        {
            InitializeComponent();
        }
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfig.getPathForFile("InformeListaDePrecios.frx", FastReportsTipoFile.desistema));
        ...
        private void WFProductosListaPrecios_Load(object sender, EventArgs e)
        {
            RecargarReport();
        }

        private void WFProductosListaPrecios_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
        ...
        private void CBMostrarExistencia_CheckedChanged(object sender, EventArgs e)
        {
