...
{
    public partial class WFProductosXLinea : IposForm
    {
        public WFProductosXLinea()
        {
            InitializeComponent();
        }
        ...
        private void BTEnviar_Click(object sender, EventArgs e)
        {
            ...
            if (!CBTodasLineas.Checked)
            {
                try
                {
                    p_linea = Int64.Parse(this.ITEMIDTextBox.DbValue.ToString());
                }
                catch
                {
        ...
        {
            report1.Load(FastReportsConfig.getPathForFile("InformeProductosXLinea.frx", FastReportsTipoFile.desistema));
        ...
        private void WFProductosXLinea_Load(object sender, EventArgs e)
        {
            RecargarReport();
        }

        private void WFProductosXLinea_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
