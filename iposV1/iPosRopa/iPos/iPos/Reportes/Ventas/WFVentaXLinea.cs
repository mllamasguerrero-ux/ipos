...
{
    public partial class WFVentaXLinea : IposForm
    {
        public WFVentaXLinea()
        {
            InitializeComponent();
        }
        ...
        private void BTEnviar_Click(object sender, EventArgs e)
        {
            ...
            report1.SetParameterValue("lineaid", (Decimal)p_item);
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfig.getPathForFile(CBSumarizado.Checked ? "InformeVentasXLinea.frx" : "InformeVentasXLineaDetalle.frx", FastReportsTipoFile.desistema));
        ...
        private void WFVentaXLinea_Load(object sender, EventArgs e)
        {
            RecargarReport();
        }

        private void WFVentaXLinea_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
