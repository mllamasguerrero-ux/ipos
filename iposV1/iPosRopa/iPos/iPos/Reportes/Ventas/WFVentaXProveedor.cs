...
{
    public partial class WFVentaXProveedor : IposForm
    {
        public WFVentaXProveedor()
        {
            InitializeComponent();
        }
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfig.getPathForFile(CBSumarizado.Checked ? "InformeVentasXProveedorSum.frx" : "InformeVentasXProveedor.frx", FastReportsTipoFile.desistema));
        ...
        private void WFVentaXProveedor_Load(object sender, EventArgs e)
        {
        }

        private void WFVentaXProveedor_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
