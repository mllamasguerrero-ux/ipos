...
{
    public partial class WFClienteXProducto : IposForm
    {
        public WFClienteXProducto()
        {
            InitializeComponent();
        }
        ...
        private void BTEnviar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                p_producto =  Int64.Parse(this.ITEMIDTextBox.DbValue.ToString());
            }
            catch
            {
            ...
            report1.SetParameterValue("itemid", p_producto);
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfig.getPathForFile(CBSumarizado.Checked ? "InformeClientesXProductoSum.frx" : "InformeClientesXProducto.frx", FastReportsTipoFile.desistema));
        ...
        private void WFClienteXProducto_Load(object sender, EventArgs e)
        {
            
        }

        private void WFClienteXProducto_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
