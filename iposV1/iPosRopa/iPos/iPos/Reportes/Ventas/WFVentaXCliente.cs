...
{
    public partial class WFVentaXCliente : IposForm
    {
        public WFVentaXCliente()
        {
            InitializeComponent();
        }
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfig.getPathForFile(CBSumarizado.Checked ? "InformeVentasXClienteSum.frx" : "InformeVentasXCliente.frx", FastReportsTipoFile.desistema));
        ...
        private void WFVentaXCliente_Load(object sender, EventArgs e)
        {
        }

        private void WFVentaXCliente_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
