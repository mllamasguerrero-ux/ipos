...
{
    public partial class WFVentaXVendedor : IposForm
    {
        public WFVentaXVendedor()
        {
            InitializeComponent();
        }
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfig.getPathForFile(CBSumarizado.Checked ? "InformeVentasXVendedorSum.frx" : "InformeVentasXVendedor.frx", FastReportsTipoFile.desistema));
        ...
        private void WFVentaXVendedor_Load(object sender, EventArgs e)
        {
        }

        private void WFVentaXVendedor_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
