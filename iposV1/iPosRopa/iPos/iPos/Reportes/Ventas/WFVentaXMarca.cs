...
{
    public partial class WFVentaXMarca : IposForm
    {
        public WFVentaXMarca()
        {
            InitializeComponent();
        }
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfig.getPathForFile(CBSumarizado.Checked ? "InformeVentasXMarca.frx" : "InformeVentasXMarcaDetalle.frx", FastReportsTipoFile.desistema));
        ...
        private void WFVentaXMarca_Load(object sender, EventArgs e)
        {
            RecargarReport();
        }

        private void WFVentaXMarca_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
