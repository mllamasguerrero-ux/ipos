...
{
    public partial class WFVentaXVendedorDelCliente : IposForm
    {
        public WFVentaXVendedorDelCliente()
        {
            InitializeComponent();
        }
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfig.getPathForFile(RBSumarizado.Checked ? "InformeVentasXVendedorSumDelCliente.frx" : (RBXVenta.Checked ? "InformeXVentaXVendedorCliente.frx" : "InformeVentasXVendedorDelCliente.frx"), FastReportsTipoFile.desistema));
        ...
        private void WFVentaXVendedorDelCliente_Load(object sender, EventArgs e)
        {
        }

        private void WFVentaXVendedorDelCliente_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
