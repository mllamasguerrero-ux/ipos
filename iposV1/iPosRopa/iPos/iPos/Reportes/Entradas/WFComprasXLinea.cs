...
{
    public partial class WFComprasXLinea : IposForm
    {
        public WFComprasXLinea()
        {
            InitializeComponent();
        }
        ...
        private void RecargarReport()
        {
            ...
            report1.Load(FastReportsConfig.getPathForFile(CBSumarizado.Checked ? "InformeComprasXLineaSum.frx" : "InformeComprasXLinea.frx", FastReportsTipoFile.desistema));
        ...
        private void WFComprasXLinea_Load(object sender, EventArgs e)
        {
        }

        private void WFComprasXLinea_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                report1.Delete();
