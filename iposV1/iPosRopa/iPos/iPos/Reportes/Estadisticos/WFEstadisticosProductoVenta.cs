...
namespace iPos
{
    public partial class WFEstadisticosProductoVenta : Form
    {
        long productoId = 0;
        public WFEstadisticosProductoVenta()
        {
            InitializeComponent();
        }

        public WFEstadisticosProductoVenta(long _productoId)
            : this()
        {
        ...
        private void LlenarGrid()
        {
            try
            {
                ...
                try
                {
                    p_item = int.Parse(this.ITEMIDTextBox.DbValue.ToString());
                }
                catch
                {
                ...
                this.tTL_REP_PROD_VENTA_COMPARACIONTableAdapter.Fill(this.dSFastReports.TTL_REP_PROD_VENTA_COMPARACION, p_item, iAnio1, iAnio2, strIncluirTrasl);
                CambiarImagenesGrid();
            }
        ...
        private void WFEstadisticosProductoVenta_Load(object sender, EventArgs e)
        {
