...
namespace iPos
{
    public partial class WFEstadisticosClienteVenta : Form
    {
        long clienteId = 0;
        public WFEstadisticosClienteVenta()
        {
            InitializeComponent();
        }

        public WFEstadisticosClienteVenta(long _clienteId)
            : this()
        {
        ...
        private void LlenarGrid()
        {
            try
            {
                ...
                this.tTL_REP_CLIENTE_COMPARACIONTableAdapter.Fill(this.dSFastReports.TTL_REP_CLIENTE_COMPARACION, p_item, iAnio1, iAnio2, strIncluirTrasl);
                CambiarImagenesGrid();
            }
        ...
        private void WFEstadisticosClienteVenta_Load(object sender, EventArgs e)
        {
            ...
            if (clienteId > 0)
            {
                ...
                string strBuffer = "";
                this.ITEMIDTextBox.DbValue = clienteId.ToString();
                this.ITEMIDTextBox.MostrarErrores = false;
                this.ITEMIDTextBox.MValidarEntrada(out strBuffer, 1);
                this.ITEMIDTextBox.MostrarErrores = true;
