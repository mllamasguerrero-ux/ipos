...
{	
	...
	public class NumericTextBox : TextBoxET
	{
		/// <summary> 
		...
		private void NumericTextBox_TextChanged(object sender, EventArgs e)
		{
            ...
            Decimal.TryParse(this.Text, out idec_InternalValue);
		...
		protected string FormatNumber()
		{
            ...
            Decimal decBuffer;
            Decimal.TryParse(this.Text, out decBuffer);
            return decBuffer.ToString(lsb_Format.ToString());
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            if (keyData == (Keys.Alt | Keys.P))
            {
                ...
                {
                    this.Text = iPos.Tools.ResultSaved.resultSaved.ToString();
                }
            }
