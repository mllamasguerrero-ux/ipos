...
namespace iPos
{
    public partial class WFDesEnsambleKit : IposForm
    {
        CDOCTOBE m_Docto;
        CPRODUCTOBE m_prod;
        ...
        public WFDesEnsambleKit()
        {
            InitializeComponent();
            m_prod = new CPRODUCTOBE();
            m_Docto = new CDOCTOBE();
            m_Docto.ITIPODOCTOID = DBValues._DOCTO_TIPO_DESENSAMBLE;
            LlenarGrid();
        ...
        {
            WFListaEnsamblados look = new WFListaEnsamblados((int)DBValues._DOCTO_TIPO_DESENSAMBLE);
            look.ShowDialog();
        ...
        private bool KIT_APLICARDESENSAMBLE(long lDoctoID, FbTransaction st)
        {
            ...
            try
            {
                ...
                string commandText = @"KIT_APLICARDESENSAMBLE";
        ...
        private bool KIT_HAYEXISPARADESENSAMBLE(long lDoctoID, FbTransaction st)
        {
            ...
            try
            {
                ...
                string commandText = @"KIT_HAYEXISPARADESENSAMBLE";
        ...
        private bool ProcessAplicar()
        {
            ...
            try
            {
                ...
                if (!KIT_HAYEXISPARADESENSAMBLE(m_Docto.IID, null))
                {
                    MessageBox.Show("No hay existencias suficientes para desensamblar los kits");
                ...
                if (KIT_APLICARDESENSAMBLE(m_Docto.IID, fTrans) == false)
                {
                    fTrans.Rollback();
                    fConn.Close();
        ...
        private void WFDesEnsambleKit_Load(object sender, EventArgs e)
        {
