...
{
    public partial class WFPlazos : Form
    {
        ...
        public WFPlazos(string palabrasBusqueda)
            : this()
        {
        ...
        private void WFPlazos_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFPlazoEdit fPi = new WFPlazoEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.PLAZO_VIEW, strABuscar);
                if (this.dSCatalogos.PLAZO_VIEW.Rows.Count > 0)
