...
{
    public partial class WFVendedores : IposForm
    {
        ...
        public WFVendedores(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFVendedores_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFVendedorEdicion fPi = new WFVendedorEdicion();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.VENDEDOR_VIEW, strABuscar);
                if (this.dSCatalogos.VENDEDOR_VIEW.Rows.Count > 0)
