...
{
    public partial class WFEncargadosGuias : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFEncargadosGuias()
        {
            InitializeComponent();
        ...
        public WFEncargadosGuias(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFEncargadosGuias_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFEncargadoGuiaEdicion fPi = new WFEncargadoGuiaEdicion();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.ENCARGADOGUIA_VIEW, strABuscar);
                if (this.dSCatalogos.ENCARGADOGUIA_VIEW.Rows.Count > 0)
