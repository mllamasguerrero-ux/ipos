...
{
    public partial class WFListaPrecios : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFListaPrecios()
        {
            InitializeComponent();
        ...
        public WFListaPrecios(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFListaPrecios_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFListaPrecioEdit fPi = new WFListaPrecioEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.lISTAPRECIO_VIEWTableAdapter.Fill(this.dSCatalogos.LISTAPRECIO_VIEW, strABuscar);
