...
{
    public partial class WFMarcas : IposForm
    {
        ...
        public WFMarcas(string palabrasBusqueda)
            : this()
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFMarcaEdit fPi = new WFMarcaEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.MARCA_VIEW, strABuscar);
                if (this.dSCatalogos.MARCA_VIEW.Rows.Count > 0)
