...
namespace iPos
{
    public partial class WFSeleccionaVendedorEjecutivo : IposForm
    {
        public long m_vendedorfinal = 0;
        public string m_clavevendedor = "";
        public bool m_bseleccionado = false;
        public WFSeleccionaVendedorEjecutivo()
        {
            InitializeComponent();
        }

        public WFSeleccionaVendedorEjecutivo(long vendedorfinal,string clavevendedor) : this()
        {
        ...
        private void WFSeleccionaVendedorEjecutivo_Load(object sender, EventArgs e)
        {
            string strBuffer = "";
        ...
        private void btnContinuar_Click(object sender, EventArgs e)
        {
            if (this.VENDEDORIDTextBox.Text == "" || Int64.Parse(this.VENDEDORIDTextBox.DbValue.ToString()) == 0)
            {
                ...
                MessageBox.Show("Debe seleccionar el vendedor ejecutivo final ");
                this.VENDEDORIDTextBox.Focus();
                return;
            }
