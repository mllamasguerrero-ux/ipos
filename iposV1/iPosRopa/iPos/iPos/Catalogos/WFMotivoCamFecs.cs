...
{
    public partial class WFMotivoCamFecs : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFMotivoCamFecs()
        {
            InitializeComponent();
        ...
        public WFMotivoCamFecs(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFMotivoCamFecs_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dSCatalogos.MOTIVO_CAMFEC_VIEW' table. You can move, or remove it, as needed.
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFMotivoCamFecEdit fPi = new WFMotivoCamFecEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.MOTIVO_CAMFEC_VIEW, strABuscar);
