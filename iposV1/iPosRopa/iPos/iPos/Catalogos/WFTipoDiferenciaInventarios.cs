...
{
    public partial class WFTipoDiferenciaInventarios : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFTipoDiferenciaInventarios()
        {
            InitializeComponent();
        ...
        public WFTipoDiferenciaInventarios(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFTipoDiferenciaInventarios_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFTipoDiferenciaInventarioEdit fPi = new WFTipoDiferenciaInventarioEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.TIPODIFERENCIAINVENTARIO_VIEW, strABuscar);
                if (this.dSCatalogos.TIPODIFERENCIAINVENTARIO_VIEW.Rows.Count > 0)
