...
{
    public partial class WFTerminalesPagoServicio : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFTerminalesPagoServicio()
        {
            InitializeComponent();
        ...
        public WFTerminalesPagoServicio(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFTerminalesPagoServicio_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                //string strCLAVE = TableDataGridView.Rows[iRetornoRowIndex].Cells["DGTERMINAL"].Value.ToString();
                WFTerminalPagoServicioEdit fPi = new WFTerminalPagoServicioEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.TERMINALPAGOSERVICIO_VIEW, strABuscar);
                if (this.dSCatalogos.TERMINALPAGOSERVICIO_VIEW.Rows.Count > 0)
