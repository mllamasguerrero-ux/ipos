...
{
    public partial class WFContenidos : IposForm
    {
        ...
        public WFContenidos(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFContenidos_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dSCatalogos.CONTENIDO_VIEW' table. You can move, or remove it, as needed.
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFContenidoEdit fPi = new WFContenidoEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.CONTENIDO_VIEW, strABuscar);
