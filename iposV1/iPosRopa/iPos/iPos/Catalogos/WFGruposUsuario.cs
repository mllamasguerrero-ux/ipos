...
{
    public partial class WFGruposUsuario : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFGruposUsuario()
        {
            InitializeComponent();
        ...
        public WFGruposUsuario(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFGruposUsuario_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFGruposUsuarioEdit fPi = new WFGruposUsuarioEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.GRUPOUSUARIO_VIEW, strABuscar);
