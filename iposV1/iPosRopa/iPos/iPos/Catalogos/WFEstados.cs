...
{
    public partial class WFEstados : IposForm
    {
        ...
        public WFEstados(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFEstados_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dSCatalogos.ESTADO_VIEW' table. You can move, or remove it, as needed.
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFEstadoEdit fPi = new WFEstadoEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.ESTADO_VIEW, strABuscar);
