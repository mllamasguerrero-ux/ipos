...
{
    public partial class WFAnaqueles : IposForm
    {
        ...
        public WFAnaqueles(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFAnaqueles_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFAnaquelEdit fPi = new WFAnaquelEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.ANAQUEL_VIEW, strABuscar);
                if (this.dSCatalogos.ANAQUEL_VIEW.Rows.Count > 0)
