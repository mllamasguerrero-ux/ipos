...
{
    public partial class WFAlmacenes : Form
    {
        ...
        public WFAlmacenes(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFAlmacenes_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFAlmacenEdit fPi = new WFAlmacenEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.ALMACEN_VIEW, strABuscar);
                if (this.dSCatalogos.ALMACEN_VIEW.Rows.Count > 0)
