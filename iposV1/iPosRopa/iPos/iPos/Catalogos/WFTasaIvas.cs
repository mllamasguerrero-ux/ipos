...
{
    public partial class WFTasaIvas : IposForm
    {
        ...
        public WFTasaIvas(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFTasaIvas_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFTasaIvaEdit fPi = new WFTasaIvaEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.TASAIVA_VIEW, strABuscar);
