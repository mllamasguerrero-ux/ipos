...
{
    public partial class WFMedicos : IposForm
    {
        ...
        public WFMedicos(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFMedicos_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dSCatalogos.BANCO_VIEW' table. You can move, or remove it, as needed.
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFBancoEdit fPi = new WFBancoEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.MEDICO_VIEW, strABuscar,CBSoloMedicosEmpresa.Checked ? "S" : "N");
        ...
        private void CBSoloMedicosEmpresa_CheckedChanged(object sender, EventArgs e)
        {
            LlenarGrid();
        }
        /*
