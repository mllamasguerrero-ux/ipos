...
{
    public partial class WFSucursales : IposForm
    {
        ...
        public WFSucursales(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFSucursales_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dSCatalogos.SUCURSAL_VIEW' table. You can move, or remove it, as needed.
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFSucursalEdit fPi = new WFSucursalEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.SUCURSAL_VIEW, strABuscar);
