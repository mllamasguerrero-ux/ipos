...
{
    public partial class WFUnidades : IposForm
    {
        ...
        public WFUnidades(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFUnidades_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dSCatalogos.UNIDAD_VIEW' table. You can move, or remove it, as needed.
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFUnidadEdit fPi = new WFUnidadEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.UNIDAD_VIEW, strABuscar);
