...
{
    public partial class WFAreas : IposForm
    {
        ...
        public WFAreas(string palabrasBusqueda)
            : this()
        {
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.AREA_VIEW, strABuscar);
                if (this.dSCatalogos.AREA_VIEW.Rows.Count > 0)
