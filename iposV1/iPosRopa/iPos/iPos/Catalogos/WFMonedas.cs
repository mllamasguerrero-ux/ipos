...
{
    public partial class WFMonedas : IposForm
    {
        ...
        public WFMonedas(string palabrasBusqueda)
            : this()
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFMonedaEdit fPi = new WFMonedaEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.MONEDA_VIEW, strABuscar);
