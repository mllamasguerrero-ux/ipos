...
{
    public partial class WFClerkPagoServicios : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFClerkPagoServicios()
        {
            InitializeComponent();
        ...
        public WFClerkPagoServicios(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFClerkPagoServicios_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dSCatalogos.CLERKPAGOSERVICIO_VIEW' table. You can move, or remove it, as needed.
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                //string strCLAVE = TableDataGridView.Rows[iRetornoRowIndex].Cells["DGCLERKID"].Value.ToString();
                WFClerkPagoServicioEdit fPi = new WFClerkPagoServicioEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.CLERKPAGOSERVICIO_VIEW, strABuscar);
