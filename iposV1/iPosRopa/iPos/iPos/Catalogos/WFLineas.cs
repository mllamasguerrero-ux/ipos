...
{
    public partial class WFLineas : IposForm
    {
        ...
        public WFLineas(string palabrasBusqueda)
            : this()
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFLineaEdit fPi = new WFLineaEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.LINEA_VIEW, strABuscar);
