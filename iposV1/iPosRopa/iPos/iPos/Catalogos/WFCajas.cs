...
{
    public partial class WFCajas : IposForm
    {
        ...
        public WFCajas(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFCajas_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFCajaEditForm fPi = new WFCajaEditForm();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.CAJA_VIEW, strABuscar);
                if (this.dSCatalogos.CAJA_VIEW.Rows.Count > 0)
