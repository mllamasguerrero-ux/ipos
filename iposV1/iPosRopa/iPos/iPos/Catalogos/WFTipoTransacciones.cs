...
{
    public partial class WFTipoTransacciones : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFTipoTransacciones()
        {
            InitializeComponent();
        ...
        public WFTipoTransacciones(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFTipoTransacciones_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFTipoTransaccionEdit fPi = new WFTipoTransaccionEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.TIPOTRANSACCION_VIEW, strABuscar);
