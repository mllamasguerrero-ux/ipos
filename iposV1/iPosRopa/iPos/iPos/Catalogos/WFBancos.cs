...
{
    public partial class WFBancos : IposForm
    {
        ...
        public WFBancos(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFBancos_Load(object sender, EventArgs e)
        {
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.BANCO_VIEW, strABuscar);
