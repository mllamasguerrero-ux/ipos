...
{
    public partial class WFGastosAdicionales : Form
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFGastosAdicionales()
        {
            InitializeComponent();
            m_bRetornarValor = false;
        }

        public WFGastosAdicionales(string palabrasBusqueda)
            : this()
        {
        ...
        private void WFGastosAdicionales_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFGastoAdicionalEdit fPi = new WFGastoAdicionalEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.GASTOADICIONAL_VIEW, strABuscar);
                if (this.dSCatalogos.GASTOADICIONAL_VIEW.Rows.Count > 0)
