...
{
    public partial class WFSubTipoClientes : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFSubTipoClientes()
        {
            InitializeComponent();
        ...
        public WFSubTipoClientes(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFSubTipoClientes_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFSubTipoClienteEdit fPi = new WFSubTipoClienteEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.SUBTIPOCLIENTE_VIEW, strABuscar);
                if (this.dSCatalogos.SUBTIPOCLIENTE_VIEW.Rows.Count > 0)
