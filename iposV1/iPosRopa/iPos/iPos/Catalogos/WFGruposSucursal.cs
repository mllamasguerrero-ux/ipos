...
{
    public partial class WFGruposSucursal : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFGruposSucursal()
        {
            InitializeComponent();
        ...
        public WFGruposSucursal(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFGruposSucursal_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFGrupoSucursalEdit fPi = new WFGrupoSucursalEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.GRUPOSUCURSAL_VIEW, strABuscar);
