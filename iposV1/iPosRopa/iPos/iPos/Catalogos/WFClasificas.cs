...
{
    public partial class WFClasificas : IposForm
    {
        ...
        public WFClasificas(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFClasificas_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dSCatalogos.CLASIFICA_VIEW' table. You can move, or remove it, as needed.
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFClasificaEdit fPi = new WFClasificaEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.CLASIFICA_VIEW, strABuscar);
