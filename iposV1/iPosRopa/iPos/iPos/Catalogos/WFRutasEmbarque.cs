...
{
    public partial class WFRutasEmbarque : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFRutasEmbarque()
        {
            InitializeComponent();
            m_bRetornarValor = false;
        }

        public WFRutasEmbarque(string palabrasBusqueda): this()
        {
            m_bRetornarValor = true;
        }

        private void WFRutasEmbarque_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFRutaEmbarqueEdit fPi = new WFRutaEmbarqueEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.rUTAEMBARQUE_VIEWTableAdapter.Fill(this.dSCatalogos.RUTAEMBARQUE_VIEW, strABuscar);
                if (this.dSCatalogos.RUTAEMBARQUE_VIEW.Rows.Count > 0)
