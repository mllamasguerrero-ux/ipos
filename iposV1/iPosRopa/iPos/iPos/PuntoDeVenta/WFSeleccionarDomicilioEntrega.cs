...
namespace iPos
{
    public partial class WFSeleccionarDomicilioEntrega : Form
    {
        ...
        public WFSeleccionarDomicilioEntrega()
        {
            InitializeComponent();
        }


        public WFSeleccionarDomicilioEntrega(long personaId , string textoParaSeleccionar, long? seleccionPreviaId): this()
        {
            PersonaId = personaId;
