...
namespace iPos
{
    public partial class WFImportarPreciosNuevosMovil : IposForm
    {
        bool bError = false;
        string strError = "";
        ...
        public WFImportarPreciosNuevosMovil()
        {
            InitializeComponent();
        }


        public WFImportarPreciosNuevosMovil(bool bShowMensajesError)
            : this()
        {
        ...
        private void WFImportarPreciosNuevosMovil_Load(object sender, EventArgs e)
        {
        ...
        private void ProcesarPendientes()
        {
            ...
            bError = !ImportaFtpMovil.ImportarDatosProdUpdated(ref strError);
