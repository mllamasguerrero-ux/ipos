...
namespace iPos
{
    public partial class WFExportacionFinalMovil_3 : iPos.Tools.ScreenConfigurableForm
    {
        ...
        public WFExportacionFinalMovil_3()
        {
            InitializeComponent();
        }
        ...
        private void WFExportacionFinalMovil_3_Load(object sender, EventArgs e)
        {
        ...
        */
        ...
        private void FinalizarSesion()
        {
            ...
            try
            {
                ...
                movilSesion.IFECHAFINCOBRA = DateTime.Now;
                movilSesion.IFECHAFINVENTA = DateTime.Now;
                movilSesion.IFOLIOFINCOBRA = CurrentUserID.CurrentParameters.IMOVILCIERRECOBRANZA;
                movilSesion.IFOLIOFINVENTA = CurrentUserID.CurrentParameters.IMOVILCIERREVENTA;
                movilSesion.IACTIVO = "N";

                string jsonStr = JsonConvert.SerializeObject(movilSesion, Formatting.Indented);


                string strRespuesta = service1.CerrarCorteMovil_3(jsonStr, CurrentUserID.CurrentParameters.IVENDEDORMOVILCLAVE, CurrentUserID.CurrentParameters.ISUCURSALNUMERO,
                                       iPos.Tools.FTPManagement.m_strFTPFolderWs,
                                       iPos.Tools.FTPManagement.m_strFTPFolderPassWs);
