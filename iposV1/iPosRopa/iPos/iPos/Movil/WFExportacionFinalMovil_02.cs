...
namespace iPos
{
    public partial class WFExportacionFinalMovil_02 : iPos.Tools.ScreenConfigurableForm
    {
        ...
        public WFExportacionFinalMovil_02()
        {
            InitializeComponent();
        }
        ...
        private void WFExportacionFinalMovil_02_Load(object sender, EventArgs e)
        {
        ...
        */
        ...
        public bool EnviarCierreDeVentas()
        {
            ...
            strRespuesta = service1.CerrarCorteVentaMovil_2(iPos.CurrentUserID.CurrentParameters.IBDSERVERWS, 
