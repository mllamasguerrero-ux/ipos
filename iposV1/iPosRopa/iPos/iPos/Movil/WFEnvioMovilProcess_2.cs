...
namespace iPos
{
    public partial class WFEnvioMovilProcess_2 : iPos.Tools.ScreenConfigurableForm
    {
        ...
        public WFEnvioMovilProcess_2()
        {
            InitializeComponent();
        }


        public WFEnvioMovilProcess_2(CDOCTOBE docto):this()
        {
            m_Docto = docto;
        }
        ...
        private void WFEnvioMovilProcess_2_Load(object sender, EventArgs e)
        {
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            switch (currentProgress)
            {
                case 0: 
                    ...
                    break;
                case 1: CerrarVenta(); FinalizarVisita(); break;
                case 2:
                    if (CurrentUserID.CurrentParameters.ITIPOSYNCMOVIL.Equals(DBValues._TIPOSYNC_WS))
                    {
        ...
        private void EnviarVenta()
        {
            ...
            foreach (CMOVTOBE movto in movtos)
            {
                ...
                vedpbe.IID = getLastNChars(m_Docto.IID.ToString(), 10);
        ...
        private void VerificarProcesamiento()
        {
            ...
            while (intento < 3)
            {
                ...
                try
                {
                    ...
                    strRespuesta = service1.VerificarVentaMovil_2(getLastNChars(m_Docto.IID.ToString(), 10), m_Docto.IFOLIO.ToString(), m_Docto.IFECHA, iPos.CurrentUserID.CurrentParameters.IBDSERVERWS, iPos.CurrentUserID.CurrentUser.IUSERNAME,
                                        iPos.Tools.FTPManagement.m_strFTPFolderWs,
                                        iPos.Tools.FTPManagement.m_strFTPFolderPassWs);
            ...
            {
                bError = true;
                strError = "No se pudo verificar " + strRespuesta;
                return;
            }
