...
{
    public partial class WFBitacoraCobranzaListMovil : IposForm
    {
        ...
        public WFBitacoraCobranzaListMovil()
        {
            InitializeComponent();
        }
        ...
        {
            WFBitacoraAddMovil wf = new WFBitacoraAddMovil();
            wf.ShowDialog();
            wf.Dispose();
        ...
        private void bITACOBRANZADataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex != -1)
            {
                ...
                if (bITACOBRANZADataGridView.Columns[e.ColumnIndex].Name == "DGEDITAR")
                {
                    ...
                    iPos.Cobranza.WFBitacoraEdit wf = new iPos.Cobranza.WFBitacoraEdit("Cambiar", bitId);
                    wf.ShowDialog();
                    wf.Dispose();
                    GC.SuppressFinalize(wf);
                ...
                {
                    long bitId = long.Parse(bITACOBRANZADataGridView.Rows[e.RowIndex].Cells["DGID"].Value.ToString());
                    iPos.Cobranza.WFBitacoraEdit wf = new iPos.Cobranza.WFBitacoraEdit("Consultar", bitId);
                    wf.ShowDialog();
                    wf.Dispose();
                    GC.SuppressFinalize(wf);
        ...
        private void WFBitacoraCobranzaListMovil_Load(object sender, EventArgs e)
        {
            LlenarGrid();
