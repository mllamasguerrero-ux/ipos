...
namespace iPos
{
    public partial class WFEnvioMovilProcess : iPos.Tools.ScreenConfigurableForm
    {
        ...
        public WFEnvioMovilProcess()
        {
            InitializeComponent();
        }


        public WFEnvioMovilProcess(CDOCTOBE docto):this()
        {
            m_Docto = docto;
        }
        ...
        private void WFEnvioMovilProcess_Load(object sender, EventArgs e)
        {
