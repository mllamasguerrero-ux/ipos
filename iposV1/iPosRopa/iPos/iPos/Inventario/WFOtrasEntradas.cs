...
namespace iPos
{
    ...
    public partial class WFOtrasEntradas : IposForm
    {
        ...
        string m_proveedorEsImportador = "S";
        ...
        public WFOtrasEntradas(long default_tipodocto) : this()
        {
        ...
        private void WFPuntoDeTransaccion_Load(object sender, EventArgs e)
        {
            ...
            if (usuariosD.UsuarioTienePermisos((int)CurrentUserID.CurrentUser.IID, (int)DBValues._DERECHO_CAMBIARPRECIO_OTRASENTRADAS, null))
            {
        ...
        private void AbrirTransaccion()
        {
            ...
            WFLOOKUPCOMPRAS look = new WFLOOKUPCOMPRAS((int)DBValues._DOCTO_ESTATUS_BORRADOR, (int)DBValues._DOCTO_TIPO_OTRASENTRADAS, true);
            look.ShowDialog();
            ...
            if (dr != null)
            {
                ...
                if (m_Docto.ITIPODOCTOID == DBValues._DOCTO_TIPO_OTRASENTRADAS)
                {
                    this.LBOperacion.Text = "Otras entradas";
                }
        ...
        private void AbrirTransaccionsCerradasYDevoluciones(int iDoctoSelectedId)
        {
            ...
            {
                WFLOOKUPCOMPRAS look = new  WFLOOKUPCOMPRAS((int)DBValues._DOCTO_ESTATUS_COMPLETO, (int)DBValues._DOCTO_TIPO_OTRASENTRADAS, true);
                look.ShowDialog();
       ...
       /* private void ModoOtrasEntradas()
        ...
        {
            /*foreach (iPos.Entradas.DSEntradas.GridPVRow dr in dSEntradas.GridPV)
            {
                if (dr. == productoId)
                {
        ...
        private void btnNoTransaccion_Click(object sender, EventArgs e)
        {
            ...
            WFSelectOtrosTransByFolio wf = new WFSelectOtrosTransByFolio(DBValues._DOCTO_TIPO_OTRASENTRADAS);
            wf.ShowDialog();
            string strSucDest = "";
