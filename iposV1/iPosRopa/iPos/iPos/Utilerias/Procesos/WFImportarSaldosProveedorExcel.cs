...
{
    public partial class WFImportarSaldosProveedorExcel : Form
    {
        private bool m_importacionExitosa;
        private string m_iComentario;

        public WFImportarSaldosProveedorExcel()
        {
            InitializeComponent();
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (ife.ImportarSaldosProveedoresFromExcel(this.TBImpCatalogos.Text, CurrentUserID.CurrentUser.IID, ref mensajesDeError))
            {
        ...
        private void WFImportarSaldosProveedorExcel_Load(object sender, EventArgs e)
        {
            ChecarCorteActivo();
        }
    }
