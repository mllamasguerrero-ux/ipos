...
namespace iPos
{
    public partial class WFImportarClientesDesdeExcel : IposForm
    {

        private bool m_importacionExitosa;
        private string m_iComentario;

        public WFImportarClientesDesdeExcel()
        {
            InitializeComponent();
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
                ...
                if (ife.ImportarClientesFromExcel(this.TBImpCatalogos.Text))
                {
        ...
        private void TBImpCatalogos_TextChanged(object sender, EventArgs e)
        {
