...
{
    public partial class WFTipoGastos : IposForm
    {
        ...
        public WFTipoGastos(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFTipoGastos_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFTipoGastoEdit fPi = new WFTipoGastoEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.TIPOGASTO_VIEW, strABuscar);
                if (this.dSCatalogos.TIPOGASTO_VIEW.Rows.Count > 0)
