...
{
    public partial class WFGastos : IposForm
    {
        ...
        public WFGastos(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFGastos_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dSCatalogos.GASTO_VIEW' table. You can move, or remove it, as needed.
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFGastoEdit fPi = new WFGastoEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.GASTO_VIEW, strABuscar);
