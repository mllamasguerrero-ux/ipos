...
{
    public partial class WFCentroCostos : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFCentroCostos()
        {
            InitializeComponent();
        ...
        public WFCentroCostos(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFCentroCostos_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFCentroCostoEdit fPi = new WFCentroCostoEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.CENTROCOSTO_VIEW, strABuscar);
                if (this.dSCatalogos.CENTROCOSTO_VIEW.Rows.Count > 0)
