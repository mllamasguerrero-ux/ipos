...
{
    public partial class WFCuentasBancos : IposForm
    {
        public DataRow m_rtnDataRow;
        public bool m_bRetornarValor;

        public WFCuentasBancos()
        {
            InitializeComponent();
        ...
        public WFCuentasBancos(string palabrasBusqueda)
            : this()
        {
            m_bRetornarValor = true;
        }

        private void WFCuentasBancos_Load(object sender, EventArgs e)
        {
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFCuentaBancoEdit fPi = new WFCuentaBancoEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.cUENTABANCO_VIEWTableAdapter.Fill(this.dSCatalogos.CUENTABANCO_VIEW, strABuscar);
                if (this.dSCatalogos.CUENTABANCO_VIEW.Rows.Count > 0)
