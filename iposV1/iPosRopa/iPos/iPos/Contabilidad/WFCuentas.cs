...
{
    public partial class WFCuentas : IposForm
    {
        ...
        public WFCuentas(string palabrasBusqueda)
            : this()
        {
        ...
        {
            // TODO: This line of code loads data into the 'dSCatalogos.CUENTA_VIEW' table. You can move, or remove it, as needed.
        ...
        private void MostrarRegistro(string opc)
        {
            try
            {
                ...
                WFCuentaEdit fPi = new WFCuentaEdit();
        ...
        private void LlenarGrid()
        {
            ...
            try
            {
                ...
                numeroRegistros = this.TableTableAdapter.Fill(this.dSCatalogos.CUENTA_VIEW, strABuscar);
